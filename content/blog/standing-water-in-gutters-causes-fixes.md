...
1. **Where is the standing water?** Near the downspout = clogged downspout. At a low point = sag or pitch problem. Behind a debris pile = debris dam.
2. **Is the gutter visibly sagging at the water location?** If yes = hanger/fascia problem.
3. **Is the rest of the gutter draining normally?** If yes, the problem is localized. If the entire run holds water, it's a system-wide pitch issue.
