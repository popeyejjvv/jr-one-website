...
const CITIES_ES = {
  ...
  clearwater: {
    ...
    localP: "La ubicación costera de Clearwater significa que el exterior de su hogar recibe castigo constante del aire salado, tormentas tropicales y exposición intensa a rayos UV todo el año. Las canaletas, sofitos y fascias de aluminio son ideales para las condiciones de Clearwater porque resisten la corrosión del aire salado que deteriora materiales inferiores. JR One sirve a Clearwater y todo Pinellas County con la misma precisión y dedicación que llevamos a cada comunidad de Tampa Bay.",
    weatherNote: "La proximidad costera de Clearwater agrega corrosión por aire salado a los desafíos estándar de Florida: lluvia intensa, rayos UV y humedad. El aluminio es el material ideal aquí porque maneja todo esto sin degradarse.",
    nearbyText: "También servimos a Palm Harbor, Dunedin, Safety Harbor, Largo y todo Pinellas County.",
  },
  "st-petersburg": {
    heroH1: "Empresa Familiar de St. Petersburg en",
    heroH1Gold: "Aluminio",
    localP: "La mezcla de casas históricas, barrios de mediados de siglo y construcción nueva en St. Petersburg significa que cada trabajo de canaletas y sofitos es diferente. Muchas casas antiguas de St. Pete todavía tienen sofitos y fascias originales de madera que se han deteriorado durante décadas con la humedad de Florida. JR One se enfoca en reemplazar estos sistemas envejecidos con aluminio duradero que protege su hogar y mejora su apariencia.",
    weatherNote: "St. Pete tiene el récord Guinness de días consecutivos de sol: 768 días. Esa exposición UV degrada los sofitos y fascias de madera más rápido de lo que la mayoría de propietarios se imaginan.",
    nearbyText: "También servimos a Gulfport, Pinellas Park, Seminole, Largo y todo Pinellas County.",
  },
  sarasota: {
    heroH1: "Empresa Familiar de Sarasota en",
    heroH1Gold: "Canaletas y Aluminio",
    localP: "Los propietarios de Sarasota invierten en sus propiedades, y esperan contratistas que estén a la altura. JR One sirve a Sarasota con la misma atención meticulosa al detalle que la comunidad exige. Desde casas frente al agua en los cayos hasta barrios establecidos como Palmer Ranch y Lakewood Ranch, instalamos sistemas de aluminio que funcionan y lucen impecables.",
    weatherNote: "Las tormentas costeras de Sarasota lanzan lluvia de lado, poniendo a prueba canaletas y sofitos de maneras que las casas tierra adentro rara vez experimentan. La inclinación adecuada de instalación y la fijación correcta no son opcionales aquí, son esenciales.",
    nearbyText: "También servimos a Bradenton, Venice, Osprey, North Port y comunidades cercanas.",
  },
  bradenton: {
    heroH1: "Empresa Familiar de Bradenton en",
    heroH1Gold: "Canaletas y Fascias",
    localP: "Bradenton se encuentra en la intersección del clima costero y el crecimiento suburbano, con barrios que van desde el centro histórico hasta desarrollos nuevos en Lakewood Ranch y Parrish. Ya sea que mantenga una casa antigua o equipe una construcción nueva, JR One proporciona el mismo servicio Gold Standard en todo Manatee County.",
    weatherNote: "La posición de Bradenton sobre el Manatee River y Tampa Bay significa que las casas aquí enfrentan tanto marejadas costeras como inundaciones tierra adentro. Canaletas funcionando correctamente no son solo estéticas, son protección estructural.",
    nearbyText: "También servimos a Sarasota, Lakewood Ranch, Anna Maria Island y áreas cercanas.",
  },
  lakeland: {
    heroH1: "Empresa Familiar de Lakeland en",
    heroH1Gold: "Instalación de Canaletas",
    localP: "La ubicación interior de Lakeland significa que recibe todas las tormentas intensas de la tarde del centro de Florida sin la brisa costera para secar las cosas. La lluvia intensa y la humedad persistente hacen que los sistemas de canaletas de calidad sean esenciales para proteger los cimientos y el exterior de su hogar. JR One lleva artesanía de calibre Tampa Bay a cada proyecto en Lakeland.",
    weatherNote: "Lakeland está en el 'Pasillo de Relámpagos' de Florida, una de las regiones con más actividad de tormentas en el país. Esas tormentas de la tarde descargan cantidades masivas de agua en periodos cortos, y sus canaletas necesitan manejarlo.",
    nearbyText: "También servimos a Plant City, Brandon, Winter Haven y comunidades cercanas de Polk County.",
  },
  brandon: {
    heroH1: "Empresa Familiar de Brandon en",
    heroH1Gold: "Canaletas y Sofitos",
    localP: "El rápido crecimiento de Brandon en las últimas dos décadas significa una mezcla de edades de vivienda, desde desarrollos establecidos de los años 80 hasta construcción nueva. Ambos necesitan sistemas confiables de canaletas y sofitos, pero por diferentes razones. Las casas más antiguas a menudo tienen sofitos de madera fallando y sistemas de canaletas obsoletos, mientras que las construcciones nuevas necesitan instalación de calidad desde el primer día. JR One maneja ambos en la comunidad de Brandon.",
    weatherNote: "Brandon recibe la misma actividad intensa de tormentas que Tampa pero con más cobertura de árboles suburbanos, lo que significa más hojas, agujas de pino y escombros en sus canaletas.",
    nearbyText: "También servimos a Riverview, Tampa, Plant City y todo Hillsborough County.",
  },
  "wesley-chapel": {
    heroH1: "Empresa Familiar de Wesley Chapel en",
    heroH1Gold: "Aluminio",
    localP: "Wesley Chapel es una de las comunidades de más rápido crecimiento en Tampa Bay, con construcción nueva y barrios establecidos lado a lado. JR One sirve a propietarios de Wesley Chapel que quieren su trabajo de canaletas, sofitos y fascias hecho bien, no por el postor más barato que el constructor pudo encontrar, sino por un equipo familiar con más de 30 años en la industria de canaletas en Tampa Bay.",
    weatherNote: "El terreno plano de Pasco County significa que el drenaje es crítico. Sin canaletas con la inclinación adecuada, el agua se acumula alrededor de sus cimientos en lugar de ser dirigida lejos.",
    nearbyText: "También servimos a Land O' Lakes, Lutz, New Tampa y todo Pasco County.",
  },
  "palm-harbor": {
    heroH1: "Empresa Familiar de Palm Harbor en",
    heroH1Gold: "Canaletas",
    localP: "Los barrios establecidos y las calles arboladas de Palm Harbor son parte de lo que lo hace hermoso, y parte de por qué el mantenimiento de canaletas importa aquí. Los robles y pinos dejan escombros todo el año, y la proximidad de Palm Harbor al Golfo significa que el aire salado siempre es un factor. JR One proporciona soluciones de aluminio construidas exactamente para estas condiciones.",
    weatherNote: "El dosel maduro de árboles de Palm Harbor significa más escombros en las canaletas que la mayoría de las comunidades de Pinellas County. Los protectores y el mantenimiento regular son especialmente importantes aquí.",
    nearbyText: "También servimos a Tarpon Springs, Dunedin, Clearwater y áreas cercanas.",
  },
  riverview: {
    heroH1: "Empresa Familiar de Riverview en",
    heroH1Gold: "Canaletas y Fascias",
    localP: "El crecimiento explosivo de Riverview ha traído miles de casas nuevas, muchas construidas rápidamente por constructores de volumen. Si sus canaletas fueron instaladas como parte de un proceso de construcción rápida, puede que no hayan recibido la atención a la inclinación, espaciado de ganchos y calidad de material que un oficio especializado proporciona. JR One arregla lo que los constructores hicieron a la ligera e instala sistemas nuevos construidos para durar.",
    weatherNote: "La posición de Riverview a lo largo del Alafia River significa que el drenaje adecuado es crítico para prevenir problemas de cimientos y erosión del jardín.",
    nearbyText: "También servimos a Brandon, Sun City Center, Ruskin y todo Hillsborough County.",
  },
  "new-port-richey": {
    heroH1: "Empresa Familiar en",
    heroH1Gold: "Aluminio en New Port Richey",
    localP: "La mezcla de propiedades frente al agua y barrios interiores establecidos de New Port Richey requiere sistemas de canaletas y sofitos que puedan manejar todo, desde tormentas costeras hasta escombros de árboles. JR One sirve a New Port Richey y el oeste de Pasco County con el mismo enfoque Gold Standard que llevamos a cada comunidad en Tampa Bay.",
    weatherNote: "Las propiedades frente al Golfo en New Port Richey reciben impacto directo de sistemas tropicales. La fijación con clasificación de huracán y el dimensionamiento adecuado de canaletas no son opcionales aquí.",
    nearbyText: "También servimos a Spring Hill, Trinity, Tarpon Springs y áreas cercanas.",
  },
  largo: {
    heroH1: "Empresa Familiar de Largo en",
    heroH1Gold: "Canaletas y Sofitos",
    localP: "Largo se encuentra en el corazón de Pinellas County: lo suficientemente cerca del Golfo para la exposición al aire salado, lo suficientemente denso en copa de árboles para escombros constantes en canaletas, y lo suficientemente establecido para que muchas casas tengan sistemas de sofitos y fascias que ya pasaron su vida útil. JR One lleva trabajo de aluminio de oficio especializado a propietarios de Largo que quieren el trabajo bien hecho.",
    weatherNote: "La ubicación central de Largo en Pinellas significa que recibe tanto clima costero como cobertura de árboles suburbanos, una combinación que acelera el desgaste de canaletas y sofitos.",
    nearbyText: "También servimos a Clearwater, Pinellas Park, Seminole, St. Petersburg y áreas cercanas.",
  },
  "spring-hill": {
    heroH1: "Empresa Familiar de Spring Hill en",
    heroH1Gold: "Canaletas",
    localP: "Las viviendas accesibles y la comunidad en crecimiento de Spring Hill hacen de esta un área donde el trabajo de contratistas de calidad tiene alta demanda pero no siempre es fácil de encontrar. JR One extiende nuestra área de servicio de Tampa Bay a Spring Hill porque los propietarios aquí merecen la misma artesanía Gold Standard que cualquier otra comunidad que servimos.",
    weatherNote: "La posición interior de Spring Hill significa tormentas intensas y lluvias estacionales fuertes sin alivio del viento costero. Las canaletas aquí trabajan duro todo el año.",
    nearbyText: "También servimos a New Port Richey, Land O' Lakes y todo Hernando County.",
  },
  "tarpon-springs": {
    heroH1: "Empresa Familiar de Tarpon Springs en",
    heroH1Gold: "Canaletas y Aluminio",
    localP: "Tarpon Springs es famosa por su herencia griega y el histórico Sponge Docks, con casas que van desde encantadoras cabañas frente al agua hasta desarrollos interiores más nuevos. El aire salado del Golfo y las fuertes tormentas de verano ejercen estrés constante sobre canaletas, sofitos y fascias, haciendo que el trabajo de aluminio de calidad sea esencial para preservar tanto la belleza como la estructura de las casas de Tarpon Springs.",
    weatherNote: "La exposición directa al Golfo de Tarpon Springs significa vientos cargados de sal y lluvia intensa durante sistemas tropicales. El aluminio resistente a la corrosión y la fijación adecuada son innegociables aquí.",
    nearbyText: "También servimos a Palm Harbor, Dunedin y New Port Richey.",
  },
  "land-o-lakes": {
    heroH1: "Empresa Familiar de Land O' Lakes en",
    heroH1Gold: "Canaletas y Sofitos",
    localP: "Land O' Lakes es una de las áreas de más rápido crecimiento de Pasco County, con comunidades de construcción nueva apareciendo junto a barrios establecidos. Muchas de estas casas fueron construidas rápidamente por constructores de volumen, y las instalaciones de canaletas y sofitos a menudo reflejan ese ritmo. JR One lleva precisión de oficio especializado a propietarios de Land O' Lakes que quieren su trabajo de aluminio bien hecho desde la primera vez.",
    weatherNote: "El terreno plano de Pasco County y los numerosos lagos y humedales de Land O' Lakes significan que el drenaje lo es todo. Sin canaletas con la inclinación y tamaño adecuados, el agua se acumula alrededor de los cimientos en lugar de ser dirigida lejos.",
    nearbyText: "También servimos a Lutz, Wesley Chapel y New Tampa.",
  },
  dunedin: {
    heroH1: "Empresa Familiar de Dunedin en",
    heroH1Gold: "Aluminio y Canaletas",
    localP: "El centro histórico de Dunedin, su encanto costero y sus calles arboladas lo convierten en una de las comunidades más deseables de Pinellas County. Muchas casas aquí tienen carácter y años, lo que también significa sistemas envejecidos de sofitos, fascias y canaletas que necesitan reemplazo profesional. JR One sirve a Dunedin con el cuidado que estas casas merecen, actualizando sistemas de madera a aluminio duradero que resiste el clima de la Costa del Golfo.",
    weatherNote: "La posición de Dunedin entre el Golfo y St. Joseph Sound significa exposición constante al aire salado e impacto directo de tormentas costeras. Materiales de calidad y fijación con clasificación de huracán protegen su inversión.",
    nearbyText: "También servimos a Clearwater, Palm Harbor y Tarpon Springs.",
  },
  ruskin: {
    heroH1: "Empresa Familiar de Ruskin en",
    heroH1Gold: "Canaletas y Fascias",
    localP: "Ruskin se encuentra en el sur de Hillsborough County donde las raíces agrícolas se encuentran con el rápido crecimiento residencial. Desde propiedades frente al agua a lo largo de Tampa Bay hasta desarrollos interiores más nuevos, las casas aquí necesitan sistemas de canaletas y sofitos construidos para las condiciones más duras de Florida. JR One lleva la misma artesanía Gold Standard a Ruskin que entregamos en todo Tampa Bay.",
    weatherNote: "El terreno bajo de Ruskin a lo largo de Tampa Bay hace que el manejo adecuado del agua sea crítico. Las lluvias estacionales fuertes combinadas con niveles freáticos altos significan que sus canaletas son la primera línea de defensa contra daños a cimientos y jardín.",
    nearbyText: "También servimos a Sun City Center, Riverview y Brandon.",
  },
  "sun-city-center": {
    heroH1: "Empresa Familiar de Sun City Center en",
    heroH1Gold: "Instalación de Canaletas",
    localP: "Sun City Center es una de las principales comunidades de retiro activo de Florida, donde los propietarios se enorgullecen de propiedades bien mantenidas. Sistemas de canaletas envejecidos, sofitos deteriorados y fascias desgastadas no solo lucen mal, comprometen la protección de su hogar. JR One entiende los estándares que los residentes de Sun City Center esperan, y entregamos trabajo de aluminio preciso que mantiene las casas protegidas y con buena apariencia.",
    weatherNote: "La ubicación en el sur de Hillsborough de Sun City Center recibe toda la fuerza de las tormentas de verano y sistemas tropicales. Canaletas confiables no son opcionales, son esenciales para proteger el hogar en el que ha invertido.",
    nearbyText: "También servimos a Ruskin, Riverview y Brandon.",
  },
  "temple-terrace": {
    heroH1: "Empresa Familiar de Temple Terrace en",
    heroH1Gold: "Canaletas y Sofitos",
    localP: "Temple Terrace es una de las comunidades más establecidas de Tampa, con copa de árboles madura y barrios que han estado aquí por décadas. Esa edad significa que muchas casas funcionan con sofitos originales de madera y sistemas de canaletas obsoletos que el clima de Florida ha castigado por años. JR One reemplaza sistemas fallando con aluminio duradero construido para manejar lo que el clima de Temple Terrace le lance.",
    weatherNote: "La densa cobertura de árboles de Temple Terrace significa escombros constantes en canaletas de robles y pinos, mientras que el corredor del Hillsborough River agrega humedad y desafíos de drenaje que exigen sistemas de canaletas funcionando correctamente.",
    nearbyText: "También servimos a Tampa, Brandon y Lutz.",
  },
  "plant-city": {
    heroH1: "Empresa Familiar de Plant City en",
    heroH1Gold: "Canaletas",
    localP: "Plant City, la Capital Mundial de la Fresa, se encuentra en el este de Hillsborough County donde la vida suburbana se encuentra con la herencia agrícola. Las casas aquí enfrentan el mismo clima intenso de Florida que el resto de Tampa Bay, y el trabajo de calidad en canaletas y sofitos es esencial para proteger su propiedad. JR One extiende nuestro servicio Gold Standard a Plant City porque cada propietario merece trabajo de aluminio de oficio especializado.",
    weatherNote: "La posición interior de Plant City la coloca directamente en el corredor de tormentas de Florida. Los aguaceros intensos de la tarde descargan cantidades masivas de agua en ráfagas cortas, y su sistema de canaletas necesita manejar el volumen sin desbordarse.",
    nearbyText: "También servimos a Brandon, Lakeland y Tampa.",
  },
  lutz: {
    heroH1: "Empresa Familiar de Lutz en",
    heroH1Gold: "Aluminio y Canaletas",
    localP: "Lutz se extiende a ambos lados de la línea del condado Hillsborough-Pasco, ofreciendo un ambiente suburbano con gran cobertura de árboles y barrios establecidos junto a desarrollos más nuevos. Esa cobertura de árboles es hermosa pero significa escombros constantes en canaletas, y muchas casas antiguas de Lutz necesitan actualizaciones de sofitos y fascias. JR One sirve a Lutz con la misma precisión y dedicación que llevamos a cada comunidad de Tampa Bay.",
    weatherNote: "La característica copa de robles y pinos de Lutz deja escombros todo el año, haciendo que el mantenimiento de canaletas y los protectores sean especialmente importantes. Combinado con las fuertes lluvias estacionales de Florida, canaletas tapadas aquí llevan a pudrición de fascias y problemas de cimientos rápidamente.",
    nearbyText: "También servimos a Land O' Lakes, Wesley Chapel y Tampa.",
  },
  "south-tampa": {
    heroH1: "Empresa Familiar de South Tampa en",
    heroH1Gold: "Canaletas, Sofitos y Cobre",
    localP: "South Tampa va desde Bayshore Boulevard hasta Davis Islands, de Hyde Park a Beach Park y Palma Ceia: una mezcla de casas históricas con canaletas originales de cobre, construcción nueva de alta gama frente al agua, y vecindarios con HOA que no aceptan trabajo apurado. JR One maneja todo: restauración de cobre en bungalows de Hyde Park, instalación de canaletas de aluminio sin costura con clasificación para huracanes en construcciones nuevas de Beach Park, y trabajo de sofitos que cumple con los comités de revisión arquitectónica que escudriñan cada detalle.",
    weatherNote: "Las propiedades frente a Bayshore reciben aire salado constante más exposición directa a marejadas de sistemas tropicales. Los huracanes Idalia y Helene metieron agua en plantas bajas al sur de Gandy. Los vecindarios interiores de South Tampa ven las mismas tormentas intensas de la tarde que el resto de la ciudad. Ambos exigen aluminio resistente a la corrosión y fijación con clasificación para huracanes, y ambos recompensan el trabajo de calidad con vida útil mucho más larga.",
    nearbyText: "También servimos a Tampa, Clearwater, St. Petersburg y comunidades cercanas de Hillsborough County.",
  },
  // ── 7 mission cities added 2026-05-23 (Play 4) ──
  "new-tampa": {
    heroH1: "Empresa Familiar de New Tampa en",
    heroH1Gold: "Canaletas, Sofito y Aluminio",
    localP: "New Tampa está en el borde interior del condado de Hillsborough, donde las comunidades planificadas de Cory Lake Isles, Tampa Palms, Hunter's Green, West Meadows, Cross Creek, K-Bar Ranch, Easton Park, Live Oak Preserve, Heritage Isles y Pebble Creek reciben tormentas fuertes sin la brisa del Golfo que seca los techos. Los techos de Tampa Palms y Hunter's Green corren de 2,800 a 4,500 pies cuadrados, lo que significa que las canaletas de 5 pulgadas se desbordan en la primera lluvia fuerte. JR One instala canaletas de 6 pulgadas como base en New Tampa y 7 pulgadas cuando la carga del techo lo exige. Familia, más de 30 años en el oficio. Hablamos español.",
    weatherNote: "Las tormentas del interior dejan caer lluvia más pesada en menos tiempo. La brisa del Golfo que seca los techos de Pinellas nunca llega a K-Bar Ranch o Live Oak Preserve. Bajantes del tamaño correcto más drenaje subterráneo PVC sacan ese volumen lejos de la losa antes de que rote la fascia.",
    nearbyText: "También servimos a Wesley Chapel, Tampa, Lutz, Temple Terrace y comunidades cercanas de Hillsborough County.",
  },
  valrico: {
    heroH1: "Empresa Familiar de Valrico en",
    heroH1Gold: "Canaletas y Sofito",
    localP: "Valrico está en el este de Hillsborough donde vecindarios establecidos como Bloomingdale y las comunidades cercanas a FishHawk mezclan dosel maduro de roble con hogares familiares suburbanos. Los robles dejan caer escombros todo el año, las tormentas de verano descargan más lluvia que las ciudades costeras del Golfo, y el suelo drena lentamente. JR One maneja Valrico como las casas aquí lo merecen: canaletas continuas de 6 y 7 pulgadas, protectores de malla fina, y drenaje subterráneo PVC que mueve el agua lejos de la losa. Familia, más de 30 años en el oficio.",
    weatherNote: "El dosel maduro de roble de Valrico significa que las hojas y bellotas tapan las canaletas más rápido que en casas sin árboles. Combinado con las tormentas de la tarde más fuertes del este de Hillsborough, la diferencia entre un sistema de 6 pulgadas con protectores y uno de 5 pulgadas calidad-constructor es la diferencia entre cimientos limpios y cuatro mil dólares de pudrición de fascia.",
    nearbyText: "También servimos a Brandon, Riverview, Lithia, Plant City y comunidades cercanas de Hillsborough County.",
  },
  lithia: {
    heroH1: "Empresa Familiar de Lithia en",
    heroH1Gold: "Canaletas, Cobre y Aluminio",
    localP: "Lithia se centra en FishHawk Ranch, una de las comunidades planificadas más respetadas del este de Hillsborough. Las casas de FishHawk son más grandes, los techos más inclinados, y los árboles más viejos. Esa combinación requiere capacidad real de canaleta (7 pulgadas en los techos más grandes), sistemas de protección reales para la carga de escombros del roble, y atención real al detalle del fascia porque los comités de HOA de FishHawk notan todo. JR One trae 30 años de experiencia familiar en el oficio de canaletas de Tampa Bay a cada instalación en Lithia. Hablamos español.",
    weatherNote: "Lithia y FishHawk reciben las tormentas de la tarde más fuertes del este de Hillsborough con muy poca brisa del Golfo para secar los techos entre tormentas. La humedad todo el año más la cobertura madura de roble acelera la pudrición de fascia, especialmente detrás de canaletas subdimensionadas que se desbordan en las esquinas.",
    nearbyText: "También servimos a Valrico, Riverview, Brandon y comunidades cercanas del este de Hillsborough County.",
  },
  oldsmar: {
    heroH1: "Empresa Familiar de Oldsmar en",
    heroH1Gold: "Canaletas y Aluminio",
    localP: "Oldsmar está en la cabecera de Old Tampa Bay donde Pinellas, Hillsborough y el agua abierta se encuentran. El aire salado corroe todo menos el aluminio, los sistemas tropicales empujan agua tierra adentro por Safety Harbor y Tampa Road, y los vecindarios más antiguos tienen sofito y fascia de madera que treinta años de humedad han ablandado. JR One sirve a Oldsmar con canaletas de aluminio resistentes a la corrosión, reemplazo de sofito ventilado, y la fijación resistente a huracán que Pinellas necesita. Familia, más de 30 años en el oficio. Hablamos español.",
    weatherNote: "La posición de cabecera de bahía de Oldsmar significa que la marejada de tormentas tropicales empuja tierra adentro desde Old Tampa Bay, y los vientos cargados de sal llegan más lejos de lo que la mayoría de los pueblos de Pinellas se imaginan. El aluminio es el único material de canaleta y sofito que aguanta aquí a largo plazo.",
    nearbyText: "También servimos a Safety Harbor, Tampa, Clearwater, Palm Harbor y comunidades cercanas de Pinellas County.",
  },
  "safety-harbor": {
  ...
  seminole: {
    ...
    heroH1Gold: "Canaletas y Aluminio",
    localP: "Seminole está en el corazón del condado central de Pinellas donde la vivienda de los años 70 a 90 es el inventario dominante. Eso significa que la mayoría de las casas aquí tienen sofito y fascia originales de madera que llevan más de cuarenta años cocinándose en el sol y la humedad de Florida, más sistemas de canaleta subdimensionados que nunca igualaron la carga del techo. JR One maneja Seminole como estas casas lo merecen: conversión completa de madera a aluminio en sofito y fascia, canaletas de aluminio sin costura de 6 pulgadas como nueva base, y drenaje subterráneo cuando la losa lo necesita. Hablamos español.",
    weatherNote: "La ubicación central de Pinellas de Seminole recibe el clima costero sin las primas de dirección costera, más densidad residencial establecida que significa escombros de árboles y bajantes envejecidos como items constantes de mantenimiento. Canaletas del tamaño correcto y fascia envuelto en aluminio previenen la cascada de problemas que empieza con un evento de desbordamiento.",
    nearbyText: "También servimos a Largo, Pinellas Park, St. Petersburg, Clearwater y comunidades cercanas de Pinellas County.",
  },
  "pinellas-park": {
    heroH1: "Empresa Familiar de Pinellas Park en",
    heroH1Gold: "Canaletas y Trabajo Comercial",
    localP: "Pinellas Park es Pinellas central denso: vecindarios establecidos de viviendas unifamiliares, propiedades comerciales pequeñas, y edificios de apartamentos multifamiliares que todos necesitan trabajo de canaletas, sofito y fascia que aguante el clima de Florida. El lado comercial aquí es más activo que en la mayoría de las ciudades de Pinellas, lo que hace de Pinellas Park un encaje natural para los sistemas de canaletas comerciales de JR One y los contratos de mantenimiento HOA además del trabajo residencial estándar. Familia, más de 30 años en el oficio. Hablamos español.",
    weatherNote: "La posición central de Pinellas Park significa que usted recibe la actividad de tormentas sin la brisa de aire salado que seca los pueblos costeros vecinos. La humedad todo el año más el inventario de vivienda suburbana más antigua significa que el sofito y fascia de aluminio son reemplazos generalmente atrasados, no actualizaciones de lujo.",
    nearbyText: "También servimos a Largo, Seminole, St. Petersburg, Clearwater y comunidades cercanas de Pinellas County.",
  },
};

const SERVICES_ES = [
  { icon: "water", title: "Instalación de Canaletas Sin Costura", ctaPhrase: "instalación de canaletas sin costura", desc: "Fabricadas a medida en el sitio para un ajuste perfecto sin fugas.", link: "/seamless-aluminum-gutters", comboSlug: "seamless-aluminum-gutters" },
  { icon: "shield", title: "Protectores de Canaletas", ctaPhrase: "instalación de protectores de canaletas", desc: "Mantienen los escombros afuera y facilitan el mantenimiento.", link: "/gutter-guards", comboSlug: "gutter-guards" },
  { icon: "edge", title: "Sofitos y Fascias", ctaPhrase: "reemplazo de sofito y fascia", desc: "Protección de aluminio y vinilo para el borde de su techo.", link: "/soffit-and-fascia", comboSlug: "soffit-and-fascia" },
...
const T = {
  ...
  es: {
    ...
    promoBannerPost: ". Llame al (844) 444-3114 para su Cotización Gratis",
    breadHome: "Inicio",
    ...
    getQuote: "OBTENGA SU COTIZACIÓN GRATIS",
    callBtn: "LLAMAR AL (844) 444-3114",
    freeQuoteFor: "Cotización Gratis para Propietarios en ",
    freeQuoteSuffix: "",
    ...
    goldSteps: [
      ...
      { num: "02", title: "Diseñar", desc: "Una solución personalizada con un presupuesto detallado y transparente. Usted ve exactamente lo que recibirá." },
      { num: "03", title: "Instalar", desc: "Nuestro equipo capacitado realiza la instalación con precisión. Protegemos su propiedad y limpiamos como si nunca hubiéramos estado ahí." },
      { num: "04", title: "Proteger", desc: "Revisamos el trabajo terminado con usted, lo respaldamos con nuestra garantía de calidad y hacemos seguimiento." },
    ],
    neighborhoodsLabel: "Vecindarios que Servimos",
    reviewsEyebrow: "RESEÑAS",
    reviewsTitle: "De Confianza en Todo Tampa Bay",
    reviews: [
      { text: "Desde el principio, trabajaron para asegurar que recibiera una cotización justa. Sin presión de venta. El trabajo fue excepcional.", name: "Lois G.", service: "Tampa", stars: 5 },
      { text: "Después de Milton llamé a una docena de empresas. Solo JR One devolvió la llamada. Hicieron un trabajo perfecto.", name: "Matt D.", service: "Tampa Bay", stars: 5 },
      { text: "Seis personas en el sitio con un gerente de equipo. Reemplazaron todo el sofito y fascia con aluminio, repararon todo el daño de termitas. Hecho en días.", name: "Propietario de Tampa", service: "", stars: 5 },
    ],
    ctaSuffix: " Propietario? Hablemos.",
    ctaDesc: "Obtenga su cotización gratis y sin presión de una empresa familiar de aluminio en Tampa Bay. Respondemos en pocas horas.",
    scrollForm: "IR AL FORMULARIO",
    notFound: "Página de ciudad no encontrada. Disponibles: ",
  },
};
        ...
        <section style={{ background: "var(--jr-paper)", padding: "var(--jr-space-20) 0" }}>
          <Container>
            <SectionHeading
              ...
              title={lang === "en" ? `${city.name} Homeowner Guides` : `Guías para Propietarios en ${city.name}`}
            />
            <p
              style={{
                fontFamily: "var(--jr-font-body)",
            ...
            >
              {lang === "en"
                ...
                : `Precios detallados, comparaciones y específicos de Tampa Bay con 30+ años en el oficio. Números reales, sin relleno.`}
            </p>
            <div
              style={{
                display: "grid",
              ...
              {[
                {
                  ...
                  title: lang === "en" ? "Gutter Installation Cost in Tampa (2026)" : "Costo de Instalación de Canaletas en Tampa (2026)",
                ...
                },
                {
                  ...
                  desc: lang === "en" ? "Brand comparison (LeafFilter, Gutter Helmet, MasterShield), micro mesh vs solid, what works in Tampa." : "Comparación de marcas (LeafFilter, Gutter Helmet, MasterShield), malla fina vs sólido, lo que funciona en Tampa.",
                },
                {
                  ...
                  desc: lang === "en" ? "Save up to 70% versus replacement. Cost per sq ft, Roof Maxx comparison, ideal candidate roofs." : "Ahorre hasta 70% versus reemplazo. Costo por pie cuadrado, comparación con Roof Maxx, techos candidatos ideales.",
                },
                {
                  ...
                  desc: lang === "en" ? "What's a fair price, per-city pricing, DIY vs professional decision tree, hurricane-season timing." : "Cuál es un precio justo, precios por ciudad, decisión DIY vs profesional, momento para temporada de huracanes.",
                },
              ].map((r, i) => (
                <a
                  key={i}
