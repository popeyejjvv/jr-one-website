...
const CITIES = {
  ...
  "south-tampa": { name:"South Tampa", county:"Hillsborough County", slug:"south-tampa", heroH1:"South Tampa's Premier", heroH1Gold:"Gutter, Soffit & Copper Specialists", localP:"South Tampa runs from Bayshore Boulevard to Davis Islands, Hyde Park to Beach Park and Palma Ceia — a mix of historic homes with original copper gutters, premium new construction along the water, and HOA-governed neighborhoods that don't accept rushed work. JR One handles all of it: copper restoration on bungalows in Hyde Park, hurricane-rated seamless aluminum on new builds in Beach Park, and architectural-board-compliant soffit work where the review committee scrutinizes every detail.", weatherNote:"Bayshore-facing properties take constant salt air plus direct exposure to tropical-system storm surge — Hurricane Idalia and Helene both pushed water into ground floors south of Gandy. Inland South Tampa neighborhoods see the same intense afternoon thunderstorms as the rest of the city. Both demand corrosion-resistant aluminum and proper hurricane-rated fastening, and both reward quality work with much longer system life.", neighborhoods:["Bayshore Boulevard","Hyde Park","Davis Islands","Palma Ceia","Beach Park","SoHo","Bayshore Beautiful","Sunset Park","Virginia Park","Westshore"], nearbyText:"We also serve Tampa, Clearwater, St. Petersburg, and surrounding Hillsborough County." },
};
...
const CITIES_ES = {
  ...
  "south-tampa": {
    heroH1: "Especialistas Premium en", heroH1Gold: "Canaletas, Sofitos y Cobre en South Tampa",
