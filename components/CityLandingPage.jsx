...
const T = {
  en: {
    ...
    placeZip: "ZIP Code",
    serviceOpts: ["What do you need?", "Commercial Gutters", "Copper Gutters", "Drainage Installation", "Govee Lights", "Gutter Cleaning", "Gutter Guards", "Gutter Repair", "SAGIPER", "Seamless Gutters", "Service Plans", "Siding", "Soffit & Fascia", "Specialty Gutters", "HOA Contracts", "Rental Property Maintenance", "Other / Not Sure"],
    ...
    servicesSub: "Gutters, soffit, fascia, and drainage. Built for Tampa Bay weather.",
  ...
  es: {
    ...
    servicesSub: "Canaletas, sofito, fascia y drenaje. Construido para el clima de Tampa Bay.",
