...
const T = {
  en: {
    ...
    peakDesc: "restores shingles from the inside out — adds 6–10 years of roof life for up to 70% less than a new roof install, with warranty docs Florida carriers need to see when evaluating your renewal.",
  ...
  es: {
    ...
    peakDesc: "restaura las tejas desde adentro — agrega 6–10 anos de vida al techo por hasta 70% menos que una instalacion de techo nuevo, con documentos de garantia que las aseguradoras de FL necesitan ver al evaluar su renovacion.",
