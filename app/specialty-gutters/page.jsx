...
const T = {
  en: {
    ...
    peakDesc: "restores shingles from the inside out — adds 6–10 years without the $15K–$25K+ replacement bill, with warranty docs your insurer must accept under FL law.",
  ...
  es: {
    ...
    peakDesc: "restaura las tejas desde adentro — agrega 6–10 anos sin la cuenta de $15K–$25K+ de un reemplazo, con documentos de garantia que su aseguradora debe aceptar bajo la ley de FL.",
