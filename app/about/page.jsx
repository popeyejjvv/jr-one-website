...
const T = {
  ...
  es: {
    ...
    heroP: "La historia no nació en una sala de juntas. Nació en un techo en Tampa en 1990, con un hombre de Honduras, una máquina de canaletas y la convicción de que el trabajo honesto construye una vida honesta. En 2006, su hijo Christopher formó JR One Aluminum LLC para llevar el oficio familiar hacia adelante. Así llegamos hasta aquí.",
    ch1Year: "1990",
    ch1Title: "De Honduras a Tampa Bay",
    ch1P1: "En 1990, Javier Rivera inmigró a Tampa desde Honduras y comenzó a hacer lo que sabía. Trabajar con sus manos. Empezó instalando canaletas, aprendiendo el oficio desde cero y construyendo una reputación casa por casa.",
