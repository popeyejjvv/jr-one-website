...
const T = {
  en: {
    ...
    heroP: "The story didn't start in a boardroom. It started on a rooftop in Tampa over 30 years ago, with a man from Honduras, a gutter machine, and a belief that honest work builds an honest life. Years later, his son Christopher formed JR One Aluminum LLC to carry the family trade forward. This is how we got here.",
    ch1Year: "The Beginning",
    ch1Title: "From Honduras to Tampa Bay",
    ch1P1: "Over 30 years ago, Javier Rivera immigrated to Tampa from Honduras and started doing what he knew, working with his hands. He began installing gutters, learning the trade from the ground up, and building a reputation one house at a time.",
    ...
    stats: [
      { value: "30+", label: "Years in the Tampa Bay gutter trade" },
      { value: "2", label: "Generations, family-owned" },
    ...
    servicesP: "We do one thing and we do it well. Aluminum exterior systems. Gutters, soffit, fascia, siding, and gutter guards. No roofing. No painting. No general contracting. Just aluminum, done right.",
    services: [
    ...
    imgAlt: "Javier Rivera, founder of the family trade, with over 30 years in Tampa Bay gutters",
  },
  es: {
    ...
    heroP: "La historia no nació en una sala de juntas. Nació en un techo en Tampa hace más de 30 años, con un hombre de Honduras, una máquina de canaletas y la convicción de que el trabajo honesto construye una vida honesta. Años después, su hijo Christopher formó JR One Aluminum LLC para llevar el oficio familiar hacia adelante. Así llegamos hasta aquí.",
    ch1Year: "El Comienzo",
    ch1Title: "De Honduras a Tampa Bay",
    ch1P1: "Hace más de 30 años, Javier Rivera inmigró a Tampa desde Honduras y comenzó a hacer lo que sabía. Trabajar con sus manos. Empezó instalando canaletas, aprendiendo el oficio desde cero y construyendo una reputación casa por casa.",
    ...
    ch3P1: "Christopher Rivera había estado haciendo estimados con su padre desde los nueve años. Mientras otros niños jugaban, él estaba aprendiendo a leer una línea de techo, medir un tramo de canaleta y hablar con propietarios sobre la protección de sus hogares.",
    ...
    ch3P3: "Hoy, JR One Aluminum LLC opera tres cuadrillas internas que sirven a Tampa Bay y la costa oeste de Florida. Algunas de las casas en las que trabajamos son las mismas casas donde Javier instaló canaletas hace décadas. Hemos regresado a rehacer su trabajo original, lo cual nos llena de humildad y es un recordatorio de que este oficio lo llevamos en la sangre.",
    ...
    stats: [
      { value: "30+", label: "Años en el oficio de canaletas de Tampa Bay" },
      { value: "2", label: "Generaciones, empresa familiar" },
    ...
    servicesP: "Hacemos una cosa y la hacemos bien. Sistemas exteriores de aluminio. Canaletas, sofitos, fascia, revestimiento y protectores de canaletas. Sin techado. Sin pintura. Sin contratación general. Solo aluminio, bien hecho.",
    services: [
    ...
    ctaSub: "Obtén tu cotización gratuita sin presión. Respondemos en horas y te explicamos todo tan detalladamente como esperarías de nosotros.",
    ctaForm: "Solicitar Cotización",
    imgAlt: "Javier Rivera, fundador del oficio familiar, con más de 30 años en canaletas de Tampa Bay",
  },
};
