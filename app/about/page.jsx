...
const T = {
  en: {
    ...
    heroTag: "OUR STORY",
    heroH1a: "Three Decades. One Family.",
    heroH1b: "One Standard.",
    heroP: "JR One didn't start in a boardroom. It started on a rooftop in Tampa in 1990, with a man from Honduras, a gutter machine, and a belief that honest work builds an honest life. This is how we got here.",
    ch1Year: "1990",
    ...
    ch3P3: "Today, JR One Aluminum operates three in-house crews serving Tampa Bay and Florida's west coast. Some of the homes we work on are the same homes Javier installed gutters on 30 years ago. We've gone back and redone his original work — which is both humbling and a reminder that this trade is in our blood.",
    ...
    imgAlt: "Javier Rivera — Founder of JR One Aluminum",
  },
  es: {
    breadcrumbHome: "Inicio",
    breadcrumbAbout: "Sobre Nosotros",
    heroTag: "NUESTRA HISTORIA",
    heroH1a: "Tres Decadas. Una Familia.",
    heroH1b: "Un Solo Estandar.",
    heroP: "JR One no nacio en una sala de juntas. Nacio en un techo en Tampa en 1990, con un hombre de Honduras, una maquina de canaletas y la conviccion de que el trabajo honesto construye una vida honesta. Asi llegamos hasta aqui.",
    ch1Year: "1990",
    ...
    ch3P3: "Hoy, JR One Aluminum opera tres cuadrillas internas que sirven a Tampa Bay y la costa oeste de Florida. Algunas de las casas en las que trabajamos son las mismas casas donde Javier instalo canaletas hace 30 anos. Hemos regresado a rehacer su trabajo original — lo cual es humilde y un recordatorio de que este oficio lo llevamos en la sangre.",
    ...
    stats: [
      {value:"1990",label:"Ano de fundacion por Javier Rivera"},
      {value:"30+",label:"Anos sirviendo a Tampa Bay"},
    ...
    imgAlt: "Javier Rivera — Fundador de JR One Aluminum",
  },
};
