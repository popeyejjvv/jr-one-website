...
const T = {
  en: {
    ...
    heroP: "SAGIPER architectural cladding systems, made in Portugal. Solar Shield Technology, 50-year limited warranty with 15 years non-prorated across the full product line, no repainting or sealing cycle. Built for Florida sun and the homeowners and architects who want dark colors that hold their finish.",
    ...
    stats: [
      ...
      { value: "Custom", label: "Color and finish matched" },
    ...
    products: [
      ...
      { emoji: "📐", name: "SAGIBATTEN", subtitle: "Aluminum Batten System", desc: "2mm wall thickness. 7 size options from 1\"x2\" to 2\"x8\". Woodgrain finishes including Nordic series. For contemporary facades, pergolas, accent walls, and baffle ceilings. 50-year limited warranty, 15 years non-prorated." },
    ],
    ...
    whyItems: [
      ...
      { title: "No repainting or sealing", desc: "No painting, staining, or sealing in normal service. Periodic washing keeps the finish clean. 50-year limited warranty with 15 years non-prorated across the full product line." },
    ...
    goldSteps: [
      ...
      { num: "04", title: "Protect", desc: "Every SAGIPER line we install, SagiWall, SagiRev, SagiBond, and SagiBatten, is covered by SAGIPER's 50-year limited warranty, which includes 15 years non-prorated. No painting, staining, or sealing in normal service. Periodic washing is the upkeep it asks for." },
    ],
  ...
  es: {
    ...
    stats: [
      ...
      { value: "A medida", label: "Color y acabado combinados" },
    ...
    products: [
      { emoji: "🏠", name: "SAGIWALL", subtitle: "Revestimiento Exterior", desc: "PVC machihembrado con película Solar Shield Technology de 5 capas. Perfiles acanalados y V-groove. Ancho de 6\", longitudes hasta 35 ft (uniones mínimas). Acabados de madera, metálicos y colores RAL. Evaluado ICC-ES ESR-4876. Probado NFPA 285 contra incendios. Probado ASTM E330 carga de viento. Garantía limitada de 50 años, 15 años sin prorrateo." },
      ...
      { emoji: "📐", name: "SAGIBATTEN", subtitle: "Sistema de Listones de Aluminio", desc: "Espesor de pared de 2mm. 7 opciones de tamaño desde 1\"x2\" hasta 2\"x8\". Acabados de madera incluyendo serie Nordic. Para fachadas contemporáneas, pérgolas, paredes de acento y techos de deflectores. Garantía limitada de 50 años, 15 años sin prorrateo." },
    ],
    ...
    whyItems: [
      ...
      { title: "Sin repintado ni sellado", desc: "Sin pintura, sin tinte, sin sellado en servicio normal. Un lavado periódico mantiene limpio el acabado. Garantía limitada de 50 años con 15 años sin prorrateo en toda la línea de productos." },
    ...
    goldSteps: [
      ...
      { num: "04", title: "Proteger", desc: "Cada línea SAGIPER que instalamos, SagiWall, SagiRev, SagiBond y SagiBatten, queda cubierta por la garantía limitada de 50 años de SAGIPER, que incluye 15 años sin prorrateo. Sin pintura, sin tinte, sin sellado en servicio normal. Un lavado periódico es todo el cuidado que pide." },
    ],
