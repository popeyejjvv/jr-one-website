...
export default function SagiperPage() {
  ...
  return (
    <div style={{background:C.bg,color:C.white,fontFamily:f.b,lineHeight:1.65,minHeight:"100vh"}}>
      <div style={{background:`linear-gradient(90deg,${C.accent},${C.accentLight})`,padding:"10px 24px",textAlign:"center",fontFamily:f.h,fontSize:"13px",fontWeight:600,color:C.white}}>SAGIPER Architectural Cladding — Engineered in Portugal, Made in Plant City, FL — Call (844) 444-3114</div>
