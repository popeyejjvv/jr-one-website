...
const T = {
  en: {
    ...
    products: [
      ...
      { emoji: "🛡️", name: "SAGIBOND", subtitle: "Aluminum Composite Material Panels", desc: "Three constructions: FireGuard (fire-rated), HexaCore (honeycomb, superior rigidity), SlimShield (solid 3mm aluminum). Modern commercial facades with woodgrain warmth. 4ft x 16ft sheets. Warranty terms are in the manufacturer's written documentation, provided with your estimate." },
      { emoji: "📐", name: "SAGIBATTEN", subtitle: "Aluminum Batten System", desc: "2mm wall thickness. 7 size options from 1\"x2\" to 2\"x8\". 24+ woodgrain finishes including Nordic series. For contemporary facades, pergolas, accent walls, and baffle ceilings. Warranty terms are in the manufacturer's written documentation, provided with your estimate." },
    ],
