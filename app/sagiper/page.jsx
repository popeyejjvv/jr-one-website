...
const T = {
  en: {
    ...
    heroP: "SAGIPER architectural cladding systems. Engineered in Portugal, manufactured in Plant City, FL. Solar Shield Technology, 50-year warranty, no repainting or sealing cycle. Built for Florida sun and the homeowners and architects who want dark colors that hold their finish.",
    ...
    whyItems: [
      ...
      { title: "No repainting or sealing", desc: "No painting, staining, or sealing in normal service. Periodic washing keeps the finish clean. 50-year warranty with 15 years non-prorated." },
    ...
    goldSteps: [
      ...
      { num: "04", title: "Protect", desc: "Your home is covered by SAGIPER's 50-year warranty with 15 years non-prorated. No painting, staining, or sealing in normal service. Periodic washing is the upkeep it asks for." },
    ],
    ...
    faqs: [
      { q: "What is SAGIPER?", a: "SAGIPER is a Portuguese manufacturer (established 1994) of architectural PVC and aluminum cladding systems. Their North American headquarters includes manufacturing in Plant City, FL, making them a local Florida producer with European engineering standards." },
      ...
      { q: "How much does SAGIPER cost vs. regular siding?", a: "SAGIPER costs more upfront than standard vinyl. The 50-year warranty, the absence of a repainting cycle, and architect-grade aesthetics make it the strongest long-term value on the right home." },
  ...
  es: {
    ...
    whyItems: [
      ...
      { title: "Sin repintado ni sellado", desc: "Sin pintura, sin tinte, sin sellado en servicio normal. Un lavado periódico mantiene limpio el acabado. Garantía de 50 años con 15 años sin prorrateo." },
    ...
    goldSteps: [
      ...
      { num: "04", title: "Proteger", desc: "Su casa está cubierta por la garantía de 50 años de SAGIPER con 15 años sin prorrateo. Sin pintura, sin tinte, sin sellado en servicio normal. Un lavado periódico es todo el cuidado que pide." },
    ],
    ...
    faqs: [
      { q: "¿Qué es SAGIPER?", a: "SAGIPER es un fabricante portugués (establecido en 1994) de sistemas de revestimiento arquitectónico en PVC y aluminio. Su sede norteamericana incluye manufactura en Plant City, FL, lo que los convierte en un productor local de Florida con estándares de ingeniería europea." },
      ...
      { q: "¿Cuánto cuesta SAGIPER vs. el revestimiento regular?", a: "SAGIPER cuesta más al inicio que el vinilo estándar. La garantía de 50 años, la ausencia de un ciclo de repintado y la estética de grado arquitectónico lo convierten en el valor a largo plazo más fuerte en la casa indicada." },
