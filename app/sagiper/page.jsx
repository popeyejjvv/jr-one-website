...
const T = {
  en: {
    ...
    heroP: "SAGIPER architectural cladding systems. Engineered in Portugal, manufactured in Plant City, FL. Solar Shield Technology, 50-year warranty, virtually zero maintenance. Built for Florida sun and the homeowners and architects who want dark colors that won't warp.",
    ...
    whyItems: [
      ...
      { title: "Virtually zero maintenance", desc: "No painting, staining, or sealing in normal service. 50-year warranty with 15 years non-prorated." },
    ...
    goldSteps: [
      ...
      { num: "04", title: "Protect", desc: "Your home is covered by SAGIPER's 50-year warranty with 15 years non-prorated. Virtually zero maintenance. No painting, staining, or sealing. Ever." },
    ],
  ...
  es: {
    ...
    heroP: "Sistemas de revestimiento arquitectónico SAGIPER. Ingeniería portuguesa, fabricados en Plant City, FL. Tecnología Solar Shield, garantía de 50 años, prácticamente cero mantenimiento. Hecho para el sol de Florida y para los propietarios y arquitectos que quieren colores oscuros que no se deformen.",
    ...
    whyItems: [
      ...
      { title: "Prácticamente cero mantenimiento", desc: "Sin pintura, sin tinte, sin sellado en servicio normal. Garantía de 50 años con 15 años sin prorrateo." },
    ...
    goldSteps: [
      ...
      { num: "04", title: "Proteger", desc: "Su casa está cubierta por la garantía de 50 años de SAGIPER con 15 años sin prorrateo. Prácticamente cero mantenimiento. Sin pintura, sin tinte, sin sellado en servicio normal." },
    ],
