...
/* NOTE (2026-07-04 audit fix): SAGIPER country of origin is UNCONFIRMED.
   The site previously claimed both "Engineered in Portugal / manufactured in
   Plant City, FL" (this page) and "Canadian-engineered / Manufactured in
   Canada" (layout.js + public/llms/jrone-sagiper.md). All origin claims are
   neutralized to "premium European-engineered composite cladding" until
   Popeye confirms the true origin. Do not restore a specific country or
   manufacturing-location claim without verification. */
...
const T = {
  en: {
    ...
    heroP: "SAGIPER premium European-engineered composite cladding systems. Solar Shield Technology, 50-year warranty, virtually zero maintenance. Built for Florida sun and the homeowners and architects who want dark colors that won't warp.",
    ...
    whyItems: [
      ...
      { title: "Virtually zero maintenance", desc: "No painting, staining, or sealing required. 50-year warranty with 15 years non-prorated." },
      { title: "European-engineered", desc: "Premium European-engineered composite cladding, specified for the Florida market." },
    ],
    ...
    goldSteps: [
      ...
      { num: "04", title: "Protect", desc: "Your home is covered by SAGIPER's 50-year warranty with 15 years non-prorated. Virtually zero maintenance. No painting, staining, or sealing required." },
    ],
    ...
    faqs: [
      { q: "What is SAGIPER?", a: "SAGIPER is a manufacturer of premium European-engineered architectural PVC and aluminum cladding systems, available in the Florida market and installed by JR One Aluminum across Tampa Bay." },
      { q: "How is SAGIPER different from regular vinyl siding?", a: "Solar Shield Technology prevents heat absorption, so dark colors won't warp like standard vinyl. Custom lengths up to 35 feet minimize seams. Architect-grade specs (BIM/Revit files, CSI specs) put it in a different category. 50-year warranty vs. standard prorated warranties." },
      ...
      { q: "How much does SAGIPER cost vs. regular siding?", a: "SAGIPER costs more upfront than standard vinyl. The 50-year warranty, virtually zero maintenance, and architect-grade aesthetics make it the best long-term value." },
    ...
    ctaTitle: "Ready for Cladding That Lasts a Lifetime?",
  ...
  es: {
    ...
    heroP: "Sistemas SAGIPER de revestimiento compuesto premium de ingeniería europea. Tecnología Solar Shield, garantía de 50 años, prácticamente cero mantenimiento. Hecho para el sol de Florida y para los propietarios y arquitectos que quieren colores oscuros que no se deformen.",
    ...
    whyItems: [
      ...
      { title: "Prácticamente cero mantenimiento", desc: "No requiere pintura, tinte ni sellado. Garantía de 50 años con 15 años sin prorrateo." },
      { title: "Ingeniería europea", desc: "Revestimiento compuesto premium de ingeniería europea, especificado para el mercado de Florida." },
    ],
    ...
    goldSteps: [
      ...
      { num: "04", title: "Proteger", desc: "Su casa está cubierta por la garantía de 50 años de SAGIPER con 15 años sin prorrateo. Prácticamente cero mantenimiento. No requiere pintura, tinte ni sellado." },
    ],
    ...
    faqs: [
      { q: "¿Qué es SAGIPER?", a: "SAGIPER es un fabricante de sistemas premium de revestimiento arquitectónico en PVC y aluminio de ingeniería europea, disponibles en el mercado de Florida e instalados por JR One Aluminum en todo Tampa Bay." },
      { q: "¿En qué se diferencia SAGIPER del revestimiento de vinilo común?", a: "La Tecnología Solar Shield previene la absorción de calor, lo que significa que los colores oscuros no se deformarán como el vinilo estándar. Longitudes personalizadas hasta 35 pies minimizan las uniones. Especificaciones de grado arquitectónico (archivos BIM/Revit, especificaciones CSI) lo ponen en una categoría diferente. Garantía de 50 años vs. garantías estándar prorrateadas." },
      ...
      { q: "¿Cuánto cuesta SAGIPER vs. el revestimiento regular?", a: "SAGIPER cuesta más al inicio que el vinilo estándar. La garantía de 50 años, prácticamente cero mantenimiento y la estética de grado arquitectónico lo convierten en el mejor valor a largo plazo." },
    ...
    ctaTitle: "¿Listo para un Revestimiento Que Dura Toda la Vida?",
