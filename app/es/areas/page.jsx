...
export default function AreasIndexPageES() {
  ...
  const collectionSchema = {
    ...
    description: "29 ciudades de Tampa Bay atendidas por JR One Aluminum LLC para canaletas sin costura, sofito, fascia, protectores, cobre, iluminación Govee instalada profesionalmente y siding.",
    isPartOf: {
      "@type": "WebSite",
        ...
        <section style={{ padding: "var(--jr-space-16) var(--jr-space-6) var(--jr-space-8)", textAlign: "center" }}>
          <div style={{ maxWidth: "var(--jr-container)", margin: "0 auto" }}>
            ...
            <p style={{ fontSize: "var(--jr-text-lg)", color: C.muted, maxWidth: "780px", margin: "0 auto var(--jr-space-2)" }}>
              29 ciudades en 7 condados del área de Tampa Bay. Canaletas de aluminio sin costura, sofito, fascia, protectores de canaletas, cobre, iluminación Govee instalada profesionalmente, siding y drenaje. Más de 30 años en el oficio, empresa familiar, totalmente asegurada.
            </p>
