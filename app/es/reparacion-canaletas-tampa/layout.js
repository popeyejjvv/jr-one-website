...
const serviceSchemaEs = {
  ...
  description: "Reparación de canaletas en Tampa Bay: hundimientos, fugas, desbordamiento, reemplazo de bajantes, daño de tormenta. Servicio misma semana. Familia, más de 30 años en el oficio.",
};
...
export const metadata = {
  ...
  description: "Reparación de canaletas en Tampa Bay: hundimientos, fugas, desbordamiento, daño de tormenta. Servicio misma semana. (844) 444-3114. Hablamos español.",
  alternates: {
  ...
  openGraph: {
    ...
    description: "Hundimientos, fugas, desbordamiento, daño de tormenta. Servicio misma semana. (844) 444-3114.",
