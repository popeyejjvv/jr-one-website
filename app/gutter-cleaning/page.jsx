...
const T = {
  ...
  es: {
    ...
    heroP: "La limpieza de canaletas de JR One Aluminum cuesta $150 a $400 en una casa unifamiliar típica en Tampa, FL, con precio según pies lineales, altura del techo y acceso, uno o dos pisos, cantidad de escombro y número de bajantes. La mayoría de limpiadores sacan escombros y se van. Nosotros removemos cada pedazo, lavamos cada bajante, inspeccionamos cada soporte, fotografiamos cualquier problema y nos llevamos los desechos.",
    btnEstimate: "RESERVE SU LIMPIEZA",
    btnEstimator: "VEA SU RANGO DE PRECIO",
    btnCall: "(844) 444-3114",
    problemTag: "POR QUÉ NECESITAN MÁS",
    problemTitle: "Los Árboles de Florida Nunca Paran",
    problems: [
      { title: "Los robles tiran cada mes", desc: "El roble vivo de Tampa tira hojas los 12 meses, no solo en otoño. La mayoría de dueños subestima cuánto escombro ven sus canaletas entre limpiezas. A los 6 meses sin limpieza ya hay agua estancada." },
      { title: "Las agujas de pino se compactan", desc: "Las agujas de pino son el peor enemigo. Se encajan en el canal, se compactan contra el bajante y bloquean el flujo completamente. Las casas con pinos necesitan limpieza más frecuente." },
      { title: "Cada tormenta descarga escombro nuevo", desc: "Las tormentas de verano y los huracanes cargan canaletas con escombros frescos en un solo evento. Una canaleta limpiada en mayo puede estar tapada después de una sola tormenta de agosto." },
      { title: "Limpiezas saltadas cuestan miles", desc: "Salte dos limpiezas y el desbordamiento satura la fascia detrás de la canaleta. Esa limpieza de $180 que evitó se vuelve una reconstrucción de $4,000 18 meses después." },
    ],
    solutionTag: "EL OFICIO ESPECIALIZADO",
    solutionTitle: "Cómo se Ve una Limpieza Real",
    solutionSub: "Ojos del oficio de aluminio en su sistema. Limpieza más diagnóstico gratis de cualquier cosa que necesite atención.",
    solutions: [
      { emoji: "🧹", title: "Remoción completa de escombros", desc: "Cada tramo aclarado a mano o extraído con aspiradora de extremo a extremo. Valles y esquinas incluidos. Sin ignorar las secciones difíciles." },
      { emoji: "💧", title: "Lavado de cada bajante", desc: "Cada bajante se lava con agua para confirmar flujo. Bloqueos parciales en el bajante (causa #1 de desbordamiento después de una limpieza) se aclaran o se marcan." },
      { emoji: "🔧", title: "Inspección de soportes, pendiente y sellador", desc: "Mientras estamos arriba, chequeamos apriete de soportes, pendiente de canaleta y sellador en esquinas. Problemas se fotografían y se reportan." },
      { emoji: "📋", title: "Documentación fotográfica de problemas", desc: "Si encontramos fascia podrida, sellador fallando, soportes caídos o problemas de drenaje, recibe fotos y resumen escrito. No una conversación vaga." },
      ...
      { emoji: "👷", title: "Ojos del oficio, no handyman generalista", desc: "JR One es empresa familiar con más de 30 años en el oficio del aluminio. Vemos cosas que los generalistas se pierden, y podemos cotizar cualquier reparación en el momento." },
    ],
    stats: [
      { value: "$150-$400", label: "Rango típico de limpieza unifamiliar en Tampa" },
      { value: "30+", label: "Años en Tampa Bay" },
      { value: "100%", label: "Escombro llevado" },
      { value: "100%", label: "Documentación fotográfica" },
    ],
    scopeEyebrow: "OPCIONES DE SERVICIO",
    scopeTitle: "Elija la Limpieza Correcta",
    scopeSub: "Servicio completo, básica, paquete con protector o servicio de bajante. Su sistema, su decisión.",
    scopeItems: [
    ...
    timingTitle: "Pre-verano (mayo) y post-huracán (noviembre) es el momento ideal.",
    timingDesc: "Mucha cobertura de árboles: 3 a 4 veces al año. Moderada: 2 veces al año. Casas con protectores: cada 2 a 3 años. Después de cada tormenta, sin importar el horario, los escombros de huracán son un evento propio.",
    timingLabel: "CUÁNDO LIMPIAR",
    ...
    goldSteps: [
      { num: "01", title: "Evaluar", desc: "Caminamos la línea del techo, anotamos acceso y pies lineales, confirmamos alcance. Estimado transparente antes de subir." },
      ...
      { num: "04", title: "Reportar y Llevar", desc: "Resumen escrito y fotos de problemas, más escombros embolsados llevados de la propiedad. Terminado." },
    ],
    reviewEyebrow: "RESEÑAS",
    reviewTitle: "Lo Que Dicen los Clientes",
    reviews: [
      { text: "He tenido tres compañías diferentes limpiando mis canaletas. JR One fue la primera que realmente lavó los bajantes y me mostró fotos de un soporte oxidado que no sabía que tenía.", name: "Arif K.", service: "Limpieza Completa", stars: 5 },
      { text: "Vinieron la semana después de una tormenta, limpiaron todo, embolsaron y se fueron en 90 minutos. Sin desorden en el patio, sin cargos sorpresa.", name: "David K.", service: "Limpieza Post-Tormenta", stars: 5 },
    ...
    faqs: [
      { q: "Cuánto cuesta la limpieza de canaletas en Tampa?", a: "La limpieza de canaletas de JR One Aluminum cuesta $150 a $400 en una casa unifamiliar típica en Tampa, FL. El precio depende de los pies lineales de canaleta, la altura del techo y el acceso con escalera, si la casa es de uno o dos pisos, el nivel de escombro y el número de bajantes. Casas de dos pisos con techos complejos corren más alto. Casas de un piso más pequeñas con acceso sencillo corren más bajo. Precio exacto después de un vistazo rápido. Para un número de su propia casa en Tampa, use el estimador de JR One en jronegutters.com/estimator o llame al (844) 444-3114." },
      { q: "Con qué frecuencia debo limpiar mis canaletas?", a: "Mucha cobertura de árboles: 3 a 4 limpiezas al año. Cobertura moderada: dos veces al año. Pre-verano (mayo) y post-huracán (noviembre). Casas con protectores: cada 2 a 3 años. Casas de lote abierto sin árboles: una vez al año mínimo." },
      { q: "Llevan los escombros?", a: "Sí. Todo el escombro se embolsa y se remueve de su propiedad. No llega a casa a montones de hojas." },
      { q: "Cuál es la diferencia entre su limpieza y un handyman?", a: "La mayoría de handymen generales sacan lo que pueden ver y se van. Nosotros aclaramos cada tramo de extremo a extremo, lavamos cada bajante, inspeccionamos soportes y sellador, fotografiamos problemas y llevamos los desechos. Además somos contratista del oficio especializado de aluminio." },
      { q: "Pueden limpiar canaletas en casa de dos o tres pisos?", a: "Sí. JR One está equipado para multi-piso residencial y comercial. Nuestros equipos tienen escaleras, equipo y entrenamiento para trabajo de alto acceso." },
      { q: "Dan servicio a propiedades de alquiler?", a: "Sí. Vea nuestra página de mantenimiento de alquileres para planes recurrentes construidos para dueños ausentes." },
      { q: "Ofrecen limpieza de emergencia o post-tormenta?", a: "Sí. Después de tormentas priorizamos clientes existentes y propiedades con contrato. La limpieza se agenda más rápido que la mayoría de nuestro trabajo, normalmente bien dentro de nuestro estándar de 14 días y muchas veces antes, aunque una semana intensa post-tormenta puede alargar el calendario." },
    ],
    ctaTitle: "LISTO PARA RESERVAR?",
    ctaSub: "Cuéntenos su dirección y largo aproximado de canaleta si lo sabe. Le daremos un estimado gratis después de revisar la propiedad. Sin presión, sin sobreventa.",
    ...
    formDisclaimer: "Sin spam. Sin presión. Estimado gratis.",
  ...
  return (
    <div style={{ background: "var(--jr-navy)", color: "var(--jr-paper)", minHeight: "100vh" }}>
      ...
      <main id="main">
        ...
        <section className="jr-noise-bg jr-service-hero" style={{ position: "relative", padding: "var(--jr-space-16) var(--jr-space-6) var(--jr-space-20)", backgroundImage: "linear-gradient(165deg, rgba(11,22,51,0.84) 0%, rgba(17,32,67,0.88) 55%, rgba(22,42,80,0.92) 100%), url('/images/gutter-cleaning-before.webp')", backgroundSize: "cover", backgroundPosition: "center", overflow: "hidden" }}>
        ...
        <section style={{ background: `linear-gradient(135deg, ${ACCENT}1F, var(--jr-navy-deep))`, padding: "var(--jr-space-8) var(--jr-space-6)", borderTop: `2px solid ${ACCENT}`, borderBottom: `2px solid ${ACCENT}` }}>
          <Container>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "var(--jr-space-5)" }}>
              ...
              <Button href="tel:8444443114" variant="primary" size="md" iconLeft={<PhoneIcon size={16} />} accent={ACCENT} accentLight={ACCENT_LIGHT}>{t.timingBtn}</Button>
            </div>
          </Container>
        </section>
        ...
        <CTABand
          ...
          sub={lang === "en" ? "No upsell, no pressure. Just a clean job and a clean exit." : "Sin sobreventa, sin presión. Solo un trabajo limpio."}
      ...
      <ServiceAreaList
        ...
        serviceLabel={lang === "es" ? "Limpieza de Canaletas" : "Gutter Cleaning"}
        lang={lang}
      />
