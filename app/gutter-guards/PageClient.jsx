...
const T = {
  ...
  es: {
    ...
    solutions: [
      { title: "Cuatro opciones de protectores para cada situación", desc: "Instalamos protectores de canaletas de aluminio, protectores estándar, protectores de micro malla y protectores EZ Mesh. Evaluamos su cobertura de árboles, inclinación del techo y tipo de escombros para recomendar el sistema correcto. No solo el más caro." },
      { title: "Opción de filtro fino micro malla", desc: "Para máximo bloqueo de escombros, los protectores de micro malla filtran agujas de pino, gránulos de tejas y vainas de semillas mientras manejan los aguaceros más fuertes de Florida. Recomendamos micro malla para hogares con mucha cobertura de árboles o problemas de escombros finos." },
    ...
    guardSub: "Cuatro sistemas de protectores. Cada uno diseñado para un nivel específico de protección y presupuesto.",
    guardTypes: [
      { icon: "🛡️", title: "Protectores de Aluminio", desc: "Protectores de aluminio de alta resistencia que se ajustan a sus canaletas existentes. Diseñados para manejar los rayos UV intensos, lluvias fuertes y vientos altos de Florida sin deformarse, oxidarse o deteriorarse. La opción más fuerte y duradera que ofrecemos.", spec: "Material: Aluminio" },
      { icon: "📐", title: "Protectores Estándar", desc: "Un protector confiable y económico que mantiene las hojas y escombros grandes fuera de sus canaletas mientras mantiene un buen flujo de agua. Una opción práctica para hogares con cobertura moderada de árboles que desean protección sin precio elevado.", spec: "Tipo: Malla estándar" },
      { icon: "✨", title: "Protectores de Micro Malla", desc: "La filtración más fina disponible. Las mallas micro filtran agujas de pino, gránulos de tejas, vainas de semillas e incluso gránulos de arena del techo mientras manejan los aguaceros más fuertes de Florida. Nuestra principal recomendación para hogares rodeados de árboles.", spec: "Filtración: Malla ultra fina" },
      { icon: "🔧", title: "Protectores EZ Mesh", desc: "Protectores de malla de instalación rápida que brindan protección contra escombros con tiempo mínimo de instalación. Un balance inteligente entre rendimiento y valor. Efectivos contra hojas y escombros medianos mientras mantienen su sistema fluyendo durante la temporada de tormentas.", spec: "Instalación: Diseño de ajuste rápido" },
    ],
    ...
    faqs: [
      ...
      { q: "Cuál es el mejor protector para agujas de pino?", a: "Los protectores de micro malla son la opción más efectiva para agujas de pino. Los protectores de malla estándar tienen aberturas lo suficientemente grandes para que las agujas pasen. Si tiene pinos cerca de su línea de techo, recomendaremos específicamente un sistema de micro malla clasificado para escombros finos." },
