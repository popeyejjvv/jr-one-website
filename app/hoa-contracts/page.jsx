...
const T = {
  ...
  es: {
    ...
    heroH1Gold: "Que las HOAs Tienen en Marcado Rápido",
    heroP: "JR One maneja canaletas, sofito, fascia y mantenimiento de aluminio en las comunidades administradas de Tampa Bay. Un contrato, un equipo, un punto de contacto para el administrador. Bilingüe, asegurado, y confiable para poner en el calendario comunitario.",
    btnEstimate: "Solicite un Recorrido HOA",
    btnCall: "Llame al (844) 444-3114",
    problemEyebrow: "POR QUÉ NOS LLAMAN LAS HOAs",
    problemTitle: "Lo Que Se Rompe en una Comunidad Administrada",
    problems: [
      { title: "Vendedores sueltos casa por casa", desc: "La mayoría de las HOAs terminan con 4 a 5 trabajadores cubriendo 200 casas. La calidad se dispersa, los precios se dispersan, y nadie puede decirle al administrador qué se hizo exactamente en cada calle." },
      { title: "Volumen post-tormenta que nadie maneja", desc: "Después de cada tormenta, las HOAs reciben llamadas sobre canaletas caídas, paneles de sofito volados y fascia despegada. Un solo trabajador con escalera no procesa 40 unidades en una semana." },
      { title: "Ciclos preventivos saltados", desc: "La limpieza de canaletas, la inspección de sofito y los chequeos de fascia se saltan una temporada. La pudrición se extiende detrás de las paredes. Dieciocho meses después la HOA enfrenta una evaluación especial que nadie quería." },
      { title: "Fricción de idioma con residentes", desc: "La población de residentes HOA de Tampa es muy bilingüe. Los equipos que solo hablan inglés pierden la mitad de la conversación, y la mitad de los problemas nunca se reportan bien." },
    ],
    solutionEyebrow: "LA DIFERENCIA HOA DE JR ONE",
    solutionTitle: "Cómo Trabajamos Con HOAs y Administradores",
    solutionSub: "Un contrato, un proveedor, una relación. Construida para comunidades, no llamadas de servicio sueltas.",
    solutions: [
      { title: "Mantenimiento programado a nivel comunitario", desc: "Limpieza de canaletas semestral o trimestral, inspección de sofito y fascia, lavado de bajantes y prueba de flujo en cada unidad de la comunidad. En un horario que el administrador puede publicar." },
      { title: "Reporte de punto único para el administrador", desc: "Después de cada ciclo entregamos un reporte unidad por unidad: qué se limpió, qué se marcó, fotos de problemas encontrados y seguimientos recomendados. El administrador lo reenvía a la junta, no una caja de facturas." },
      ...
      { title: "Equipos bilingües de principio a fin", desc: "Cada equipo de JR One es completamente bilingüe EN y ES. Los residentes obtienen respuestas claras en su idioma. Los administradores tienen un contacto en inglés que es dueño de la cuenta." },
      { title: "Prioridad de respuesta post-tormenta para HOAs con contrato", desc: "Después de una tormenta priorizamos las HOAs con contrato antes de la cola minorista. Su comunidad no espera tres semanas." },
      { title: "Oficio especializado, no generalista", desc: "Canaletas, sofito, fascia, molduras de aluminio, drenaje. Hacemos una cosa y la hacemos en miles de casas. Sin entregas a subcontratistas, sin pérdida de calidad." },
    ],
    stats: [
      { value: "25+", label: "HOAs y comunidades administradas atendidas" },
      { value: "30+", label: "Años de trabajo de aluminio en Tampa Bay" },
      { value: "48h", label: "Tiempo típico de recorrido" },
    ...
    scopeSub: "Construya su contrato con cualquier combinación. Con precio por unidad, por pie lineal, o por comunidad según alcance.",
    scopeItems: [
      { title: "Limpieza de canaletas y bajantes", desc: "Remoción completa de escombros y lavado de bajantes en cada unidad en un cronograma establecido (trimestral, semestral, o post-tormenta)." },
      { title: "Inspección de canaletas, sofito y fascia", desc: "Inspección con documentación fotográfica de soportes caídos, paneles sueltos, fascia podrida y costuras fallidas. Marcados antes de ser problemas comunitarios." },
      { title: "Reparación de canaletas y re-inclinación", desc: "Resellado, reemplazo de soportes y corrección de pendiente en canaletas que aún sirven pero empiezan a fallar." },
      { title: "Reemplazo de paneles de sofito y fascia", desc: "Reemplazo por unidad de paneles de aluminio dañados por viento o podridos y envolturas de fascia, combinados al color de la comunidad." },
      { title: "Redirección de bajantes y drenaje", desc: "Corrección de problemas de drenaje que erosionan paisajismo, inundan aceras o acumulan agua en fundaciones. Una queja constante en HOAs." },
      { title: "Respuesta rápida post-tormenta", desc: "Dentro de 72 horas de una tormenta caminamos la comunidad, documentamos daño y coordinamos la cola de reparación con el administrador." },
    ],
    coverageLabel: "COBERTURA TAMPA BAY",
    coverageTitle: "Servimos HOAs en 5 condados y 21 ciudades.",
    coverageDesc: "Hillsborough, Pinellas, Pasco, Manatee y Sarasota. Tampa, Clearwater, St. Pete, Sarasota, Bradenton, Lakeland, Brandon, Wesley Chapel, Riverview, Palm Harbor, Temple Terrace y más.",
    coverageBtn: "Contacto",
    goldEyebrow: "EL ESTÁNDAR DE ORO",
    goldTitle: "Cómo Integramos una HOA",
    goldMotto: "Un recorrido. Un contrato. Un proveedor en que la junta confía.",
    goldSteps: [
      { num: "01", title: "Recorrido", desc: "Recorrido comunitario gratis con el administrador. Documentamos unidades, pies lineales de canaleta, condición de sofito y puntos de dolor actuales." },
      { num: "02", title: "Alcance", desc: "Alcance personalizado del menú de servicios. Limpieza trimestral, inspección semestral, respuesta post-tormenta, lo que necesite la comunidad." },
      ...
      { num: "04", title: "Ejecución y Reporte", desc: "Ejecutamos según horario y entregamos reporte unidad por unidad después de cada ciclo. Sin sorpresas." },
    ],
    reviewEyebrow: "RESEÑAS DE ADMINISTRADORES",
    reviewTitle: "Lo Que Dicen Juntas y Administradores",
    reviews: [
      { text: "Teníamos tres trabajadores cubriendo 180 casas. Cambiamos todo el lado de aluminio a JR One y las quejas bajaron en un mes. Un punto de contacto lo hizo sostenible.", name: "Administradora Comunitaria", service: "HOA de Hillsborough", stars: 5 },
      { text: "Después del Huracán Idalia tuvimos paneles volados en 40+ unidades. JR One caminó la comunidad en 48 horas y tuvo una cola de reparación priorizada. Esa respuesta es rara.", name: "Miembro de Junta HOA", service: "Comunidad de Casas en Pinellas", stars: 5 },
      { text: "La parte bilingüe importa más de lo que la gente piensa. Nuestros residentes se sintieron escuchados.", name: "Administradora de Propiedad", service: "Comunidad Sur de Tampa", stars: 5 },
    ],
    faqEyebrow: "PREGUNTAS FRECUENTES",
    faqTitle: "Preguntas Sobre Contratos de Mantenimiento HOA",
    faqs: [
      { q: "Qué tamaño de HOA aceptan?", a: "Trabajamos con comunidades desde 12 unidades hasta 400+. Por debajo de 12 recomendamos llamadas individuales. Por encima de 400 dividimos en zonas de servicio." },
      { q: "Cómo se estructura el precio de una HOA?", a: "Es personalizado por comunidad según unidades, pies lineales, accesibilidad de techo y alcance. La mayoría termina con un retenedor mensual o trimestral fijo con tarifa por unidad transparente para reparaciones fuera de alcance." },
      { q: "Requieren contrato de varios años?", a: "No. La mayoría son anuales con revisión de renovación. Preferimos ganar la renovación cada año." },
      { q: "Pueden coordinar con nuestro techero actual?", a: "Sí. Coordinamos directamente con techeros, pintores y jardineros cuando los alcances se traslapan, particularmente en sofito y fascia que toca la línea del techo." },
      { q: "Qué hay de respuesta de emergencia post-tormenta?", a: "Las HOAs con contrato tienen prioridad antes de la cola minorista. Dentro de 72 horas caminamos la comunidad y damos una lista priorizada para revisión de junta o reclamo de seguro." },
      { q: "Están asegurados para trabajo en HOAs?", a: "Sí. JR One Aluminum tiene cobertura completa de responsabilidad general y compensación laboral. Entregamos certificados al administrador con la HOA nombrada como asegurado adicional si se requiere." },
      { q: "Pueden dar reportes que la junta entienda?", a: "Cada ciclo termina con un reporte unidad por unidad: qué se hizo, qué se marcó, fotos y seguimientos. Escrito para reunión de junta, no solo facturación." },
    ],
    ctaTitle: "Listo Para Simplificar el Mantenimiento de Aluminio de Su HOA?",
    ctaSub: "Solicite un recorrido comunitario gratis. Nos reunimos con el administrador en sitio, evaluamos el alcance y ponemos un contrato transparente frente a la junta. Sin obligación.",
    formTitle: "Solicite un Recorrido HOA",
    formName: "Nombre del Administrador",
    formPhone: "Número de Teléfono",
    formEmail: "Correo Electrónico",
    formZip: "Código Postal de la Comunidad",
    formBtn: "Solicitar Recorrido Gratis",
    formDisclaimer: "Sin spam. Sin presión. Conversación directa con el dueño.",
  ...
  return (
    <div style={{ background: "var(--jr-navy)", color: "var(--jr-paper)", minHeight: "100vh" }}>
      ...
      <main id="main">
        ...
        {/* HERO */}
        <section className="jr-noise-bg jr-service-hero" style={{ position: "relative", padding: "var(--jr-space-12) var(--jr-space-6) var(--jr-space-20)", backgroundImage: "linear-gradient(165deg, rgba(11,22,51,0.84) 0%, rgba(17,32,67,0.88) 55%, rgba(22,42,80,0.92) 100%), url('/images/hoa-contracts-hero.webp')", backgroundSize: "cover", backgroundPosition: "center", overflow: "hidden" }}>
        ...
        <CTABand
          ...
          sub={lang === "en"
            ...
            : "Equipos bilingües, reportes transparentes, prioridad post-tormenta. Programe un recorrido gratis hoy."}
