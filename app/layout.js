...
const organizationSchema = {
  ...
  // foundingDate intentionally omitted: brand guardrail - never publish a founding year.
...
export const metadata = {
  ...
  description:
    "Family-owned, over 30 years in the trade. Seamless gutters, soffit, fascia, drainage. In-house crews, fully insured. Tampa Bay specialty trade contractor. Free estimates. (844) 444-3114.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "JR One Aluminum LLC. Tampa Bay seamless gutters, soffit, fascia, drainage. Family-owned, 30+ years.",
        type: "image/png",
      },
    ],
  },
