...
const T = {
  en: {
    ...
    peakAlertDesc: "restores shingles from the inside out. Adds 6 to 10 years of roof life for up to 70% less than a new roof install, with warranty docs Florida carriers may consider when evaluating your renewal.",
  ...
  es: {
    ...
    heroH1Accent: "Funcionando Todo el Año.",
    heroP: "El mantenimiento regular extiende la vida de su sistema de canalones, previene daños costosos y mantiene su hogar protegido durante el clima más severo de Florida. Tres niveles de servicio para cada casa y presupuesto.",
    ...
    problemTitle: "Qué Pasa Cuando Omite el Mantenimiento de Canalones",
    problems: [
      { title: "Los canalones tapados se desbordan", desc: "Hojas, agujas de pino y escombros se acumulan rápido en Florida. Cuando los canalones se tapan, el agua se desborda, directo por sus paredes, hacia sus cimientos y detrás de las tablas de fascia." },
      { title: "El agua estancada cría plagas", desc: "Los canalones tapados retienen agua estancada, el caldo de cultivo perfecto para mosquitos, moho y algas. Esa agua estancada también acelera la oxidación y corrosión desde adentro." },
      { title: "Las juntas con fugas pasan desapercibidas", desc: "Las esquinas y uniones se separan con el tiempo. Las pequeñas fugas se convierten en pudrición de fascia, manchas de sofito y erosión de cimientos. Para cuando ve el daño, la factura de reparación se ha triplicado." },
      { title: "El descuido destruye su inversión", desc: "Un sistema de canalones que costó miles en instalar puede fallar en solo unos años sin mantenimiento. La limpieza e inspección regular es el seguro más barato que tiene su casa." },
    ],
    ...
    plans: [
      {
        ...
        desc: "Remoción esencial de escombros. Soplado, limpieza y restauración del flujo.",
        features: ["Soplar escombros del techo alrededor de la línea del canalón", "Soplar todos los canalones: remover hojas, agujas, acumulación", "Soplar todos los bajantes para confirmar flujo libre", "Limpieza completa de todos los escombros de la propiedad", "Inspección visual por daños obvios o problemas"],
      ...
      },
      {
        ...
        tag: "RECOMENDADO",
        price: "Llame para Precio",
        desc: "Todo en Básico más lavado completo con agua, remoción de suciedad y sellado de fugas.",
        features: ["Todo en Limpieza de Hojas", "Lavado completo con agua de todos los canalones: remueve suciedad y sedimento adherido", "Lavado completo con agua de todos los bajantes", "Sellar cualquier esquina con fuga obvia (juntas de esquina)", "Verificación de flujo del sistema: confirmar que el agua se mueve correctamente", "Reporte de condición escrito con fotos"],
        best: "La mayoría de propietarios. La limpieza exhaustiva que detecta problemas antes de que se vuelvan costosos.",
        highlight: true,
      },
      {
        ...
        tag: "PREMIUM",
        price: "Llame para Precio",
        desc: "Restauración completa del sistema. Limpieza, realineación, resellado y protección con guardas nuevas.",
        features: ["Todo en Limpieza Premium", "Reasegurar y realinear todos los canalones", "Reasegurar y realinear todos los bajantes", "Prueba de flujo funcional: asegurar que todo drena correctamente", "Resellado de TODAS las esquinas en todo el sistema", "Instalación profesional de guardas de hojas nuevas", "Sistema de guardas dimensionado y ajustado a sus canalones específicos"],
    ...
    alaCarte: [
      { title: "Reparación de Bajantes", desc: "Reparación de secciones de bajante dañadas o desconectadas, reasegurar a la estructura y sellado de puntos de fuga." },
      { title: "Reinstalación de Guardas", desc: "Reasegurar o reinstalar guardas de canalones existentes que se han movido, levantado o desplazado por tormentas." },
      { title: "Reemplazo de Fascia de Madera", desc: "Reparación o reemplazo de fascia de madera exterior dañada, marcos o molduras. Corte personalizado, asegurado y sellado." },
      { title: "Reparación General de Canalones", desc: "Sellado de fugas, reemplazo de ganchos, realineación, corrección de pendiente. Presupuesto basado en alcance después de inspección." },
    ],
    peakAlertLabel: "ALERTA DE SEGUROS DE FLORIDA",
    peakAlertTitle: "280% de Aumento en No Renovaciones. Techo de Más de 15 Años?",
    peakAlertDesc: "restaura las tejas desde adentro. Agrega 6 a 10 años de vida al techo por hasta 70% menos que una instalación de techo nuevo, con documentos de garantía que las aseguradoras de FL pueden considerar al evaluar su renovación.",
    ...
    goldSteps: [
      { num: "01", title: "Inspeccionar", desc: "Evaluamos todo su sistema de canalones, revisando obstrucciones, fugas, ganchos sueltos, desalineación y condición de la fascia. Fotos incluidas." },
      { num: "02", title: "Limpiar", desc: "Remoción de escombros, soplado de canalones, limpieza de bajantes y limpieza completa de la propiedad. Su sistema fluye de nuevo." },
      { num: "03", title: "Reparar", desc: "Sellar esquinas con fugas, reasegurar secciones sueltas, realinear pendiente y reparar cualquier problema encontrado durante la inspección." },
      { num: "04", title: "Proteger", desc: "Instalación opcional de guardas de hojas, reporte de condición con fotos y programación de su próxima visita de servicio." },
    ],
    faqEyebrow: "PREGUNTAS FRECUENTES",
    faqTitle: "Preguntas de Mantenimiento",
    faqs: [
      { q: "Con qué frecuencia debo limpiar mis canalones en Tampa?", a: "Recomendamos al menos dos veces al año. Una antes de la temporada de huracanes (mayo o junio) y otra después de la caída de hojas de otoño (noviembre o diciembre). Casas con mucha cobertura de árboles o pinos pueden beneficiarse de limpieza trimestral." },
      { q: "Puedo obtener solo una limpieza única sin plan?", a: "Sí. Todos nuestros servicios de limpieza están disponibles como visitas únicas. Los planes simplemente le dan la conveniencia de servicio programado a precios consistentes. No está atado a un contrato." },
      { q: "Cuál es la diferencia entre Limpieza de Hojas y Limpieza Premium?", a: "La Limpieza de Hojas remueve escombros de sus canalones y limpia los bajantes. La Limpieza Premium agrega un lavado completo del sistema para verificar el flujo en todo el sistema, más resellado de esquinas (juntas) y reasegurar bajantes. Premium detecta problemas en desarrollo que la limpieza básica no detecta." },
      { q: "Ofrecen el Paquete Deluxe para sistemas de guardas existentes?", a: "El Paquete Deluxe incluye instalación de guardas nuevas. Si ya tiene guardas, ofrecemos mantenimiento de guardas como parte de nuestra Limpieza Premium. Limpiando escombros de superficie, revisando puntos de anclaje y asegurando funcionamiento adecuado." },
      { q: "Qué significa 'resellar esquinas'?", a: "Las esquinas son las juntas donde dos tramos de canalón se encuentran. Con el tiempo, el sellador en estas juntas puede agrietarse o separarse, causando fugas. Resellar esquinas durante el mantenimiento previene estas fugas antes de que dañen su fascia o cimientos." },
      { q: "Dan servicio a canalones que no instalaron?", a: "Sí. Nuestros servicios de mantenimiento están disponibles para cualquier sistema de canalones, sin importar quién lo instaló. Evaluaremos la condición y le informaremos si se necesitan reparaciones más allá de la limpieza." },
    ],
    ctaTitle: "Programe Su Mantenimiento de Canalones",
    ctaSub: "Díganos qué plan le interesa y lo programaremos. Sin contratos, sin presión. Solo mantenimiento profesional que protege su hogar.",
    ...
    formDisclaimer: "Sin spam. Sin presión. Solo mantenimiento profesional.",
    successTitle: "Solicitud Recibida",
    successMsg: "Nos pondremos en contacto en horas.",
    preferTalk: "Prefiere hablar?",
    planSelectOptions: ["Qué plan le interesa?", "Limpieza de Hojas (Básico)", "Limpieza Premium (Recomendado)", "Paquete Deluxe con Guardas", "No estoy seguro, necesito consejo", "Solo limpieza única"],
  },
};
  ...
  return (
    <div style={{ background: "var(--jr-navy)", color: "var(--jr-paper)", minHeight: "100vh" }}>
      ...
      <main id="main">
        ...
        {/* HERO */}
        <section className="jr-noise-bg jr-service-hero" style={{ position: "relative", padding: "var(--jr-space-12) var(--jr-space-6) var(--jr-space-20)", backgroundImage: "linear-gradient(165deg, rgba(11,22,51,0.84) 0%, rgba(17,32,67,0.88) 55%, rgba(22,42,80,0.92) 100%), url('/images/service-plans-hero-v2.webp')", backgroundSize: "cover", backgroundPosition: "center", overflow: "hidden" }}>
        ...
        <CTABand
          title={lang === "en" ? "Three Plans. One Standard." : "Tres Planes. Un Estándar."}
          sub={lang === "en"
            ? "Family-owned, over 30 years in the trade. Schedule the right plan for your home."
            : "Empresa familiar, más de 30 años en el oficio. Programa el plan correcto para tu hogar."}
