...
const T = {
  en: {
    ...
    peakAlertDesc: "restores shingles from the inside out. Adds 6 to 10 years of roof life for up to 70% less than a new roof install.",
  ...
  es: {
    ...
    peakAlertDesc: "restaura las tejas desde adentro. Agrega 6 a 10 años de vida al techo por hasta 70% menos que una instalación de techo nuevo.",
