...
const T = {
  ...
  es: {
    ...
    peakAlertDesc: "restaura las tejas desde adentro. Agrega 6 a 10 anos de vida al techo por hasta 70% menos que una instalacion de techo nuevo, con documentos de garantia que las aseguradoras de FL pueden considerar al evaluar su renovacion.",
