...
const T = {
  en: {
    ...
    solutions: [
      ...
      { title: "SAGIPER architectural cladding", desc: "For maximum exterior protection and aesthetics, we install SAGIPER architectural cladding systems (SagiWall, SagiRev, and more). Wind-load tested, 50-year warranty, no repainting or sealing cycle." },
  ...
  es: {
    ...
    solutions: [
      ...
      { title: "Revestimiento arquitectónico SAGIPER", desc: "Para máxima protección exterior y estética, instalamos sistemas de revestimiento arquitectónico SAGIPER (SagiWall, SagiRev y más). Probado contra cargas de viento, garantía de 50 años, sin ciclo de repintado ni sellado." },
