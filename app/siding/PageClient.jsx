...
const T = {
  en: {
    ...
    solutions: [
      ...
      { title: "SAGIPER architectural cladding", desc: "For maximum exterior protection and aesthetics, we install SAGIPER architectural cladding systems (SagiWall, SagiRev, and more). Wind-load tested, 50-year limited warranty on the PVC lines, no repainting or sealing cycle." },
    ...
    faqs: [
      { q: "How much does siding installation cost in Tampa?", a: "Siding costs vary significantly based on material (vinyl vs. fiber cement vs. architectural cladding), home size, and the amount of prep work needed. Vinyl siding typically runs $4 to $9 per square foot installed. SAGIPER cladding is higher but comes with a 50-year limited warranty on the PVC lines. We provide detailed, itemized estimates so you can compare apples to apples." },
      { q: "Which siding is best for Florida homes?", a: "For most Tampa Bay homes, vinyl siding offers the best balance of durability, appearance, and value. For homeowners wanting architectural aesthetics and maximum durability, we install SAGIPER architectural cladding (made in Portugal, wind-load tested, UV-resistant, backed by a 50-year limited warranty on the PVC lines). We assess your specific situation (location, exposure, budget) and give you an honest recommendation." },
  ...
  es: {
    ...
    solutions: [
      ...
      { title: "Revestimiento arquitectónico SAGIPER", desc: "Para máxima protección exterior y estética, instalamos sistemas de revestimiento arquitectónico SAGIPER (SagiWall, SagiRev y más). Probado contra cargas de viento, garantía limitada de 50 años en las líneas de PVC, sin ciclo de repintado ni sellado." },
