...
const T = {
  ...
  es: {
    ...
    readyEstimate: "Listo para una Cotización Gratis?",
    ctaDesc: "Especialistas en aluminio de Tampa Bay. Empresa familiar. Más de 30 años en la industria de canaletas de Tampa Bay. Equipos propios.",
