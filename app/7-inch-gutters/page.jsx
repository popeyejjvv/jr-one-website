...
const T = {
  ...
  es: {
    ...
    solutions: [
      ...
      { emoji: "🎨", title: "Más de 40 opciones de color, sin impacto visual", desc: "Mismo espectro de colores de aluminio que 6\". El perfil de 7\" es ligeramente mayor pero aún residencial. La mayoría de dueños no lo nota a simple vista." },
    ],
    stats: [
    ...
    faqs: [
      ...
      { q: "Qué colores hay en 7\"?", a: "Mismas 40+ opciones que 6\". Corremos el mismo inventario de aluminio. Blanco, almendra, arcilla, bronce, bronce oscuro, negro y combinaciones personalizadas." },
    ],
