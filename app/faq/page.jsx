...
import { HouseIcon, WaterDropIcon, ShieldIcon, RoofEdgeIcon, RulerIcon, BroomIcon, CardIcon, PhoneIcon, MailIcon } from "../../lib/icons";
    ...
    categories: [
      {
        key: "general", name: "General", faqs: [
          { q: "What services does JR One offer?", a: "We do seamless aluminum gutters (6\" and 7\"), copper gutters, gutter guards (aluminum, standard, micro mesh, and EZ mesh), soffit and fascia installation, siding, SAGIPER architectural cladding, gutter repair, Govee smart light installation, drainage installation (underground PVC, catch basins, surface grates, pop-up emitters), and maintenance plans. We're an aluminum-exterior specialty trade. That's all we do, and we do it right." },
          ...
          { q: "Do you speak Spanish?", a: "Yes. JR One is a fully bilingual company, English and Spanish. We communicate in whichever language you're most comfortable with, from the first call through final walkthrough." },
    ...
    categories: [
      {
        key: "general", name: "General", faqs: [
          ...
          { q: "Hablan espanol?", a: "Si. JR One es una empresa completamente bilingue, ingles y espanol. Nos comunicamos en el idioma que te resulte mas comodo desde la primera llamada hasta la inspeccion final." },
