    ...
    categories: [
      ...
      },
      {
        key: "gutters", name: "Canaletas", faqs: [
          ...
          { q: "Cuanto cuestan las canaletas nuevas en Tampa?", a: "La instalacion de canaletas de aluminio sin costura de JR One Aluminum en Tampa, FL se cotiza por trabajo, no a tarifa fija. El precio depende del tamano de la canaleta (6\" o 7\"), pies lineales, altura del techo y acceso con escalera, si la casa es de uno o dos pisos, la complejidad de la linea de techo y numero de esquinas, y la configuracion de bajantes. Proporcionamos estimados detallados con cada item desglosado para que veas exactamente lo que estas pagando. Usa nuestro Estimador Aereo en jronegutters.com/estimator para un rango de precios de tu propia casa en Tampa, o llama al (844) 444-3114." },
      ...
      },
      {
        key: "peak", name: "Peak 301 y Seguros", faqs: [
          ...
          { q: "Cuanto cuesta Peak 301 comparado con el reemplazo del techo?", a: "Para la mayoria de los hogares de Tampa Bay, el rejuvenecimiento de tejas Peak 301 de JR One Aluminum cuesta alrededor de 60 a 75% menos que un reemplazo completo de techo, que en este mercado cuesta de $15,000 a $25,000 o mas. El precio depende del tamano del techo en cuadros, tipo de teja, condicion de la teja, pendiente del techo y acceso. Le damos precios exactos solo despues de inspeccionar su techo especifico. El tratamiento es una aplicacion de un solo dia por nuestra cuadrilla, documentacion de garantia y coordinacion con un inspector para tu certificacion de Vida Util Remanente (RUL). Para un numero de su propia casa en Tampa Bay, solicite una evaluacion gratuita del techo en jronegutters.com/peak-301 o llame al (844) 444-3114." },
