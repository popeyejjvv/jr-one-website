...
const CATEGORIES = [
  ...
  { name:"Gutters", icon:"💧", faqs:[
    ...
    {q:"My gutters are overflowing during heavy rain. What's wrong?",a:"Three common causes: (1) Gutters are clogged with debris — needs cleaning. (2) Gutters are undersized for your roof area — common when builders install cheap 5\" gutters on homes that need 6\" or 7\". (3) Gutters are improperly pitched — water pools instead of flowing to the downspouts. We diagnose the exact cause during a free inspection."},
