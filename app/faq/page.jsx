    ...
    categories: [
      ...
      },
      {
        key: "gutters", name: "Gutters", faqs: [
          ...
          { q: "How long do seamless gutters last?", a: "With proper maintenance, quality seamless aluminum gutters have a long service life in Florida's climate. The aluminum itself doesn't rust or rot. What shortens gutter life is neglect: clogged downspouts, standing water, and debris buildup that causes corrosion. That's why we recommend maintenance plans and gutter guards." },
      ...
      },
      {
        key: "peak", name: "Peak 301 & Insurance", faqs: [
          ...
          { q: "How much does Peak 301 cost compared to roof replacement?", a: "For most Tampa Bay homes, Peak 301 shingle rejuvenation from JR One Aluminum runs around 60 to 75% less than a full roof replacement, which runs $15,000 to $25,000 or more in this market. Price is driven by roof size in squares, shingle type, shingle condition, roof pitch, and access. We give you exact pricing only after inspecting your specific roof. The treatment is a one-day application by our crew, plus coordination with an inspector for your Remaining Useful Life (RUL) certification. For a number on your own Tampa Bay home, book a free roof assessment at jronegutters.com/peak-301 or call (844) 444-3114." },
          { q: "Will Peak 301 help with my homeowner's insurance?", a: "It can help. Florida insurers have increased policy non-renewals by 280% since 2018, primarily targeting roofs over 15 years old. A Remaining Useful Life (RUL) certification from an authorized inspector gives you documentation of your roof's condition that Florida law directs carriers to consider for roofs over 15 years. Coverage decisions rest with your insurer; confirm your situation with your agent." },
      ...
      },
      {
        key: "siding", name: "Siding & SAGIPER", faqs: [
          ...
          { q: "What is SAGIPER and why is it different?", a: "SAGIPER is a PVC architectural cladding system made in Portugal, built with Solar Shield Technology, a heat-reflective layer engineered specifically for dark colors in high-UV climates. Standard vinyl siding is generally limited to light colors in Florida because dark vinyl absorbs more heat and can distort. SAGIPER is built to hold dark colors in that same sun, and it comes in modern, design-forward profiles you can't get with standard siding." },
    ...
    categories: [
      ...
      },
      {
        key: "gutters", name: "Canaletas", faqs: [
          ...
          { q: "Cuánto duran las canaletas sin costura?", a: "Con mantenimiento adecuado, las canaletas de aluminio sin costura de calidad tienen una larga vida útil en el clima de Florida. El aluminio en sí no se oxida ni se pudre. Lo que acorta la vida de las canaletas es el descuido: bajantes tapados, agua estancada y acumulación de escombros que causa corrosión. Por eso recomendamos planes de mantenimiento y protectores de canaletas." },
      ...
      },
      {
        key: "peak", name: "Peak 301 y Seguros", faqs: [
          ...
          { q: "Cuánto cuesta Peak 301 comparado con el reemplazo del techo?", a: "Para la mayoría de los hogares de Tampa Bay, el rejuvenecimiento de tejas Peak 301 de JR One Aluminum cuesta alrededor de 60 a 75% menos que un reemplazo completo de techo, que en este mercado cuesta de $15,000 a $25,000 o más. El precio depende del tamaño del techo en cuadros, tipo de teja, condición de la teja, pendiente del techo y acceso. Le damos precios exactos solo después de inspeccionar su techo específico. El tratamiento es una aplicación de un solo día por nuestra cuadrilla, más la coordinación con un inspector para su certificación de Vida Útil Remanente (RUL). Para un número de su propia casa en Tampa Bay, solicite una evaluación gratuita del techo en jronegutters.com/peak-301 o llame al (844) 444-3114." },
          { q: "Peak 301 me ayudará con mi seguro de hogar?", a: "Puede ayudar. Las aseguradoras de Florida han aumentado las no-renovaciones de pólizas en un 280% desde 2018, apuntando principalmente a techos de más de 15 años. Una certificación de Vida Útil Remanente (RUL) de un inspector autorizado le da documentación de la condición de su techo que la ley de Florida orienta a las aseguradoras a considerar para techos de más de 15 años. Las decisiones de cobertura recaen en su aseguradora; confirme su situación con su agente." },
          ...
          { q: "Cuánto dura el tratamiento?", a: "Peak 301 agrega 6 a 10 años de vida a tu techo existente. La duración exacta depende de la condición actual de tu techo, su edad y tipo de teja, lo cual evaluamos antes de recomendar el tratamiento." },
