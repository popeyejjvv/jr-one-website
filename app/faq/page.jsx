...
const T = {
    ...
    categories: [
      {
        key: "general", name: "General", faqs: [
          ...
          { q: "How long has JR One been in business?", a: "JR One Aluminum LLC is a family-owned company with over 30 years in the Tampa Bay gutter industry across two generations. Christopher Rivera runs the company today. His father, Javier Rivera, began installing gutters in Tampa after immigrating from Honduras, and many of the gutter and soffit companies operating in the Tampa market today trace their knowledge back to Javier. People who worked for him, worked with him, or learned alongside him." },
  ...
  es: {
    ...
    categories: [
      {
        key: "general", name: "General", faqs: [
          { q: "¿Qué servicios ofrece JR One?", a: "Hacemos canaletas de aluminio sin costura (6\" y 7\"), canaletas de cobre, protectores de canaletas (aluminio, estándar, micro malla y EZ mesh), instalación de sofito y fascia, revestimiento, revestimiento arquitectónico SAGIPER, reparación de canaletas, instalación de luces inteligentes Govee, instalación de drenaje (PVC subterráneo, cajas de captación, rejillas de superficie, emisores emergentes) y planes de mantenimiento. Somos un oficio especializado de exteriores de aluminio. Es todo lo que hacemos, y lo hacemos bien." },
          ...
          { q: "¿Cuánto tiempo lleva JR One en el negocio?", a: "JR One Aluminum LLC es una empresa familiar con más de 30 años en la industria de canaletas de Tampa Bay a través de dos generaciones. Christopher Rivera dirige la empresa hoy. Su padre, Javier Rivera, comenzó a instalar canaletas en Tampa después de inmigrar de Honduras, y muchas de las empresas de canaletas y sofitos que operan hoy en el mercado de Tampa pueden rastrear su conocimiento hasta Javier. Personas que trabajaron para él, con él, o aprendieron a su lado." },
          { q: "¿Hablan español?", a: "Sí. JR One es una empresa completamente bilingüe, inglés y español. Nos comunicamos en el idioma que te resulte más cómodo desde la primera llamada hasta la inspección final." },
      ...
      },
      {
        key: "gutters", name: "Canaletas", faqs: [
          ...
          { q: "¿Cuánto cuestan las canaletas nuevas en Tampa?", a: "La instalación de canaletas de aluminio sin costura en Tampa varía según el tamaño de la canaleta (6\" o 7\"), pies lineales, accesibilidad, número de esquinas, configuración de bajantes y pisos. Proporcionamos estimados detallados con cada ítem desglosado para que veas exactamente lo que estás pagando. Usa nuestro Estimador Aéreo en jronegutters.com/estimator para un rango de precios instantáneo." },
          ...
          { q: "¿Ofrecen canaletas de cobre?", a: "Sí. Instalamos sistemas de canaletas de cobre de media caña y estilo K con bajantes de cobre, cabezales y cadenas de lluvia a juego. El cobre desarrolla una pátina natural con el tiempo y dura más de 50 años con cero mantenimiento. Es una inversión de por vida para propietarios que quieren lo mejor." },
      ...
      },
      {
        key: "guards", name: "Protectores de Canaletas", faqs: [
          ...
          { q: "¿Qué tipos de protectores de canaletas instalan?", a: "Instalamos cuatro tipos: Protectores de aluminio (sólidos con canales de agua, ideales para escombros pesados), Protectores de malla estándar (protección general económica), Protectores de micro malla (filtración más fina, bloquean agujas de pino, gránulos de tejas y semillas pequeñas) y Protectores EZ Mesh (opción de fácil mantenimiento con excelente flujo de aire). Recomendamos el tipo correcto según tu cobertura de árboles y tipo de escombros." },
          ...
          { q: "¿Cuál es el mejor protector de canaletas para agujas de pino?", a: "Los protectores de micro malla son la opción más efectiva para agujas de pino. Los protectores de malla estándar tienen aberturas lo suficientemente grandes para que las agujas pasen y se acumulen adentro. La micro malla bloquea todo hasta gránulos de tejas mientras permite el flujo completo de agua. Si tienes pinos, robles o palmeras, la micro malla es lo que recomendamos." },
      ...
      },
      {
        key: "siding", name: "Revestimiento y SAGIPER", faqs: [
          ...
          { q: "¿Qué es SAGIPER y por qué es diferente?", a: "SAGIPER es un sistema de revestimiento arquitectónico de PVC de Europa con tecnología Solar Shield. El único producto de revestimiento diseñado para manejar colores oscuros bajo el sol directo de Florida sin deformarse, decolorarse o sufrir daños por calor. El revestimiento de vinilo estándar está limitado a colores claros en Florida porque el vinilo oscuro absorbe demasiado calor y se distorsiona. SAGIPER elimina esa limitación mientras ofrece perfiles modernos y de diseño avanzado que no puedes obtener con revestimiento estándar." },
          { q: "¿Puedo usar revestimiento de color oscuro en Florida?", a: "Con revestimiento de vinilo estándar, no. Los colores oscuros absorben demasiado calor y se deformarán, pandean o distorsionan bajo el sol de Florida. Con la tecnología Solar Shield de SAGIPER, sí. SAGIPER es el único producto que permite revestimiento exterior oscuro bajo la luz solar directa de Florida sin fallas relacionadas con el calor. Esta es una gran ventaja para propietarios y arquitectos que desean exteriores oscuros modernos." },
