    ...
    categories: [
      ...
      },
      {
        key: "peak", name: "Peak 301 y Seguros", faqs: [
          ...
          { q: "Peak 301 me ayudara con mi seguro de hogar?", a: "Puede ayudar. Las aseguradoras de Florida han aumentado las no-renovaciones de polizas en un 280% desde 2018, apuntando principalmente a techos de mas de 15 anos. Peak 301 viene con documentacion de garantia que, combinada con una certificacion de Vida Util Remanente (RUL) de un inspector autorizado, le da documentacion de la condicion de su techo que la ley de Florida orienta a las aseguradoras a considerar para techos de mas de 15 anos. Las decisiones de cobertura recaen en su aseguradora; confirme su situacion con su agente." },
          ...
          { q: "Cuanto dura el tratamiento?", a: "Peak 301 agrega 6 a 10 anos de vida a tu techo existente, respaldado por una garantia de producto por escrito (terminos vigentes confirmados en su evaluacion gratuita). La duracion exacta depende de la condicion actual de tu techo, su edad y tipo de teja, lo cual evaluamos antes de recomendar el tratamiento." },
          { q: "Que es una certificacion de Vida Util Remanente (RUL)?", a: "Una certificacion RUL es un informe de inspeccion profesional de un inspector autorizado licenciado que declara que tu techo tiene al menos 5 anos de vida util remanente. La ley de Florida limita la no-renovacion basada unicamente en la edad del techo en algunos casos cuando proporcionas una certificacion RUL valida; confirma tu situacion con tu agente o un abogado. El tratamiento Peak 301 respalda esta certificacion al restaurar tus tejas a una condicion que demuestra vida util viable." },
          ...
          { q: "Que debo hacer si recibo un aviso de no-renovacion de mi aseguradora?", a: "No entres en panico. Paso 1: Solicita la razon de la no-renovacion por escrito. Paso 2: Si es por la edad del techo, ejerce tu derecho a una inspeccion bajo la ley de Florida. Paso 3: Obtene una inspeccion RUL certificada de un inspector autorizado. Paso 4: Presenta la certificacion RUL con tu solicitud de renovacion. Paso 5: Si aun se niegan, presenta una queja ante la Oficina de Regulacion de Seguros de Florida (FLOIR). Te guiamos por todo este proceso y proporcionamos plantillas de documentos gratuitas en jronegutters.com/insurance-resource-center." },
