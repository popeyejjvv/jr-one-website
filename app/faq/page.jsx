    ...
    categories: [
      {
        key: "general", name: "General", faqs: [
          ...
          { q: "Cuánto tiempo lleva JR One en el negocio?", a: "JR One Aluminum LLC es propiedad de Christopher Rivera y él la dirige. Las raíces familiares en el oficio de canaletas de Tampa Bay se remontan a 1990, cuando el padre de Christopher, Javier Rivera, comenzó a instalar canaletas en Tampa después de inmigrar de Honduras. Más de 30 años de experiencia familiar en la industria de canaletas de Tampa a través de dos generaciones. Muchas de las empresas de canaletas y sofitos que operan hoy en el mercado de Tampa pueden rastrear su conocimiento hasta Javier. Personas que trabajaron para él, con él, o aprendieron a su lado." },
      ...
      },
      {
        key: "peak", name: "Peak 301 y Seguros", faqs: [
          ...
          { q: "Peak 301 es seguro para mi hogar y jardines?", a: "Sí. La fórmula a base de soya es no tóxica, biodegradable y completamente segura para tu jardín, mascotas y familia. Sin químicos agresivos, sin humos tóxicos, sin preocupaciones ambientales. Tu jardín no se verá afectado por el tratamiento." },
        ],
      },
      {
