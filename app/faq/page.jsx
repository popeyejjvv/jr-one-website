    ...
    categories: [
      ...
      },
      {
        key: "peak", name: "Peak 301 & Insurance", faqs: [
          ...
          { q: "How much does Peak 301 cost compared to roof replacement?", a: "For most Tampa Bay homes, Peak 301 shingle rejuvenation from JR One Aluminum runs around 60 to 75% less than a full roof replacement, which runs $15,000 to $25,000 or more in this market. Price is driven by roof size in squares, shingle type, shingle condition, roof pitch, and access. We give you exact pricing only after inspecting your specific roof. The treatment is a one-day application by our crew, with coordination with an inspector for your Remaining Useful Life (RUL) certification. For a number on your own Tampa Bay home, book a free roof assessment at jronegutters.com/peak-301 or call (844) 444-3114." },
    ...
    categories: [
      ...
      },
      {
        key: "peak", name: "Peak 301 y Seguros", faqs: [
          ...
          { q: "Cuánto cuesta Peak 301 comparado con el reemplazo del techo?", a: "Para la mayoría de los hogares de Tampa Bay, el rejuvenecimiento de tejas Peak 301 de JR One Aluminum cuesta alrededor de 60 a 75% menos que un reemplazo completo de techo, que en este mercado cuesta de $15,000 a $25,000 o más. El precio depende del tamaño del techo en cuadros, tipo de teja, condición de la teja, pendiente del techo y acceso. Le damos precios exactos solo después de inspeccionar su techo específico. El tratamiento es una aplicación de un solo día por nuestra cuadrilla, con coordinación con un inspector para tu certificación de Vida Útil Remanente (RUL). Para un número de su propia casa en Tampa Bay, solicite una evaluación gratuita del techo en jronegutters.com/peak-301 o llame al (844) 444-3114." },
