...
const T = {
  en: {
    ...
    comparison: [
      { feature: "Lifespan in Florida", aluminum: "20 to 30 years", copper: "50 years or more" },
      ...
      { feature: "Replacement frequency", aluminum: "Once every 20 to 30 years", copper: "Likely never" },
    ],
  ...
  es: {
    ...
    comparison: [
      { feature: "Vida útil en Florida", aluminum: "20 a 30 años", copper: "50 años o más" },
      ...
      { feature: "Frecuencia de reemplazo", aluminum: "Cada 20 a 30 años", copper: "Probablemente nunca" },
    ],
    ...
    faqs: [
      { q: "Cuánto cuestan los canalones de cobre?", a: "Los canalones half-round de cobre de JR One Aluminum en Tampa Bay, FL comienzan alrededor de $65 por pie lineal instalado, con bajantes de cobre a aproximadamente $50 por pie lineal. El precio depende de los pies lineales, la complejidad de la línea de techo y el número de esquinas y uniones que se sueldan a mano, la altura del techo y el acceso con escalera, si la casa es de uno o dos pisos, el perfil del canalón y el número de bajantes. Un sistema completo de cobre para una casa típica cuesta significativamente más que el aluminio, pero también dura 50 años o más. Para medir el tramo de su propia casa, empiece con el estimador de JR One en jronegutters.com/estimator y luego llame al (844) 444-3114 para una cotización de cobre." },
