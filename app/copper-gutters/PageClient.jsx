...
const T = {
  ...
  es: {
    ...
    comparison: [
      ...
      { feature: "Frecuencia de reemplazo", aluminum: "Cada 20 a 25 anos", copper: "Probablemente nunca" },
    ],
    ...
    goldSteps: [
      ...
      { num: "02", title: "Disenar", desc: "Diseno personalizado del sistema de cobre incluyendo perfil del canalon, ubicacion de bajantes, cabezales decorativos y expectativas de color/patina. Presupuesto detallado." },
      { num: "03", title: "Instalar", desc: "Nuestro equipo fabrica e instala su sistema de cobre con juntas soldadas y soportes colocados con precision. La instalacion de cobre es trabajo del oficio especializado." },
    ...
    faqs: [
      ...
      { q: "Pueden instalar canalones de cobre en cualquier casa?", a: "Tecnicamente si, pero el cobre no es la mejor opcion para toda casa. Se ve mejor en casas con caracter arquitectonico. Estilos historicos, mediterraneo, artesanal, colonial o contemporaneo de alta gama. En un rancho suburbano estandar, el costo elevado puede no entregar un impacto visual proporcional." },
      { q: "Cuanto tiempo toma la instalacion?", a: "La instalacion de cobre toma mas tiempo que el aluminio por la soldadura, colocacion de soportes personalizados y el trabajo de precision requerido. La mayoria de las instalaciones residenciales de canalones de cobre toman 2 a 4 dias dependiendo de la complejidad." },
      { q: "Ofrecen guardas de canalones de cobre?", a: "Si. Instalamos guardas de hojas de cobre en tamanos de 6\" y 7\" que combinan perfectamente con su sistema de canalones de cobre. Sin guardas de aluminio que no combinen encima de un sistema de cobre." },
    ],
    ctaTitle: "INTERESADO EN COBRE?",
    ctaSub: "El cobre no es para toda casa ni todo presupuesto. Para la propiedad correcta, nada se compara. Obtenga una evaluacion gratuita para saber si el cobre es la inversion correcta para la suya.",
    ...
    formDisclaimer: "Sin spam. Sin presion. Evaluacion honesta.",
    formSuccess: "Solicitud Recibida",
    formSuccessSub: "Nos pondremos en contacto para programar su evaluacion.",
  ...
  return (
    <div style={{ background: "var(--jr-navy)", color: "var(--jr-paper)", minHeight: "100vh" }}>
      ...
      <main id="main">
        ...
        <CTABand
          title={lang === "en" ? "Free Copper Assessment" : "Evaluacion de Cobre Gratis"}
