...
const T = {
  ...
  es: {
    ...
    idealFor: [
      ...
      { emoji: "⭐", title: "Casas para siempre", desc: "Si planea quedarse en su casa por 20+ años, el costo inicial más alto del cobre se paga solo. Nunca los reemplazará, y agregan valor cada año." },
    ],
