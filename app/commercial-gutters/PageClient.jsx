...
const T = {
  en: {
    ...
    heroH1a: "Commercial Gutter Installation",
    heroH1b: "for Tampa Bay Buildings That Can't Fail.",
    ...
    solutions: [
      ...
      { title: "Commercial drainage integration", desc: "Commercial roofs demand real drainage, not just a splash block. We install Schedule 40 PVC underground drainage, catch basins, surface grates, and pop-up emitters to move water where it belongs." },
    ...
    faqs: [
      ...
      { q: "Do you handle drainage too, or just the gutter itself?", a: "Full scope. Commercial roofs demand real drainage. We install Schedule 40 PVC underground drainage, catch basins, surface grates, and pop-up emitters alongside the gutter system. One contractor for the complete water-management package." },
  ...
  es: {
    ...
    solutions: [
      ...
      { title: "Integración de drenaje comercial", desc: "Los techos comerciales demandan drenaje real, no solo un bloque deflector. Instalamos PVC Schedule 40 subterráneo, sumideros, rejillas de superficie y emisores pop-up para mover agua donde pertenece." },
    ...
    faqs: [
      ...
      { q: "¿Manejan drenaje también, o solo la canaleta?", a: "Alcance completo. Los techos comerciales demandan drenaje real. Instalamos PVC subterráneo, sumideros, rejillas de superficie y emisores pop-up junto con el sistema de canaletas. Un contratista para el paquete completo de manejo de agua." },
...
export default function CommercialGuttersPage({ portfolio = null }) {
  ...
  return (
    <div style={{ background: "var(--jr-navy)", color: "var(--jr-paper)", minHeight: "100vh" }}>
      ...
      <main id="main">
        ...
        <section className="jr-noise-bg jr-service-hero" style={{ position: "relative", padding: "var(--jr-space-12) var(--jr-space-6) var(--jr-space-20)", backgroundImage: "linear-gradient(165deg, rgba(11,22,51,0.84) 0%, rgba(17,32,67,0.88) 55%, rgba(22,42,80,0.92) 100%), url('/images/commercial-gutters-hero.webp')", backgroundSize: "cover", backgroundPosition: "center", overflow: "hidden" }}>
          ...
          <Container>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "var(--jr-space-6)" }}>
              <div style={{ flex: "1 1 460px" }}>
                <div style={{ fontFamily: "var(--jr-font-heading)", fontSize: "var(--jr-text-xs)", fontWeight: 700, color: ACCENT, letterSpacing: "2px", marginBottom: "var(--jr-space-2)", textTransform: "uppercase" }}>{t.gcEyebrow}</div>
