...
const T = {
  en: {
    ...
    serviceOptions: ["Commercial Gutters", "Copper Gutters", "Drainage Installation", "Govee Lights", "Gutter Cleaning", "Gutter Guards", "Gutter Repair", "SAGIPER", "Seamless Gutters", "Service Plans", "Siding", "Soffit & Fascia", "Specialty Gutters", "HOA Contracts", "Rental Property Maintenance", "Other / Not Sure"],
  ...
  es: {
    ...
    serviceOptions: ["Canaletas Comerciales", "Canaletas de Cobre", "Instalacion de Drenaje", "Luces Govee", "Limpieza de Canaletas", "Protectores de Canaletas", "Reparacion de Canaletas", "SAGIPER", "Canaletas Sin Costura", "Planes de Servicio", "Revestimiento", "Sofito y Fascia", "Canaletas Especiales", "Contratos HOA", "Mantenimiento de Alquileres", "Otro / No Estoy Seguro"],
    ...
    callUsHours: "Lunes a Sabado, 7:00 AM a 6:00 PM",
    ...
    whatNextSteps: [
      ...
      { num: "02", title: "Programamos", desc: "Agendamos una cita para tu evaluacion gratuita en el sitio a tu conveniencia. Sin visitas sorpresa." },
      ...
      { num: "04", title: "Cotizamos", desc: "Recibes un estimado detallado y transparente con cada item desglosado. Sin numeros vagos, sin cargos ocultos." },
    ],
  },
};
