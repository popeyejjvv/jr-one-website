...
const T = {
  en: {
    ...
    stats: [
      ...
      { value: "24-48 hr", label: "Post-storm damage assessment" },
    ...
    scopeItems: [
      ...
      { title: "Aluminum-wrapped fascia replacement", desc: "Aluminum does not rot, and no wood is left exposed to the weather." },
    ...
    faqs: [
      ...
      { q: "How fast can you replace the gutters after a hurricane?", a: "Storm calls get priority on our schedule, with an assessment within 24 to 48 hours. Material is in stock at the Tampa shop, and once the crew is on site most single-family installs are done in one day. Most work is completed within 14 days of quote approval. After a major named storm the call volume is heavy, so we triage by severity, and homes with active water intrusion at the foundation jump the line." },
      ...
      { q: "Can you wrap the fascia in aluminum to prevent the next round of rot?", a: "Yes. We replace the rotted fascia board, prime it, wrap it in factory-finished aluminum that matches the new gutters, and re-hang. The aluminum wrap stops the rot cycle because no wood is left exposed to the weather." },
    ...
    finalCTATitle: "PRIORITY POST-STORM ESTIMATE",
    finalCTASub: "Call (844) 444-3114 or fill out the contact form. Christopher Rivera or a JR One field estimator answers. On-property within 48 hours, photos taken, bid written in person, material ordered as soon as you approve.",
  },
  es: {
    breadcrumb: "Inicio / Reparación de Canaletas por Tormenta",
    heroTag: "SERVICIO DE TEMPORADA DE HURACANES",
    heroH1: "Reparación de Canaletas Dañadas por Tormenta en Tampa,",
    heroH1Gold: "Evaluado en 48 Horas.",
    heroP: "Cuando una tormenta con nombre o una tormenta de verano arranca sus canaletas del fascia o dobla un bajante contra la casa, usted no tiene tiempo para esperar dos semanas por un estimado. JR One Aluminum es familia, más de 30 años en el oficio de canaletas, sofito y fascia en Tampa Bay. Despachamos a las 7 AM desde 3420 W Cherry St en Tampa y damos programación prioritaria a las llamadas por tormenta en Hillsborough, Pinellas y Pasco, con evaluación en 24 a 48 horas.",
    btnCall: "(844) 444-3114",
    btnEstimate: "PEDIR ESTIMADO PRIORITARIO",
    statsEyebrow: "LA TEMPORADA EN NÚMEROS",
    ...
    stats: [
      ...
      { value: "Misma semana", label: "Programación post-tormenta" },
      { value: "Más de 30", label: "Años en el oficio" },
    ],
    damageEyebrow: "LO QUE REEMPLAZAMOS",
    damageTitle: "Cinco Patrones Que Reparamos Cada Temporada",
    damages: [
      { title: "Canaletas arrancadas del fascia", desc: "La lluvia con viento y la fuerza ascendente revientan los ganchos ocultos o arrancan el aluminio del fascia. Reajustamos la pendiente, re-instalamos con ganchos atornillados resistentes a huracán, y sellamos cada esquina." },
      ...
      { title: "Fascia podrida por canaleta arrancada", desc: "Cuando se va la canaleta, la madera del fascia recibe lluvia directa. Removemos la madera podrida, instalamos tablero nuevo, lo envolvemos en aluminio con acabado de fábrica del color de la canaleta nueva, y re-instalamos en una sola visita." },
      { title: "Sofito dañado por escombros con viento", desc: "Huecos en el sofito de vinilo o aluminio dejan entrar pájaros, murciélagos, avispas y agua al ático. Parchamos o reemplazamos paneles de sofito en aluminio ventilado del color." },
      { title: "Agua estancada en los cimientos", desc: "El agua que no tiene a dónde ir se estanca en la losa. Combinamos el reemplazo de canaletas con drenaje subterráneo en PVC, cajas de captación, rejillas y emisores pop-up. No instalamos drenes franceses ni drenes de canal." },
    ],
    insuranceEyebrow: "DOCUMENTACIÓN PARA SU SEGURO",
    insuranceTitle: "Lo Que Damos para su Ajustador",
    insuranceP: "JR One Aluminum documenta el daño de tormenta para que su reclamo de seguro se apruebe limpiamente. Después del recorrido entregamos:",
    insuranceItems: [
      "Fotografías de cada tramo dañado, bajante y sección de fascia o sofito",
      "Un estimado escrito con conteos de pies lineales y especificaciones de material",
      "Un reporte de condición notando qué secciones son de la tormenta vs desgaste previo",
      "Coordinación directa con el ajustador cuando la aseguradora pide seguimiento",
    ],
    insuranceFooter: "No manejamos el reclamo en sí, eso queda entre usted y su aseguradora, pero le damos al ajustador todo lo que pide.",
    ...
    scopeItems: [
      ...
      { title: "Fascia reemplazado y envuelto en aluminio", desc: "El aluminio no se pudre y no queda madera expuesta al clima." },
    ...
    areaP: "Programación prioritaria post-tormenta en Hillsborough, Pinellas y Pasco. Ciudades: Tampa, St. Petersburg, Clearwater, Brandon, Riverview, Wesley Chapel, Lutz, Land O' Lakes, New Tampa, Valrico, Lithia, Plant City, Temple Terrace, Oldsmar, Safety Harbor, Dunedin, Palm Harbor, Tarpon Springs, Largo, Seminole, Pinellas Park. Lunes a sábado, 7 AM a 6 PM.",
    midCTATitle: "LA TEMPORADA ES JUNIO A NOVIEMBRE",
    midCTASub: "Reserve el estimado post-tormenta ahora. Las llamadas por tormenta tienen prioridad en el calendario y hay material en stock en el taller de Tampa.",
    faqEyebrow: "PREGUNTAS FRECUENTES",
    faqTitle: "Daño de Tormenta",
    faqs: [
      { q: "Mi seguro de hogar cubre canaletas dañadas por tormenta?", a: "La mayoría de pólizas de hogar en Florida cubren daño de tormenta a canaletas, fascia, sofito y bajantes cuando el daño viene de una tormenta con nombre o un evento de clima severo documentado. La cobertura depende de su póliza, su deducible y la causa del daño. Documentamos el daño para que su ajustador tenga lo que necesita." },
      { q: "Qué tan rápido pueden reemplazar las canaletas después de un huracán?", a: "Las llamadas por tormenta reciben programación prioritaria durante la temporada, con evaluación en 24 a 48 horas. Hay material en stock en el taller de Tampa. La mayoría de instalaciones residenciales se hacen en un día. Después de una tormenta con nombre priorizamos por severidad." },
      { q: "Instalan ganchos resistentes a huracán?", a: "Sí. Toda instalación de JR One usa ganchos ocultos atornillados espaciados para carga de viento de huracán. No usamos ganchos de clavo porque se zafan bajo fuerza ascendente." },
      { q: "Pueden envolver el fascia en aluminio para evitar la próxima pudrición?", a: "Sí. Reemplazamos el tablero de fascia podrido, lo imprimamos, lo envolvemos en aluminio con acabado de fábrica del color de las canaletas nuevas, y re-instalamos. El envoltorio de aluminio detiene el ciclo de pudrición porque no queda madera expuesta." },
      { q: "También hacen trabajo de techo por daño de tormenta?", a: "No. JR One Aluminum es oficio especializado en canaletas, sofito, fascia y drenaje. Para techos dañados por tormenta referimos a techadores confiables. Sí instalamos rejuvenecimiento de techo Peak 301 en techos de tejas que no están dañados pero están envejecidos." },
      { q: "Cuánto cuesta una instalación post-tormenta?", a: "El precio depende de pies lineales, conteo de bajantes, extensión del daño a fascia y sofito, tamaño de canaleta (6 o 7 pulgadas), color y acceso. Medimos en sitio, fotografiamos el daño y damos el precio en persona. El estimado es gratis." },
    ],
    relatedEyebrow: "SERVICIOS RELACIONADOS",
    relatedTitle: "Más de JR One Aluminum",
    related: [
      { title: "Canaletas continuas (6\" y 7\")", href: "/es/canaletas-sin-costura-tampa" },
      { title: "Sofito y fascia", href: "/es/sofito-fascia-tampa" },
      { title: "Drenaje subterráneo en PVC", href: "/drainage-assessment" },
      { title: "Documentación para seguro", href: "/insurance-resource-center" },
      { title: "Reparación de canaletas (no-tormenta)", href: "/es/reparacion-canaletas-tampa" },
    ],
    finalCTATitle: "ESTIMADO PRIORITARIO POST-TORMENTA",
    finalCTASub: "Llame al (844) 444-3114 o llene el formulario. Christopher Rivera o un estimador de JR One contesta. En su propiedad dentro de 48 horas, fotos tomadas, cotización en persona, material programado sin demora. Hablamos español.",
  },
};
