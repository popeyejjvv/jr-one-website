...
const T = {
  en: {
    ...
    peakDesc: "restores shingles from the inside out — adds 6–10 years of roof life and comes with the warranty docs Florida carriers need to see when evaluating your renewal.",
  ...
  es: {
    ...
    peakDesc: "restaura las tejas desde adentro — agrega 6–10 anos de vida al techo y viene con los documentos de garantia que las aseguradoras de FL necesitan ver al evaluar su renovacion.",
