...
const T = {
  ...
  es: {
    ...
    faqs: [
      ...
      { q: "Qué colores están disponibles para canaletas sin costuras?", a: "Ofrecemos más de 40 opciones de color en nuestro inventario de bobinas de aluminio. Las opciones más populares en Tampa Bay son blanco, almendra, arcilla, bronce, bronce oscuro y negro. Podemos igualar virtualmente cualquier color de moldura o fascia en su hogar." },
