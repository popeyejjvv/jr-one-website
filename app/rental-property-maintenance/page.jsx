...
const T = {
  ...
  es: {
    ...
    heroTag: "MANTENIMIENTO DE PROPIEDADES DE ALQUILER E INVERSIÓN",
    heroH1: "Servicio de Canaletas y Aluminio",
    heroH1Gold: "Hecho para Dueños Ausentes",
    heroP: "Su propiedad de alquiler, Airbnb o de inversión necesita el mismo cuidado de canaletas, sofito y fascia que una residencia principal, sin que usted tenga que viajar. JR One programa, ejecuta, fotografía y reporta. Usted aprueba desde cualquier lugar.",
    btnEstimate: "Solicite un Plan de Alquiler",
    btnCall: "Llame al (844) 444-3114",
    problemEyebrow: "EL PROBLEMA DEL DUEÑO AUSENTE",
    problemTitle: "Lo Que Sale Mal Cuando No Está Ahí",
    problems: [
      { title: "Pequeños problemas se vuelven grandes daños", desc: "Un bajante parcialmente obstruido que el inquilino no nota se desborda por 6 meses. El agua satura la fascia. Cuando lo ve en una visita, está mirando una reconstrucción de $4,000 en vez de una limpieza de $180." },
      { title: "Malas reseñas por problemas de agua", desc: "Los huéspedes de Airbnb culpan al anfitrión por agua corriendo por ventanas, empapando patios e inundando entradas, aún cuando la causa raíz es una canaleta sin mantenimiento. Las reseñas de una estrella afectan su ocupación." },
      { title: "Sin visibilidad de la propiedad", desc: "Usted vive en NY, Chicago o Miami. No puede pasar por ahí después de una tormenta. La mayoría de vendedores no envía fotos. Está volando a ciegas hasta la próxima limpieza." },
      { title: "Fricción con inquilinos", desc: "Los inquilinos a largo plazo no quieren extraños llegando sin aviso. Los alquileres cortos tienen rotaciones consecutivas. Los handymen genéricos no coordinan bien ninguno." },
    ],
    solutionEyebrow: "LA DIFERENCIA JR ONE PARA ALQUILERES",
    solutionTitle: "Un Proveedor Hecho Para Cómo Usted Realmente Posee la Propiedad",
    solutionSub: "Programado, documentado, coordinado con inquilinos. Diseñado para dueños en otro código postal.",
    solutions: [
      { title: "Servicio programado en su calendario", desc: "Limpieza de canaletas semestral o trimestral, inspección de sofito y fascia y pruebas de bajantes en horario fijo. Aprueba una vez, ejecutamos para siempre." },
      { title: "Reportes con fotos a su teléfono o email", desc: "Después de cada visita enviamos un reporte con fotos: antes y después, problemas encontrados y arreglos recomendados. Obtiene la misma visibilidad que si caminara la propiedad." },
      { title: "Coordinación con inquilinos incluida", desc: "Coordinamos directamente con inquilinos a largo plazo, equipos de limpieza de alquileres cortos, o su administrador. Usted no es el intermediario." },
      { title: "Respuesta de emergencia para problemas de agua", desc: "Si un inquilino o huésped reporta intrusión de agua, podemos estar en sitio en 48 horas (más rápido para fugas activas). Recibe un diagnóstico y plan antes de que el daño se extienda." },
      { title: "Precios que tienen sentido para alquileres", desc: "Los planes se cotizan para la economía de un alquiler, no precios minoristas de casa de lujo. Tarifas limpias, planas y agrupadas por visita." },
      { title: "Un proveedor para todo su portafolio", desc: "Tiene 3 alquileres? 10? 40? Un punto de contacto, un formato de factura y un estándar de reporte en cada propiedad." },
    ],
    stats: [
      { value: "500+", label: "Propiedades de alquiler mantenidas" },
      { value: "30+", label: "Años de trabajo en Tampa Bay" },
      { value: "48h", label: "Respuesta típica a problemas de agua" },
      { value: "100%", label: "Documentación fotográfica por visita" },
    ],
    ...
    scopeItems: [
      { title: "Plan de Un Solo Alquiler", desc: "Limpieza e inspección semestral en una propiedad LTR o STR. Reporte fotográfico después de cada visita. Ideal para el primer dueño fuera del estado." },
      { title: "Plan de Portafolio (2 a 10 unidades)", desc: "Precios agrupados a través de múltiples propiedades con un punto de contacto, formato de factura único y programación coordinada." },
      ...
      { title: "Coordinación STR", desc: "Para Airbnb y VRBO coordinamos el servicio alrededor de su ventana de rotación y trabajamos con su equipo de limpieza directamente. Cero interrupción al huésped." },
      { title: "Inspección Pre-Temporada", desc: "Antes de junio caminamos la línea del techo, documentamos la condición y marcamos lo que no sobrevivirá el verano. Dandole tiempo para arreglar antes de una tormenta." },
      { title: "Llamada de Daño Post-Tormenta", desc: "Después de una tormenta podemos estar en sitio en 72 horas en propiedades con contrato, documentando daño con fotos aptas para reclamos de seguro." },
    ],
    coverageLabel: "TAMBIÉN SERVIMOS",
    coverageTitle: "Dueños de alquileres cortos, largos y propiedades de inversión. En toda Tampa Bay.",
    coverageDesc: "Cubriendo Hillsborough, Pinellas, Pasco, Manatee y Sarasota. 21 ciudades incluyendo Tampa, Clearwater, St. Pete, Sarasota, Bradenton, Wesley Chapel, Palm Harbor y más.",
    coverageBtn: "Contacto",
    goldEyebrow: "EL ESTÁNDAR DE ORO",
    goldTitle: "Cómo Integramos una Propiedad de Alquiler",
    goldMotto: "Una llamada de configuración. Servicio programado. Reportes fotográficos siempre.",
    goldSteps: [
      { num: "01", title: "Evaluar", desc: "Recorrido inicial gratis (no necesita estar presente, coordinamos con el inquilino o limpiador). Documentamos condición, marcamos problemas inmediatos y recomendamos una cadencia." },
      { num: "02", title: "Diseñar", desc: "Plan personalizado: frecuencia de visita, alcance por visita y formato de reporte. Precio transparente sin cargos ocultos." },
      { num: "03", title: "Ejecutar", desc: "Ejecutamos según horario, coordinando con inquilinos o equipos de rotación directamente. Usted se queda fuera del medio." },
      { num: "04", title: "Reportar", desc: "Reporte fotográfico a su email o teléfono después de cada visita. Cualquier problema marcado para aprobación antes de proceder." },
    ],
    reviewEyebrow: "RESEÑAS DE INVERSORES",
    reviewTitle: "Lo Que Dicen los Dueños de Alquileres",
    reviews: [
      { text: "Tengo seis alquileres en Tampa y vivo en New Jersey. JR One fue el primer vendedor que realmente envió fotos sin que las pidiera. Ahora sé qué pasa en cada propiedad.", name: "Dueño Fuera del Estado", service: "Portafolio Tampa de 6 Propiedades", stars: 5 },
      { text: "Mi Airbnb recibía reseñas de una estrella por agua acumulándose en el patio. JR One arregló el direccionamiento del bajante en una visita. Las reseñas mejoraron en un mes.", name: "Anfitrión de Airbnb", service: "STR en St. Pete Beach", stars: 5 },
      { text: "Como administradora con 40+ unidades en Pinellas, tener un vendedor de aluminio con reportes limpios me salvó de una cadena interminable de emails.", name: "Administradora de Propiedad", service: "Portafolio de 40 Unidades", stars: 5 },
    ],
    faqEyebrow: "PREGUNTAS FRECUENTES",
    faqTitle: "Preguntas Sobre Servicio de Alquileres",
    faqs: [
      { q: "Cuánto cuesta un plan de servicio de alquiler?", a: "Planes de un solo alquiler típicamente corren $300 a $800 al año para limpieza más inspección semestral en un alquiler unifamiliar estándar. Planes de portafolio obtienen precios agrupados que bajan el costo por propiedad materialmente. Precio exacto después de un recorrido." },
      { q: "Necesito estar presente para el servicio?", a: "No. Ese es el punto del plan. Coordinamos con su inquilino, su limpiador STR o su administrador. Usted obtiene un reporte fotográfico después de cada visita." },
      { q: "Cómo manejan el acceso a la propiedad?", a: "Para LTR programamos con el inquilino directamente con al menos 48 horas de aviso. Para STR trabajamos en su ventana de rotación. Si está con portón, coordinamos código una vez y lo archivamos." },
      { q: "Qué pasa si el inquilino reporta un problema de agua entre visitas?", a: "Llame o escriba. Típicamente podemos estar en sitio en 48 horas en propiedades con contrato. Recibirá un plan y cotización antes de cualquier reparación." },
      { q: "Trabajan con administradores de propiedad?", a: "Sí. Muchas cuentas de alquiler vienen por administradores que quieren un vendedor único de aluminio. Facturamos al administrador, reportamos al administrador y coordinamos por el administrador." },
      { q: "Pueden manejar daño de sofito o fascia, no solo limpieza?", a: "Sí. Somos un oficio especializado en aluminio. Si una visita programada encuentra fascia podrida o paneles volados, lo marcamos para aprobación y ejecutamos la reparación en la misma visita." },
      { q: "Tienen seguro apto para trabajo en alquileres?", a: "Sí. JR One tiene cobertura completa de responsabilidad general y compensación laboral. Podemos proveer certificados a dueños o administradores a petición." },
    ],
    ctaTitle: "Listo Para Poner Su Alquiler en Piloto Automático?",
    ctaSub: "Cuéntenos sobre su propiedad o portafolio. Construiremos un plan personalizado, coordinaremos con el inquilino o limpiador y enviaremos reportes fotográficos después de cada visita. Sin vuelos.",
    ...
    formSuccessSub: "Le responderemos dentro de un día hábil.",
  ...
  const handleForm = async (e) => {
    ...
    try {
      ...
      const result = await submitLeadForm({
        formId: "rental-property-maintenance",
        lang,
        body: {
          ...guardFields(),
          name: formData.name,
      ...
      <main id="main">
        ...
        <CTABand
          ...
          sub={lang === "en"
            ...
            : "Reportes con fotos, servicio programado, coordinación con inquilinos. Obtene tu plan personalizado."}
