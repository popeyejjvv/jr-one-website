...
const PAGE = {
  ...
  services: [
    { name:"Seamless Gutters", desc:"6\" and 7\" seamless aluminum gutter installation", qualifies:true },
    ...
    { name:"Govee Lights", desc:"Professional LED lighting installation", qualifies:true },
    ...
    <div style={{background:C.bg,color:C.white,fontFamily:f.b,lineHeight:1.65,minHeight:"100vh"}}>
      ...
      <section className="hero-stars" style={{padding:"60px 24px 80px",maxWidth:"1200px",margin:"0 auto"}}>
        <div style={{maxWidth:"800px"}}>
          ...
          <div style={{display:"flex",gap:"16px",flexWrap:"wrap"}}>
            ...
            <a href="mailto:info@jronegutters.com?subject=Referral" style={{display:"inline-flex",alignItems:"center",padding:"16px 36px",fontFamily:f.h,fontSize:"14px",fontWeight:700,letterSpacing:"1.5px",color:C.accent,border:`2px solid ${C.accent}`,borderRadius:"8px",textDecoration:"none"}}>✉️ EMAIL A REFERRAL</a>
          </div>
        </div>
      ...
      <section style={{background:C.navy,padding:"80px 24px"}}>
        <div style={{maxWidth:"800px",margin:"0 auto"}}>
          <div style={{textAlign:"center"}}><Tag>QUALIFYING SERVICES</Tag><h2 style={{...secTitle,color:C.white}}>WHAT COUNTS</h2><GoldBar /><p style={{fontFamily:f.b,fontSize:"15px",color:C.muted,marginBottom:"40px"}}>Any of these services with a minimum project value of $880 qualifies for the referral program.</p></div>
      ...
      <section style={{background:C.bg,padding:"80px 24px"}}>
        <div style={{maxWidth:"800px",margin:"0 auto",textAlign:"center"}}>
          <Tag>FAQ</Tag><h2 style={{...secTitle,color:C.white}}>REFERRAL PROGRAM QUESTIONS</h2><GoldBar />
      ...
      <section style={{background:`linear-gradient(165deg,${C.navyMid},${C.navy})`,padding:"80px 24px"}}>
        <div style={{maxWidth:"700px",margin:"0 auto",textAlign:"center"}}>
          ...
          <div style={{display:"flex",gap:"16px",justifyContent:"center",flexWrap:"wrap"}}>
            ...
            <a href="mailto:info@jronegutters.com?subject=Referral%20Program" style={{display:"inline-flex",alignItems:"center",padding:"16px 36px",fontFamily:f.h,fontSize:"14px",fontWeight:700,letterSpacing:"1.5px",color:C.accent,border:`2px solid ${C.accent}`,borderRadius:"8px",textDecoration:"none"}}>✉️ EMAIL US</a>
          </div>
