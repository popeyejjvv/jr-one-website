...
const T = {
  ...
  es: {
    ...
    services: [
      ...
      { name: "Peak 301 Rejuvenecimiento de Techo", desc: "Rejuvenecimiento de tejas a base de soya con documentación de garantía" },
