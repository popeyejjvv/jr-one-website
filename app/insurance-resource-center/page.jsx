...
const T = {
  en: {
    ...
    faqs: [
      ...
      { q:"What does the treatment actually cost?", a:"Every roof is different — size, shingle type, and condition all affect the price. Peak 301 treatment comes in well below a full replacement ($15,000–$25,000+), and we provide exact pricing only after inspecting your specific roof. The free assessment is the fastest way to get a real number for your home. The treatment includes application, warranty documentation, and coordination with the inspector for your RUL certification." },
  ...
  es: {
    ...
    faqs: [
      ...
      { q:"¿Cuánto cuesta el tratamiento realmente?", a:"Cada techo es diferente — tamaño, tipo de teja y condición afectan el precio. El tratamiento Peak 301 cuesta muy por debajo de un reemplazo completo ($15,000–$25,000+), y proporcionamos precios exactos solo después de inspeccionar su techo específico. La evaluación gratuita es la forma más rápida de obtener un número real para su hogar. Proporcionamos precios exactos después de inspeccionar su techo específico. El tratamiento incluye aplicación, documentación de garantía y coordinación con el inspector para su certificación VUR." },
