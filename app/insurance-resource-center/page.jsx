...
const T = {
  en: {
    ...
    laws: [
      ...
      },
      {
        ...
        points: [
          ...
          "This expands homeowner options beyond just engineers and home inspectors for getting the certification that may help document your roof's remaining useful life for your insurer's review.",
        ],
      },
      {
    ...
    bottomLineText: "Florida law has shifted from age-based to condition-based roof evaluation. Your roof's actual condition, not its birthday, is what Florida carriers evaluate for roof-age-related coverage decisions. Peak 301 restores your roof to a condition that supports the certification these laws require.",
    ...
    carrierTypes: [
      {
        ...
        whatItMeans: "This is where Peak 301 + a certified inspection is most powerful. You treat the roof, get the certification, and under Florida law the carrier generally cannot refuse renewal based on roof age alone once you provide it.",
      ...
      },
      {
        ...
        whatItMeans: "If your roof is already past their hard cutoff, Peak 301 may not help with this specific carrier. However, it can help you document your roof's condition for condition-based carriers to consider. If your roof is approaching their cutoff (say, 12-15 years old), Peak 301 can extend your roof's life to keep you under the limit longer.",
    ...
    steps: [
      ...
      { num: "04", title: "Get a Roof Assessment", desc: "Contact JR One for a free Peak 301 assessment. We'll evaluate whether your roof is a candidate for Peak 301 rejuvenation and give you a clear, honest recommendation, including telling you if your roof needs replacement instead." },
      { num: "05", title: "Peak 301 Treatment", desc: "If your roof qualifies, our crew applies Peak 301 in a single day. The penetrating soy-based treatment soaks into your shingles and begins restoring flexibility and water resistance immediately. No demolition, no debris, no multi-day disruption." },
      { num: "06", title: "Get Your Certification", desc: "After treatment, a licensed authorized inspector (not JR One) evaluates your roof and issues a Remaining Useful Life (RUL) certification, the documentation Florida law directs carriers to consider for roofs over 15 years. We help you coordinate this step." },
    ...
    documents: [
      { title: "Letter to Your Insurance Company", desc: "A professional template you fill in with your name and policy number to formally request continued coverage and reference your inspection certification.", file: "JR_One_Insurance_Letter_Template.pdf" },
      ...
      { title: "What to Expect After Peak 301 Treatment", desc: "A clear, step-by-step guide covering what happens during application, what your roof will look like afterward, the timeline for full penetration, and the treatment documentation you'll receive.", file: "JR_One_Peak301_What_To_Expect.pdf" },
      { title: "Peak 301 Treatment Certificate", desc: "The official JR One treatment certificate documenting your roof has been professionally rejuvenated. Includes treatment date, product details, treatment terms, and your property information. Designed to be submitted alongside your RUL certification.", file: "JR_One_Peak301_Treatment_Certificate.pdf" },
    ],
    ...
    faqs: [
      { q: "Does Peak 301 guarantee my insurance will be renewed?", a: "No, and anyone who tells you that is not being honest. What Peak 301 does is restore your roof to a condition that supports a licensed inspector certifying 5+ years of remaining useful life. That certification is the documentation Florida law directs carriers to consider for roofs over 15 years. The treatment makes the certification possible; Florida law limits a carrier's ability to non-renew on roof age alone once you provide it." },
      { q: "What if my carrier still refuses to renew after I submit the certification?", a: "If your carrier refuses to renew solely because of roof age after you've provided a valid RUL certification from an authorized inspector, you may have grounds to challenge the non-renewal. Your first step is to request the reason for non-renewal in writing. Then contact the Florida Office of Insurance Regulation (FLOIR) to file a complaint, and consider speaking with your insurance agent or an attorney about your options. You can also work with your insurance agent to shop other carriers. Many condition-based carriers will accept the same certification." },
      { q: "Is roof rejuvenation the same as a roof coating?", a: "No. This distinction matters. Peak 301 is a penetrating soy-based treatment that soaks into your shingles and restores the depleted oils from the inside out. It does not create a surface film or coating. Roof coatings create a layer on top of the shingles, which ARMA (the Asphalt Roofing Manufacturers Association) warns against for asphalt shingles. Rejuvenation and coating are two entirely different products with different mechanisms." },
      ...
      { q: "What does the treatment actually cost?", a: "Every roof is different. Size, shingle type, and condition all affect the price. For most Tampa Bay homes, Peak 301 treatment runs around 60 to 75% less than a full replacement ($15,000 to $25,000+). We provide exact pricing only after inspecting your specific roof. The free assessment is the fastest way to get a real number for your home. The treatment includes application, your treatment certificate, and coordination with the inspector for your RUL certification." },
  ...
  es: {
    ...
    laws: [
      ...
      },
      {
        ...
        points: [
          ...
          "Esto amplía las opciones del propietario más allá de solo ingenieros e inspectores de viviendas para obtener la certificación que puede ayudar a documentar la vida útil restante de su techo para la revisión de su aseguradora.",
        ],
      },
      {
    ...
    bottomLineText: "La ley de Florida ha cambiado de una evaluación de techo basada en edad a una basada en condición. La condición real de su techo, no su antigüedad, es lo que las aseguradoras de Florida evalúan en decisiones de cobertura relacionadas con la edad del techo. Peak 301 restaura su techo a una condición que respalda la certificación que estas leyes requieren.",
    ...
    carrierTypes: [
      {
        ...
        whatItMeans: "Aquí es donde Peak 301 + una inspección certificada es más poderoso. Usted trata el techo, obtiene la certificación, y bajo la ley de Florida la aseguradora generalmente no puede negar la renovación basándose únicamente en la edad del techo una vez que usted la proporciona.",
    ...
    steps: [
      ...
      { num: "04", title: "Obtenga una Evaluación del Techo", desc: "Contacte a JR One para una evaluación gratuita de Peak 301. Evaluaremos si su techo es candidato para el rejuvenecimiento Peak 301 y le daremos una recomendación clara y honesta, incluyendo decirle si su techo necesita reemplazo en su lugar." },
      { num: "05", title: "Tratamiento Peak 301", desc: "Si su techo califica, nuestro equipo aplica Peak 301 en un solo día. El tratamiento penetrante a base de soya se absorbe en sus tejas y comienza a restaurar la flexibilidad y resistencia al agua inmediatamente. Sin demolición, sin escombros, sin interrupciones de varios días." },
      { num: "06", title: "Obtenga Su Certificación", desc: "Después del tratamiento, un inspector autorizado con licencia (no JR One) evalúa su techo y emite una certificación de Vida Útil Restante (VUR), la documentación que la ley de Florida orienta a las aseguradoras a considerar para techos de más de 15 años. Le ayudamos a coordinar este paso." },
    ...
    documents: [
      { title: "Carta a Su Compañía de Seguros", desc: "Una plantilla profesional que completa con su nombre y número de póliza para solicitar formalmente la continuación de cobertura y hacer referencia a su certificación de inspección.", file: "JR_One_Insurance_Letter_Template.pdf" },
      ...
      { title: "Qué Esperar Después del Tratamiento Peak 301", desc: "Una guía clara paso a paso que cubre qué sucede durante la aplicación, cómo se verá su techo después, el cronograma para la penetración completa y la documentación del tratamiento que recibirá.", file: "JR_One_Peak301_What_To_Expect.pdf" },
      { title: "Certificado de Tratamiento Peak 301", desc: "El certificado oficial de tratamiento de JR One que documenta que su techo ha sido rejuvenecido profesionalmente. Incluye fecha de tratamiento, detalles del producto, términos del tratamiento e información de su propiedad. Diseñado para presentarse junto con su certificación VUR.", file: "JR_One_Peak301_Treatment_Certificate.pdf" },
    ],
    ...
    faqs: [
      { q: "¿Peak 301 garantiza que mi seguro será renovado?", a: "No, y cualquiera que le diga eso no está siendo honesto. Lo que Peak 301 hace es restaurar su techo a una condición que respalda que un inspector con licencia certifique 5+ años de vida útil restante. Esa certificación es la documentación que la ley de Florida orienta a las aseguradoras a considerar para techos de más de 15 años. El tratamiento hace posible la certificación; la ley de Florida limita la capacidad de la aseguradora de no renovar basándose únicamente en la edad del techo una vez que usted la proporciona." },
      { q: "¿Qué pasa si mi aseguradora aún se niega a renovar después de que envío la certificación?", a: "Si su aseguradora se niega a renovar únicamente por la edad del techo después de que usted ha proporcionado una certificación VUR válida de un inspector autorizado, usted puede tener fundamentos para impugnar la no renovación. Su primer paso es solicitar la razón de la no renovación por escrito. Luego contacte la Oficina de Regulación de Seguros de Florida (FLOIR) para presentar una queja, y considere hablar con su agente de seguros o un abogado sobre sus opciones. También puede trabajar con su agente de seguros para buscar otras aseguradoras. Muchas aseguradoras basadas en condición aceptarán la misma certificación." },
      { q: "¿El rejuvenecimiento de techo es lo mismo que un recubrimiento de techo?", a: "No. Esta distinción importa. Peak 301 es un tratamiento penetrante a base de soya que se absorbe en sus tejas y restaura los aceites agotados desde adentro hacia afuera. No crea una película superficial ni recubrimiento. Los recubrimientos de techo crean una capa sobre las tejas, lo cual ARMA (la Asociación de Fabricantes de Techos de Asfalto) advierte en contra para tejas de asfalto. El rejuvenecimiento y el recubrimiento son dos productos completamente diferentes con mecanismos distintos." },
      ...
      { q: "¿Cuánto cuesta el tratamiento realmente?", a: "Cada techo es diferente. Tamaño, tipo de teja y condición afectan el precio. Para la mayoría de los hogares de Tampa Bay, el tratamiento Peak 301 cuesta alrededor de 60 a 75% menos que un reemplazo completo ($15,000 a $25,000+). Proporcionamos precios exactos solo después de inspeccionar su techo específico. La evaluación gratuita es la forma más rápida de obtener un número real para su hogar. El tratamiento incluye aplicación, su certificado de tratamiento y coordinación con el inspector para su certificación VUR." },
    ...
    ctaSub: "No espere a recibir una carta de no renovación. Llámenos hoy para una evaluación profesional del techo y descubra si Peak 301 es adecuado para su techo, y puede ahorrarle miles.",
