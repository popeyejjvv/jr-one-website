...
const T = {
  en: {
    ...
    faqs: [
      ...
      { q:"What does the treatment actually cost?", a:"Every roof is different — size, shingle type, and condition all affect the price. For most Tampa Bay homes, Peak 301 treatment runs around 60–75% less than a full replacement ($15,000–$25,000+). We provide exact pricing only after inspecting your specific roof. The free assessment is the fastest way to get a real number for your home. The treatment includes application, warranty documentation, and coordination with the inspector for your RUL certification." },
