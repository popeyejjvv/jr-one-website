...
const T = {
  ...
  es: {
    ...
    heroH1a: "Un Trabajo de Calidad No Debería",
    heroH1b: "Vaciar Tu ",
    heroH1bAccent: "Bolsillo.",
    heroP: "Nos asociamos con proveedores de financiamiento terceros para que puedas proteger tu hogar ahora y pagar con el tiempo. Términos flexibles, aprobación rápida y sin impacto en el precio de tu proyecto.",
    howEyebrow: "Cómo Funciona",
    howTitle: "Cómo Funciona el Financiamiento",
    ...
    steps: [
      ...
      { num: "02", title: "Elige tu plan", desc: "Te guiamos por las opciones de financiamiento disponibles incluyendo montos de pagos mensuales, términos y cualquier tarifa promocional actualmente disponible." },
      { num: "03", title: "Aprobación rápida", desc: "Aplica a través de nuestro socio de financiamiento. La mayoría de las decisiones regresan en minutos. La verificación inicial es típicamente una consulta suave de crédito." },
      { num: "04", title: "El trabajo comienza", desc: "Una vez confirmado el financiamiento, programamos tu proyecto. Obtenes instalación profesional ahora y pagos manejables que se ajustan a tu presupuesto." },
    ],
    ...
    faqs: [
      { q: "Necesito crédito perfecto para calificar?", a: "No. Nuestros socios de financiamiento trabajan con una variedad de perfiles crediticios. La mejor forma de saber para qué calificas es aplicar. La verificación inicial es típicamente una consulta suave que no afecta tu puntaje de crédito." },
      { q: "Cuánto tiempo toma la aprobación?", a: "La mayoría de las decisiones de financiamiento regresan en minutos. Sabrás antes de que termine tu cita de estimado si fuiste aprobado y cuáles son tus términos." },
      { q: "Hay opciones de 0% de interés?", a: "Periodos promocionales de 0% APR a veces están disponibles dependiendo del socio de financiamiento y las ofertas actuales. Pregúntanos sobre las promociones actuales cuando programes tu estimado." },
      { q: "Puedo pagar anticipadamente sin penalidades?", a: "La mayoría de nuestras opciones de financiamiento permiten pago anticipado sin penalidades por prepago. Confirmaremos los términos específicos de tu plan antes de que firmes." },
      { q: "Cuál es el tamaño mínimo de proyecto para financiamiento?", a: "El financiamiento está disponible para la mayoría de los tamaños de proyecto. Ya sea una reparación de canaletas o un reemplazo completo de sofito y fascia de toda la casa, podemos discutir opciones de pago que funcionen para tu presupuesto." },
      { q: "El financiamiento afecta el precio de mi estimado?", a: "No. El precio de tu proyecto es el mismo ya sea que pagues por adelantado o financies. El financiamiento es un método de pago. No cambia el alcance ni el costo del trabajo." },
    ],
    ctaTitle: "Listo Para Hablar de Financiamiento?",
    ctaP: "Llámanos y te guiamos por tus opciones. Sin obligación, sin presión.",
  },
};
