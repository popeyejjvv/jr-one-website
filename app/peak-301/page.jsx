...
const T = {
  en: {
    ...
    heroP: "Peak 301 is an all-natural, soy-based sealant that penetrates your shingles and restores them from the inside out. Adds 6 to 10 years of life to your existing roof — and comes with the warranty documentation Florida carriers are required by law to accept when deciding whether to renew your policy.",
    ...
    mathPeakDesc: "of added roof life from a one-day application. Backed by a 6-year warranty FL insurers are required to accept. Exact pricing after your free assessment.",
  ...
  es: {
    ...
    heroP: "Peak 301 es un sellador natural a base de soya que penetra sus tejas y las restaura desde adentro. Agrega 6 a 10 anos de vida a su techo existente — y viene con la documentacion de garantia que las aseguradoras de Florida estan obligadas por ley a aceptar al decidir si renovar su poliza.",
    ...
    mathPeakDesc: "de vida anadida al techo por una aplicacion de un solo dia. Respaldada por una garantia de 6 anos que las aseguradoras de FL estan obligadas a aceptar. Precio exacto despues de su evaluacion gratuita.",
