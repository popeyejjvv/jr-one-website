...
const T = {
  en: {
    ...
    heroP: "Peak 301 is an all-natural, soy-based sealant that penetrates your shingles and restores them from the inside out. Adds 6 to 10 years of life to your existing roof — and comes with the warranty documentation Florida carriers need to see when evaluating whether to renew your policy.",
    heroCta: "GET YOUR FREE ROOF ASSESSMENT",
    heroCall: "CALL (844) 444-3114",
    stats: [
      { value:"6–10", label:"Years added to roof life" },
      { value:"6-Yr", label:"Warranty — backed by FL law" },
    ...
    solutions: [
      ...
      { title:"Applied in a single day — no tear-off", desc:"A full roof replacement is weeks of noisy crews, dumpsters, and disruption. Peak 301 treatment is a single-day application. Our crew arrives, sprays the sealant, and leaves. Your landscaping, your routine, and your patience stay intact." },
    ...
    mathPeakPrice: "6–10 YRS",
    mathPeakDesc: "of added roof life from a one-day application. Backed by a 6-year warranty — documentation your insurer needs to see when evaluating your policy. Exact pricing after your free assessment.",
    mathSub: "Most homeowners who call us didn't know roof rejuvenation was an option. Book a free assessment — we'll show you exactly what your roof needs, with real pricing for your home.",
  ...
  es: {
    ...
    heroP: "Peak 301 es un sellador natural a base de soya que penetra sus tejas y las restaura desde adentro. Agrega 6 a 10 anos de vida a su techo existente — y viene con la documentacion de garantia que las aseguradoras de Florida necesitan ver al evaluar si renovar su poliza.",
    heroCta: "OBTENGA SU EVALUACION GRATUITA",
    heroCall: "LLAME AL (844) 444-3114",
    stats: [
      { value:"6–10", label:"Anos agregados al techo" },
      { value:"6 Años", label:"Garantia — respaldada por ley de FL" },
    ...
    solutions: [
      ...
      { title:"Aplicado en un solo dia — sin arrancar el techo", desc:"Un reemplazo total de techo son semanas de cuadrillas ruidosas, contenedores e interrupciones. El tratamiento Peak 301 es una aplicacion de un solo dia. Nuestro equipo llega, rocia el sellador y se va. Su jardin, su rutina y su paciencia permanecen intactos." },
    ...
    mathReplacementPrice: "$15K–$25K+",
    mathReplacementDesc: "Semanas de arrancar el techo, contenedores, y un cheque de cinco cifras. Puede que su aseguradora aun no quede contenta.",
    mathPeakLabel: "TRATAMIENTO PEAK 301",
    mathPeakPrice: "6–10 AÑOS",
    mathPeakDesc: "de vida anadida al techo por una aplicacion de un solo dia. Respaldada por una garantia de 6 anos — documentacion que su aseguradora necesita ver al evaluar su poliza. Precio exacto despues de su evaluacion gratuita.",
    mathSub: "La mayoria de los propietarios que nos llaman no sabian que el rejuvenecimiento de techo era una opcion. Reserve una evaluacion gratuita — le mostraremos exactamente lo que necesita su techo, con precios reales para su hogar.",
    ...
    faqs: [
      ...
      { q:"Cuanto cuesta el tratamiento Peak 301?", a:"Cada techo es diferente — tamano, tipo de teja, condicion y acceso afectan el precio. El tratamiento Peak 301 cuesta muy por debajo de un reemplazo total ($15,000–$25,000+), y proporcionamos precios exactos solo despues de inspeccionar su techo especifico. La evaluacion gratuita es la forma mas rapida de obtener un numero real para su hogar." },
