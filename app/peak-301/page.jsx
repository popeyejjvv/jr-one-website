...
const T = {
  en: {
    ...
    insuranceStat1: "280%",
    insuranceStat1Label: "reported rise in Florida homeowner non-renewals since 2018 (industry reporting)",
    insuranceStat2: "15 Years",
    insuranceStat2Label: "the roof age at which most Florida insurers start dropping coverage",
    insuranceDesc: "Florida insurance companies are canceling homeowner policies at record rates based on roof age alone, even if your roof isn't leaking. If your shingle roof is 15+ years old, you may already be on borrowed time. Peak 301 restores shingle flexibility and granule adhesion, which can help your roof show remaining useful life when a licensed inspector evaluates it.",
    insuranceCta: "Insurance Resource Center",
    insuranceSub: "Under Florida law, a homeowner may not be dropped solely because of roof age if a licensed inspection certifies enough remaining useful life. Read the laws, the carrier types, and grab free document templates.",
    ...
    solutionTitle: "How Peak 301 Restores Your Roof and Helps You Document Its Condition",
    ...
    solutions: [
      { title: "Soy-based sealant, not a coating", desc: "Peak 301 is not a paint, spray, or surface coating. It's a soy-based sealant that penetrates into your shingle material and restores the oils that UV and heat have depleted. It rejuvenates from the inside out, restoring flexibility and resilience at the molecular level." },
      { title: "Adds 6 to 10 years of roof life", desc: "By restoring the oils that keep shingles pliable and resilient, Peak 301 extends your roof's functional lifespan by 6 to 10 years. That's 6 to 10 more years before you face the $15K to $25K+ replacement conversation." },
      ...
      { title: "Documentation for insurers", desc: "Peak 301 treatment comes with documentation showing your roof was professionally treated. You can share it with your insurer, and pair it with a licensed inspector's report, when they review your renewal." },
      { title: "Soy-based and eco-friendly", desc: "The soy-based formula is non-toxic and biodegradable, with no harsh chemicals and no toxic fumes. Our crew still covers nearby plants before applying and rinses the surrounding surfaces when the job is done." },
    ...
    faqs: [
      { q: "What exactly is Peak 301?", a: "Peak 301 is an all-natural, soy-based roof rejuvenation sealant. It penetrates into your shingle material and restores the oils that UV exposure and heat have depleted over time. It is not a coating, paint, or spray. It works from the inside of the shingle out, restoring flexibility, resilience, and granule adhesion." },
      { q: "How much does Peak 301 treatment cost?", a: "For most Tampa, FL homes, Peak 301 shingle rejuvenation from JR One Aluminum runs around 60 to 75% less than a full roof replacement, which runs $15,000 to $25,000 or more in this market. Price is driven by roof size in squares, shingle type, shingle condition, roof pitch, and access. We provide exact pricing only after we inspect your specific roof. The free assessment is the fastest way to get a real number for your home. Book one at jronegutters.com/peak-301 or call (844) 444-3114." },
      { q: "Can Peak 301 help with my homeowner's insurance renewal?", a: "Peak 301 treatment comes with documentation showing your roof was professionally rejuvenated. Florida insurers are increasingly reviewing coverage on roofs over 15 years old, and you can provide that documentation to your insurer, alongside a licensed inspector's assessment, for them to consider at renewal." },
      ...
      { q: "Is the sealant safe for my home and landscaping?", a: "Peak 301 is an all-natural soy-based formula that is non-toxic and biodegradable, with no harsh chemicals or toxic fumes. We still take normal precautions: we cover nearby plants before applying, rinse the surrounding surfaces afterward, and ask that pets and kids stay inside while the crew is working." },
      ...
      { q: "Can I see proof that Peak 301 works?", a: "Yes. We can show you documentation on the sealant's testing, performance data, and warranty terms. We can also connect you with Tampa homeowners who have had the treatment and can share their experience." },
    ],
    ctaTitle: "Don't Replace Your Roof Until You Call Us",
    ctaSub: "Peak 301 could save you $15,000+ and help you document your roof's remaining life for your insurer's review. Get a free roof assessment to find out if your shingle roof is a candidate for rejuvenation instead of replacement.",
  ...
  es: {
    ...
    heroH1c: "Peak 301 Le Ayuda a Conservarlos.",
    heroP: "Peak 301 es un sellador natural a base de soya que penetra en sus tejas y las restaura desde adentro. Agrega 6 a 10 años de vida a su techo de tejas asfálticas existente por hasta 70% menos que una instalación de techo nuevo. Viene con documentación del tratamiento que puede entregar a su aseguradora cuando evalúe su póliza.",
    ...
    insuranceStat1: "280%",
    insuranceStat1Label: "aumento reportado en no renovaciones de pólizas en Florida desde 2018 (según reportes de la industria)",
    ...
    insuranceDesc: "Las compañías de seguros de Florida están cancelando pólizas a tasas récord basándose solo en la edad del techo, incluso si su techo no tiene goteras. Si su techo de tejas tiene 15+ años, puede que ya esté en tiempo prestado. Peak 301 restaura la flexibilidad de las tejas y la adhesión de gránulos, lo que puede ayudar a que su techo muestre vida útil restante cuando un inspector con licencia lo evalúe.",
    insuranceCta: "Centro de Recursos de Seguros",
    insuranceSub: "Según la ley de Florida, no pueden cancelarle el seguro solo por la edad del techo si una inspección con licencia certifica suficiente vida útil restante. Lea las leyes, los tipos de aseguradoras y consiga plantillas de documentos gratis.",
    ...
    solutionTitle: "Cómo Peak 301 Restaura Su Techo y Ayuda a Documentar Su Condición",
    ...
    solutions: [
      { title: "Sellador a base de soya, no recubrimiento", desc: "Peak 301 no es una pintura, spray o recubrimiento superficial. Es un sellador a base de soya que penetra en el material de sus tejas y restaura los aceites que los rayos UV y el calor han agotado. Rejuvenece desde adentro hacia afuera, restaurando flexibilidad y resiliencia a nivel molecular." },
      { title: "Agrega 6 a 10 años de vida al techo", desc: "Al restaurar los aceites que mantienen las tejas flexibles y resilientes, Peak 301 extiende la vida funcional de su techo de 6 a 10 años. Son 6 a 10 años más antes de enfrentar la conversación de reemplazo de $15K a $25K+." },
      ...
      { title: "Documentación para aseguradoras", desc: "Peak 301 viene con documentación que muestra que su techo fue tratado profesionalmente, que puede compartir con su aseguradora junto con la evaluación de un inspector con licencia." },
      { title: "A base de soya y ecológico", desc: "La fórmula a base de soya es no tóxica y biodegradable, sin químicos agresivos ni vapores tóxicos. Aun así, nuestra cuadrilla cubre las plantas cercanas antes de aplicar y enjuaga las superficies de alrededor al terminar." },
    ...
    faqs: [
      { q: "¿Qué es exactamente Peak 301?", a: "Peak 301 es un sellador natural de rejuvenecimiento a base de soya. Penetra en el material de sus tejas y restaura los aceites que la exposición UV y el calor han agotado con el tiempo. No es un recubrimiento, pintura o spray. Trabaja desde el interior de la teja hacia afuera, restaurando flexibilidad, resiliencia y adhesión de gránulos." },
      { q: "¿Cuánto cuesta el tratamiento Peak 301?", a: "Para la mayoría de las casas en Tampa, FL, el rejuvenecimiento de tejas Peak 301 de JR One Aluminum cuesta alrededor de 60 a 75% menos que un reemplazo total de techo, que en este mercado cuesta de $15,000 a $25,000 o más. El precio depende del tamaño del techo en cuadros, tipo de teja, condición de la teja, pendiente del techo y acceso. Damos precio exacto solo después de inspeccionar su techo específico. La evaluación gratuita es la forma más rápida de obtener un número real. Solicítela en jronegutters.com/peak-301 o llame al (844) 444-3114." },
      { q: "¿Peak 301 puede ayudar con la renovación de mi seguro?", a: "El tratamiento Peak 301 viene con documentación que muestra que su techo fue rejuvenecido profesionalmente. Las aseguradoras de Florida cada vez revisan más la cobertura en techos de más de 15 años, y usted puede presentar esa documentación a su aseguradora, junto con la evaluación de un inspector con licencia, para que la consideren en la renovación." },
      ...
      { q: "¿El sellador es seguro para mi casa y jardín?", a: "Peak 301 es una fórmula natural a base de soya, no tóxica y biodegradable, sin químicos agresivos ni vapores tóxicos. Aun así tomamos las precauciones normales: cubrimos las plantas cercanas antes de aplicar, enjuagamos las superficies de alrededor al terminar y pedimos que las mascotas y los niños se queden adentro mientras trabaja la cuadrilla." },
      ...
      { q: "¿Puedo ver pruebas de que Peak 301 funciona?", a: "Sí. Podemos mostrarle documentación sobre las pruebas del sellador, datos de rendimiento y términos de garantía. También podemos conectarlo con propietarios en Tampa que han recibido el tratamiento y pueden compartir su experiencia." },
    ],
    ctaTitle: "No Reemplace Su Techo Hasta Que Nos Llame",
    ctaSub: "Peak 301 podría ahorrarle $15,000+ y ayudarle a documentar la vida útil restante de su techo para la revisión de su aseguradora. Obtenga una evaluación gratuita para saber si su techo de tejas es candidato para rejuvenecimiento en lugar de reemplazo.",
