...
const T = {
  en: {
    ...
    stats: [
      ...
      { value:"1 Day", label:"Full application, start to finish" },
    ...
    mathPeakPrice: "One Day",
    mathPeakDesc: "Assessment, treatment, warranty, and RUL documentation. Exact pricing after we inspect your roof.",
  ...
  es: {
    ...
    stats: [
      ...
      { value:"1 Dia", label:"Aplicacion completa, de inicio a fin" },
    ...
    mathPeakPrice: "Un Dia",
    mathPeakDesc: "Evaluacion, tratamiento, garantia, y documentacion VUR. Precio exacto despues de inspeccionar su techo.",
