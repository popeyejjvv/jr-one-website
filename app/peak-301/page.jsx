...
const T = {
  en: {
    ...
    faqs: [
      ...
      { q: "Can I see proof that Peak 301 works?", a: "Yes. We can show you documentation on the sealant's testing and performance data. We can also connect you with Tampa homeowners who have had the treatment and can share their experience." },
    ],
  ...
  es: {
    ...
    faqs: [
      ...
      { q: "¿Puedo ver pruebas de que Peak 301 funciona?", a: "Sí. Podemos mostrarle documentación sobre las pruebas del sellador y datos de rendimiento. También podemos conectarlo con propietarios en Tampa que han recibido el tratamiento y pueden compartir su experiencia." },
    ],
