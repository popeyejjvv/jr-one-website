...
const T = {
  en: {
    ...
    heroP: "Peak 301 is an all-natural, soy-based sealant that penetrates your shingles and restores them from the inside out. Adds 6 to 10 years of life to your existing roof for up to 70% less than a new roof install — and comes with the warranty documentation Florida carriers need to see when evaluating whether to renew your policy.",
    ...
    solutions: [
      ...
      { title:"Up to 70% less than replacement — in one day", desc:"A full roof replacement runs $15,000–$25,000+ in Tampa and takes weeks of tear-off. Peak 301 treatment is a single-day application at up to 70% less — you save on labor, disruption, and the five-figure check." },
    ...
    mathPeakDesc: "than a new roof install. One-day application. 6–10 years of added roof life. 6-year warranty — documentation your insurer needs to see when evaluating your policy. Exact pricing after your free assessment.",
  ...
  es: {
    ...
    heroP: "Peak 301 es un sellador natural a base de soya que penetra sus tejas y las restaura desde adentro. Agrega 6 a 10 anos de vida a su techo existente por hasta 70% menos que una instalacion de techo nuevo — y viene con la documentacion de garantia que las aseguradoras de Florida necesitan ver al evaluar si renovar su poliza.",
    heroCta: "OBTENGA SU EVALUACION GRATUITA",
    heroCall: "LLAME AL (844) 444-3114",
    stats: [
      { value:"6–10", label:"Anos agregados al techo" },
      { value:"Hasta 70%", label:"menos que una instalacion de techo nuevo" },
    ...
    solutions: [
      ...
      { title:"Hasta 70% menos que un reemplazo — en un dia", desc:"Un reemplazo total de techo cuesta $15,000–$25,000+ en Tampa y toma semanas de arrancar el techo. El tratamiento Peak 301 es una aplicacion de un solo dia a hasta 70% menos — ahorra en mano de obra, interrupciones y el cheque de cinco cifras." },
    ...
    mathPeakDesc: "que una instalacion de techo nuevo. Aplicacion de un solo dia. 6–10 anos de vida anadida al techo. Garantia de 6 anos — documentacion que su aseguradora necesita ver al evaluar su poliza. Precio exacto despues de su evaluacion gratuita.",
    ...
    faqs: [
      ...
      { q:"Cuanto cuesta el tratamiento Peak 301?", a:"Cada techo es diferente — tamano, tipo de teja, condicion y acceso afectan el precio. Para la mayoria de las casas en Tampa, el tratamiento Peak 301 cuesta alrededor de 60–75% menos que un reemplazo total ($15,000–$25,000+). Proporcionamos precios exactos solo despues de inspeccionar su techo especifico. La evaluacion gratuita es la forma mas rapida de obtener un numero real para su hogar." },
