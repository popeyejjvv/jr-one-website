...
const T = {
  en: {
    ...
    stats: [
      ...
      { value:"Fraction", label:"of replacement cost" },
    ...
    solutions: [
      ...
      { title:"A fraction of replacement cost", desc:"A full roof replacement runs $15,000–$25,000+ in Tampa. Peak 301 treatment costs a fraction of that — giving you years of additional protection at a price point that makes financial sense." },
    ...
    mathPeakPrice: "A fraction",
    mathPeakDesc: "of replacement cost. One day. Warranty documentation included.",
    mathSub: "Why spend $20,000 on a new roof when your existing roof can be restored for a fraction of that?",
    ...
    faqs: [
      ...
      { q:"How much does Peak 301 treatment cost?", a:"Peak 301 treatment costs a fraction of what a full roof replacement would cost. For most Tampa homes, that means thousands of dollars instead of $15,000–$25,000+. We provide exact pricing after inspecting your specific roof." },
  ...
  es: {
    ...
    heroP: "Peak 301 es un sellador natural a base de soya que penetra sus tejas y las restaura desde adentro — agregando 6 a 10 anos de vida a su techo existente a una fraccion del costo de reemplazo. Ademas, viene con documentacion de garantia que su compania de seguros necesita ver.",
    heroCta: "OBTENGA SU EVALUACION GRATUITA",
    heroCall: "LLAME AL (844) 444-3114",
    stats: [
      { value:"6–10", label:"Anos agregados al techo" },
      { value:"Fraccion", label:"del costo de reemplazo" },
    ...
    solutions: [
      ...
      { title:"Una fraccion del costo de reemplazo", desc:"Un reemplazo total de techo cuesta $15,000–$25,000+ en Tampa. El tratamiento Peak 301 cuesta una fraccion de eso — dandole anos de proteccion adicional a un precio que tiene sentido financiero." },
    ...
    mathPeakPrice: "Una fraccion",
    mathPeakDesc: "del costo de reemplazo. Un dia. Documentacion de garantia incluida.",
    mathSub: "Por que gastar $20,000 en un techo nuevo cuando su techo existente puede restaurarse por una fraccion?",
    ...
    faqs: [
      ...
      { q:"Cuanto cuesta el tratamiento Peak 301?", a:"El tratamiento Peak 301 cuesta una fraccion de lo que costaria un reemplazo total de techo. Para la mayoria de las casas en Tampa, eso significa miles de dolares en lugar de $15,000–$25,000+. Proporcionamos precios exactos despues de inspeccionar su techo especifico." },
