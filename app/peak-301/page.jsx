...
const T = {
  ...
  es: {
    ...
    stats: [
      ...
      { value:"<15%", label:"Costo vs. reemplazo total" },
    ...
    solutions: [
      ...
      { title:"Menos del 15% del costo de reemplazo", desc:"Un reemplazo total de techo cuesta $15,000–$25,000+ en Tampa. El tratamiento Peak 301 cuesta una fraccion de eso — dandole anos de proteccion adicional a un precio que tiene sentido financiero." },
    ...
    faqs: [
      ...
      { q:"Cuanto cuesta el tratamiento Peak 301?", a:"El tratamiento Peak 301 cuesta menos del 15% de lo que costaria un reemplazo total de techo. Para la mayoria de las casas en Tampa, eso significa miles de dolares en lugar de $15,000–$25,000+. Proporcionamos precios exactos despues de inspeccionar su techo especifico." },
