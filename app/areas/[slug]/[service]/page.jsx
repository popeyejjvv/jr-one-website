...
const ENRICHMENT = {
  ...
  "brandon/gutter-cleaning": {
    ...
    faqs: [
      { q: "How much does gutter cleaning cost in Brandon?", a: "Standard single-story homes in Bloomingdale, Providence Lakes, or Sterling Ranch run $175 to $300 for a full clean including downspout flushing and flow testing. Two-story homes and homes with mature oak canopy in FishHawk Ranch or Brandon Hills run $250 to $400 because we are removing more material and inspecting more length. Flat price up front after a quick property walk, no per-foot surprises. Free estimate by phone or text." },
  ...
  "largo/seamless-aluminum-gutters": {
    ...
    faqs: [
      { q: "How much does seamless gutter installation cost in Largo?", a: "Standard single-story homes in Largo Central, Anona, or Pinebrook Estates run $1,750 to $3,400 for a full seamless replacement including downspouts and hidden hangers. Two-story homes and larger custom homes in Harbor Bluffs or Bay Vista Estates run $3,400 to $6,500 depending on linear footage, roofline complexity, and color match. Free flat-price estimate at the property, no per-foot surprises." },
  ...
  "clearwater/gutter-repair": {
    ...
    faqs: [
      { q: "How much does gutter repair cost in Clearwater?", a: "Spot repairs (one seam, one downspout, hanger replacement) typically run $200 to $475. Full re-pitch and re-hang of a single run is $325 to $700 depending on length and access. Section replacement on a damaged run is $9 to $15 per linear foot installed including matching the existing profile. Sand Key, Clearwater Beach, and Island Estates properties are walked and quoted on a per-property basis because corrosion inspection is part of the work. Free flat-price estimate, no per-trip charge." },
  ...
  "st-petersburg/seamless-aluminum-gutters": {
    ...
    faqs: [
      { q: "How much does seamless gutter installation cost in St. Petersburg?", a: "Standard single-story homes in Disston Heights, Crescent Lake, or Lakewood Estates run $1,800 to $3,400 for a full seamless replacement including downspouts and hidden hangers. Two-story homes in Old Northeast or Snell Isle and larger custom homes on Bayway Isles run $3,500 to $6,500 depending on linear footage, roofline complexity, and color match. Free flat-price estimate, no per-foot surprises." },
  ...
  "lakeland/seamless-aluminum-gutters": {
    ...
    faqs: [
      { q: "How much does seamless gutter installation cost in Lakeland?", a: "Standard single-story homes in Cleveland Heights, Christina, or Beacon Hill run $1,650 to $3,200 for a full seamless replacement including downspouts and hidden hangers. Two-story homes and larger custom homes in Lakeland Highlands or around Lake Hollingsworth run $3,200 to $6,000 depending on linear footage, roofline complexity, and color match. Free flat-price estimate at the property, no per-foot surprises." },
  ...
  "lakeland/gutter-repair": {
    ...
    faqs: [
      { q: "How much does gutter repair cost in Lakeland?", a: "Spot repairs (one seam, one downspout, hanger replacement) typically run $175 to $425. Full re-pitch and re-hang of a single run is $300 to $625 depending on length and access. Section replacement on a damaged run is $8 to $14 per linear foot installed including matching the existing profile. Free flat-price estimate at the property, no per-trip charge for the visit." },
  ...
  "new-port-richey/gutter-repair": {
    ...
    faqs: [
      { q: "How much does gutter repair cost in New Port Richey?", a: "Spot repairs (one seam, one downspout, hanger replacement) typically run $200 to $450. Full re-pitch and re-hang of a single run is $325 to $675 depending on length and access. Section replacement on a damaged run is $8 to $14 per linear foot installed including matching the existing profile. Waterfront homes in Gulf Harbors or along Riverside Drive are walked and quoted on a per-property basis because corrosion inspection is part of the work. Free flat-price estimate." },
  ...
  "dunedin/gutter-cleaning": {
    ...
    faqs: [
      { q: "How much does gutter cleaning cost in Dunedin?", a: "Standard single-story homes in Downtown Dunedin, Hawthorn Hills, or Spanish Trails run $175 to $300 for a full clean including downspout flushing and flow testing. Two-story homes and homes under mature oak or pine canopy near the Dunedin Country Club run $250 to $400. Direct Gulf-facing properties take longer because the cleaning visit doubles as a corrosion inspection. Free flat-price estimate by phone or text." },
  ...
  "new-port-richey/seamless-aluminum-gutters": {
    ...
    faqs: [
      { q: "How much does seamless gutter installation cost in New Port Richey?", a: "Standard single-story homes in Magnolia Valley, Jasmine Lakes, or Holiday run $1,750 to $3,300 for a full seamless replacement including downspouts and hidden hangers. Two-story homes and larger custom homes in Trinity, Seven Springs, or River Ridge run $3,400 to $6,500 depending on linear footage, roofline complexity, and color match. Waterfront homes in Gulf Harbors or along Riverside Drive are walked and quoted on a per-property basis. Free flat-price estimate." },
  ...
  "largo/gutter-cleaning": {
    ...
    faqs: [
      { q: "How much does gutter cleaning cost in Largo?", a: "Standard single-story homes in Largo Central, Anona, or Harbor Bluffs run $175 to $300 for a full clean including downspout flushing and flow testing. Two-story homes and homes under mature oak canopy in Bay Vista Estates or Pinebrook Estates run $250 to $400 because we are removing more material. Direct beach-side access properties near Indian Rocks Beach get walked and quoted per-property. Free flat-price estimate by phone or text, no per-foot surprises." },
  ...
  "clearwater/gutter-guards": {
    ...
    propsOverride: [
      ["Micro-mesh stainless guard","Blocks pine needles and oak debris, the test most consumer guards fail. Clearwater has too much mature canopy in Countryside, Morningside, and Skycrest for anything less."],
      ["Works with existing 6-inch and 7-inch gutters","Retrofit onto your current system if the existing gutter is sound. No full replacement needed."],
      ["Cuts cleaning frequency","Three cleanings a year drops to one inspection visit. Math works in two to four years for canopy-heavy homes."],
  ...
  "lakeland/copper-gutters": {
    ...
    faqs: [
      { q: "How much do copper gutters cost in Lakeland?", a: "Copper installs at roughly three times the cost of comparable aluminum. A single-story historic-district home in Lake Hollingsworth or South Lake Morton with 150 to 200 linear feet typically runs $7,500 to $14,000 in copper versus $2,500 to $4,500 in aluminum. Two-story estate homes in Beacon Hill or Cleveland Heights run $12,000 to $24,000. Free flat-price estimate at the property, no per-foot surprises after fabrication starts." },
  ...
  "clearwater/soffit-and-fascia": {
    ...
    propsOverride: [
      ["Wood-to-aluminum conversion","Original 1980s wood soffit and fascia replaced with maintenance-free aluminum. No more painting, rotting, or peeling. Color-matched to existing trim and gutter color."],
  ...
  "st-petersburg/soffit-and-fascia": {
    ...
    propsOverride: [
      ["Wood-to-aluminum conversion","Original 1950s through 1970s wood soffit and fascia replaced with maintenance-free aluminum. No more painting, rotting, peeling, or insect activity. Color-matched to existing trim and gutter."],
    ...
    faqs: [
      { q: "How much does soffit and fascia replacement cost in St. Petersburg?", a: "Standard aluminum conversion runs $9 to $16 per linear foot installed, which puts a single-story home in Disston Heights, Crescent Lake, or Lakewood Estates at $2,800 to $6,500 for full perimeter conversion depending on linear footage and ventilation spec. Two-story bayfront homes in Old Northeast, Snell Isle, or Bayway Isles run $5,500 to $14,000. Coquina Key and direct bay-access estate properties get walked and quoted per-property because installation also includes corrosion-resistant fastener inspection. Free flat-price estimate, no per-foot surprises." },
      { q: "Should I repair or replace my old St. Pete wood soffit and fascia?", a: "Depends on how much of the run is soft. If the rot is isolated to one or two sections, spot repair plus aluminum conversion on the failed sections only is the right call. On 50 to 70 year old pre-1980 stock in Disston Heights, Old Northeast, or Roser Park, the wood is usually soft across more than 30 percent of the perimeter and full aluminum conversion is the better long-term spend because aluminum eliminates the failure mode permanently. We walk the property and tell you straight." },
  ...
  "palm-harbor/seamless-aluminum-gutters": {
    ...
    faqs: [
      { q: "How much does seamless gutter installation cost in Palm Harbor?", a: "Standard single-story homes in Highland Lakes, Spring Lake, or Tarpon Woods run $1,750 to $3,400 for a full seamless replacement including downspouts and hidden hangers. Two-story homes and larger Lansbrook, Boot Ranch, or Innisbrook custom builds run $3,400 to $6,500 depending on linear footage, roofline complexity, and color match. Crystal Beach coastal properties walked and quoted per-property. Free flat-price estimate, no per-foot surprises." },
  ...
  "riverview/seamless-aluminum-gutters": {
    ...
    faqs: [
      { q: "How much does seamless gutter installation cost in Riverview?", a: "Standard single-story homes in Panther Trace, Boyette Springs, or Summerfield run $1,650 to $3,300 for a full seamless replacement including downspouts and hidden hangers. Two-story homes and larger Triple Creek, Riverview Estates, or Rivercrest builds run $3,400 to $6,500 depending on linear footage and roofline complexity. Free flat-price estimate at the property, no per-foot surprises at the end." },
  ...
  "riverview/gutter-guards": {
    ...
    faqs: [
      { q: "How much do gutter guards cost in Riverview?", a: "Micro-mesh stainless guard installation typically runs $8 to $14 per linear foot installed in Riverview. A standard single-story home with 150 to 200 linear feet of gutter runs $1,200 to $2,800 total. Larger Triple Creek and Riverview Estates homes and homes with complex rooflines run higher. Free flat-price estimate at the property." },
      { q: "Are gutter guards worth it in Riverview?", a: "On a property with mature pine, oak, or laurel canopy, yes. A typical canopy-heavy Riverview home needs three cleanings per year at roughly $200 to $275 each, so $600 to $825 annually. A guard install at $1,500 to $2,500 pays back in two to four years and lasts 20 plus. On a newer property in Triple Creek with minimal landscaping the math is closer to break-even and we will tell you that during the estimate." },
      { q: "Will gutter guards stop pine needles in Riverview?", a: "Micro-mesh stainless guards do, if the mesh is fine enough. Most consumer-grade guards on the market (the perforated metal screen sold at hardware stores) fail the pine-needle test, needles slide through the holes and clog the gutter underneath. JR One installs micro-mesh that handles pine needles, which matters in Panther Trace, Bloomingdale, and any conservation-adjacent Riverview lot where pine canopy is everywhere." },
      ...
      { q: "How long do gutter guards last in Riverview?", a: "Stainless steel micro-mesh itself does not rust, warp, or collapse under debris load. The frame and fasteners typically warrant for 20 plus years. The gutter underneath is the wearing part, and a properly maintained gutter with guards installed lasts 25 to 35 years in Florida." },
      { q: "Will I still need any gutter maintenance with guards installed?", a: "Yes, but it shrinks from active cleaning to once-a-year inspection. Some fine debris and pollen accumulates on top of the mesh and gets washed off by the next rain. If pine needles or oak leaves pile up enough to block the mesh from above, they need brushing off. We offer an annual inspection visit for guarded homes that handles this in 30 minutes." },
  ...
  "dunedin/soffit-and-fascia": {
    ...
    faqs: [
      { q: "How much does soffit and fascia replacement cost in Dunedin?", a: "Standard aluminum conversion runs $9 to $16 per linear foot installed in Dunedin, which puts a single-story home in Hawthorn Hills, Spanish Trails, or Cobbs Landing at $2,800 to $6,500 for a full perimeter conversion depending on linear footage and ventilation specification. Two-story homes near Downtown Dunedin, Caladesi Pointe, or Dunedin Country Club run $5,500 to $12,000. Direct sound-access estate properties walked and quoted per-property because installation also includes corrosion-resistant fastener inspection. Free flat-price estimate." },
