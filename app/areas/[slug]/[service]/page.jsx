...
const ENRICHMENT = {
  ...
  "lakeland/copper-gutters": {
    ...
    propsOverride: [
      ...
      ["50 plus year lifespan","Copper outlasts the next two aluminum replacements. Estate-class homes amortize the cost over decades, not years."],
