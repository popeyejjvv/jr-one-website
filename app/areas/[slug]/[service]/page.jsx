...
// Single source of truth for which combos have a Spanish twin. Shared with
...
const ENRICHMENT = {
  ...
  "brandon/gutter-guards": {
    ...
    faqs: [
      ...
      { q: "How long do gutter guards last in Brandon?", a: "The micromesh itself does not rust, warp, or collapse under debris load, it lasts the life of the gutter system. The gutter underneath is the wearing part, and keeping it clear of standing debris is what determines how long the whole system lasts in Florida." },
  ...
  "spring-hill/gutter-guards": {
    ...
    faqs: [
      ...
      { q: "Do gutter guards work with existing 6-inch gutters?", a: "Yes. We retrofit guards onto sound existing 6-inch and 7-inch K-style gutters. If the existing gutter has separated seams, sagging runs, or pulled-loose hangers, we address those issues first or quote a full replacement, installing guards on a failing gutter is throwing money away. We walk the property and tell you straight which path makes sense." },
      { q: "How long do gutter guards last in Spring Hill?", a: "The micromesh itself does not rust, warp, or collapse under debris load. The gutter underneath is the wearing part, and keeping it clear of standing debris is what determines how long the whole system lasts in Florida." },
      ...
      { q: "Do you offer storm-damage warranty on Spring Hill gutter guards?", a: "Yes. Our 3-year workmanship warranty covers the install, in writing, from the date of substantial completion. After named storms we provide insurance-ready damage documentation if any component fails outside warranty. We are family-owned with over 30 years in Tampa Bay and 19 logged Spring Hill projects in the CompanyCam record." },
    ],
    neighborhoodsOfNote: ["Pristine Place","Royal Highlands","Spring Hill Estates","Forest Oaks","Wellington Place","Glen Lakes","Timber Pines","Sterling Hill"],
    trustNumbers: ["19 Spring Hill projects in the JR One CompanyCam record since August 2023, active specialist aluminum contractor in Hernando County"],
  },
  ...
  "new-port-richey/gutter-guards": {
    ...
    faqs: [
      ...
      { q: "How long do gutter guards last in coastal New Port Richey?", a: "The micromesh itself does not rust, warp, or collapse under debris load, it lasts the life of the gutter system. Salt-laden Gulf air drives faster oxidation on standard fasteners, so we use corrosion-resistant hardware on every Gulf Harbors and Riverside Drive install. The gutter underneath is the wearing part, and keeping it clear of standing debris is what determines how long the whole system lasts in Florida." },
  ...
  "lakeland/copper-gutters": {
    introOverride: "Lakeland is the only inland Polk County market in our service area with a meaningful concentration of pre-1940 historic homes, with Lake Hollingsworth, South Lake Morton Historic District, and Beacon Hill anchoring the citys estate-class architectural inventory. Polk County records show median home year-built 1980 with 43 percent of housing pre-1980, and the historic-district subset is where copper gutters are the right answer. Copper matches original architectural detail on 1920s and 1930s homes where painted aluminum reads wrong, lasts 50 years or more versus aluminums 20 to 30, and develops the patina that historic-district architectural review boards expect. With 50.2 inches of average annual rainfall per NOAA and three named storms in the last ten years, the inland-Polk climate is gentle enough that copper investment pays back in lifespan and curb appeal both.",
    propsOverride: [
      ...
      ["50 plus year lifespan","Copper outlasts more than one full aluminum replacement cycle. Estate-class homes amortize the cost over decades, not years."],
    ...
    faqs: [
      ...
      { q: "Why copper gutters instead of painted aluminum on a Lakeland historic home?", a: "Three reasons. First, architectural accuracy, copper was the gutter material on most pre-1940 Lake Hollingsworth and South Lake Morton homes when they were built, painted aluminum reads as a 1970s replacement to a trained eye. Second, lifespan, copper lasts 50 years or more versus 20 to 30 for aluminum, so the investment amortizes across more than one full aluminum-replacement cycle. Third, the South Lake Morton Historic District and other historic-district review boards in Lakeland may prefer period-appropriate materials on visible exterior elements, and copper restoration is the path of least friction through the review process. We coordinate the review submission as part of the estimate package." },
  ...
  "riverview/gutter-guards": {
    ...
    faqs: [
      { q: "How much do gutter guards cost in Riverview?", a: "Micromesh gutter guard installation from JR One Aluminum runs $10 to $18 per linear foot installed in Riverview, FL. A standard single-story home with 150 to 200 linear feet of gutter runs $1,500 to $3,600 total. Larger Triple Creek and Riverview Estates homes and homes with complex rooflines run higher. Price is driven by linear footage, roof height and ladder access, one-story versus two-story, gutter size, 6-inch or 7-inch, and number of downspouts. Free flat-price estimate at the property. Use the JR One estimator at jronegutters.com/estimator for a number on your own home, or call (844) 444-3114." },
      ...
      { q: "How long do gutter guards last in Riverview?", a: "The micromesh itself does not rust, warp, or collapse under debris load. The gutter underneath is the wearing part, and keeping it clear of standing debris is what determines how long the whole system lasts in Florida." },
      { q: "Will I still need any gutter maintenance with guards installed?", a: "Yes, but it shrinks from active cleaning to once-a-year inspection. Some fine debris and pollen accumulates on top of the mesh and gets washed off by the next rain. If pine needles or oak leaves pile up enough to block the mesh from above, they need brushing off. We offer an annual inspection visit for guarded homes that handles this in 30 minutes." },
      { q: "Do you offer storm-damage warranty on Riverview gutter guards?", a: "Yes. Our 3-year workmanship warranty covers the install, in writing, from the date of substantial completion. After named storms we provide insurance-ready damage documentation if any component fails outside warranty. We are family-owned with over 30 years in Tampa Bay and 84 logged Riverview projects in the CompanyCam record since November 2022." },
    ],
    neighborhoodsOfNote: ["Panther Trace","Boyette Springs","Summerfield","Riverview Estates","South Pointe","Triple Creek","Rivercrest","Bloomingdale"],
  ...
  // ── Brandon + Lutz buildout, 2026-08-07 ──────────────────────────────────
  // Six thin city-children enriched after measuring GSC demand. Both cities are
  // Hillsborough. Rationale, query data, and the link plan:
  // projects/brandon-lutz/measurement-and-plan-2026-08.md
  // Every number here traces to compliance-sweep-closed-2026-08.md. No prices and
  // no per-city project counts: canon carries neither, so either would be invented.
  "brandon/siding": {
    introOverride: "Brandon grew fast, and the siding around town shows it. One street is an established 1980s development, the next finished construction last year, and those houses do not need the same work. JR One Aluminum installs vinyl and aluminum siding built for Florida weather: UV-stable color, fastening rated to hold through tropical storm wind loads, insulated panel options that add R-value and cut outside noise, and the trim detail most siding jobs get wrong, meaning corners, J-channel, and window wraps. We have worked the Tampa Bay exterior trade for over 30 years, family-owned the whole way. Full siding replacement, storm damaged siding, or one bad elevation, we walk the house with you and put the scope in writing first.",
    propsOverride: [
      ["Built for Florida sun and wind","UV-stable color and wind-rated fastening are not upgrades here, they are the baseline. Panels go on to hold through tropical storm wind loads and to keep their color under year-round Tampa Bay sun."],
      ["Trim detail decides the look","Corners, J-channel, and window wraps are where a siding job either looks finished or looks cheap. We detail those by hand instead of covering the field fast and rushing the edges."],
      ["Insulated panel if you want it","Insulated siding adds R-value behind the panel and cuts sound transmission from the street. We quote it beside standard panel so you can see both options before you decide."],
      ["Siding and trim from one crew","Siding meets soffit, fascia, and gutter at every roofline, and that seam is where most water problems start. Aluminum soffit and fascia last 30 to 40+ years, and we install all of it, so nobody points at the other guy."],
    ],
    faqs: [
      { q: "How much does siding installation cost in Brandon FL?", a: "We do not publish siding prices, because two houses on the same Brandon street rarely price the same. What moves the number: total wall square footage, one story versus two, how many windows and doors need wrapping, what the crew finds behind the old panel once it comes off, standard versus insulated, and how much trim detail each elevation carries. A single story in Providence with simple gables prices differently than a two story in FishHawk with dormers and bay windows. Affordable does not mean the cheapest bid on the street, it means the scope is complete so there is no surprise change order two weeks in. Get a written estimate instead of a phone guess. Start at jronegutters.com/estimator or call (844) 444-3114 and we will come look at the actual walls." },
      { q: "Can storm damaged siding be repaired, or does the whole house have to be redone?", a: "Usually it can be repaired. After a hurricane or a hard summer storm the damage is normally on one elevation, the side that took the wind, where a branch or flying debris cracked or pulled panels loose. If the profile is still made and the color is close, we replace the affected panels and the trim around them. The honest catch is color. Siding that has taken years of Florida sun will not match a brand-new panel exactly, so on a badly hit wall the cleaner result is redoing that full elevation out to a clean corner. If the panel line has been discontinued, which happens on older Brandon homes, we tell you that up front instead of hunting for a match that does not exist. We photograph everything before we touch it and write the scope line by line, so you have documentation of what was damaged and what was replaced." },
      { q: "Vinyl siding or aluminum siding for a Brandon house?", a: "Both work here, and the right call depends on the house and on what you want to stop thinking about. Vinyl carries its color through the panel, so repainting is not part of its upkeep, comes in a deep range of colors and profiles, and can be ordered insulated. Aluminum is rigid, holds a crisp line across long runs, and takes a baked-on factory paint finish that carries a 20-year manufacturer paint warranty on painted aluminum. Aluminum is also what the soffit, fascia, and trim on most Brandon homes are already made of, so it blends cleanly at the roofline. Both clean up with a hose and mild soap. We do not push one over the other. We walk the elevations with you, look at exposure, the wind side, and what your architectural review board allows, then quote what actually fits the house." },
      { q: "What should I ask a siding contractor in Brandon before I sign?", a: "Four things. First, ask for license and insurance documentation in writing, not a verbal yes, and read the dates on it. Second, ask who actually performs the work, the company crew or a subcontractor nobody introduced you to. Third, ask what the workmanship warranty covers and how long it runs. Ours is three years from substantial completion, in writing, separate from whatever the material manufacturer covers. Fourth, ask what happens to the trim, because corners, J-channel, and window wraps are where a cheap siding job shows itself first, and a vague scope line is exactly how that detail gets skipped. Any siding company can talk well at the kitchen table. If a contractor will not put those four answers on paper, that is your answer." },
      { q: "Which Brandon and Valrico neighborhoods do you cover?", a: "All of them, plus the rest of Hillsborough County. We run siding work through Bloomingdale, Riverglen, Providence, FishHawk, Valrico, Lithia, and Durant, and the mix is the interesting part. An established 1980s neighborhood and a subdivision that finished last year are both Brandon, and they need completely different scopes. Older homes here usually mean tired trim, sun-beaten panel, and fastening that predates the wind standards we build to now. Newer construction usually means builder-grade panel installed fast, with the trim details rushed. We quote both the same way, by walking every elevation of the actual house instead of pricing off a satellite photo. If your community has an architectural review board, say so up front and we will keep the color and profile inside what it already approves. Call (844) 444-3114 and tell us the cross street." },
      { q: "Does insulated siding actually help with heat and noise?", a: "Yes on both counts, and it is worth understanding why before you pay for it. Insulated siding has rigid foam bonded behind the panel, so it adds R-value across the whole wall face instead of only between the studs where your existing insulation sits. In a Brandon summer that face is the surface taking direct afternoon sun, so the difference is most noticeable in west-facing rooms. That same foam layer cuts sound transmission, which people notice most on houses near a busy road or a school route. It also makes the panel feel more solid under your hand and lie flatter across the wall, which shows up in how straight the finished elevation looks. We quote standard and insulated side by side so you can weigh the tradeoff yourself instead of taking our word for it." },
      { q: "What happens to my soffit, fascia, and gutters during a siding job?", a: "The same crew handles them, which is the whole point of hiring one company. Siding meets soffit, fascia, and gutter at every roofline, and that intersection is where water finds its way behind a wall. If your soffit and fascia are already tired, doing them during the siding job saves a second mobilization and a second mess in your yard, and aluminum soffit and fascia last 30 to 40+ years once they are installed right. If gutters have to come off for access, they go back on properly, and if they are damaged or hanging wrong we tell you straight instead of rehanging something that was already failing. JR One is a specialty aluminum contractor. Siding, soffit, fascia, and gutters are all in house, over 30 years of it." },
    ],
    neighborhoodsOfNote: ["Bloomingdale","Riverglen","Providence","FishHawk","Valrico","Lithia","Durant"],
    trustNumbers: ["JR One Aluminum is family-owned and has worked the Tampa Bay exterior trade for over 30 years.","The workmanship warranty is three years from substantial completion, written into the contract, not promised at the door.","One local crew handles siding, soffit, fascia, and gutters, so there is nobody to point at when a detail goes wrong."],
  },
  "brandon/seamless-aluminum-gutters": {
    introOverride: "Brandon runs the full range, from 1980s developments in Bloomingdale and Riverglen to brand-new construction out toward FishHawk and Lithia, and both ends of that range need the same thing: gutters that take a Tampa-level afternoon storm without opening up at a joint. JR One fabricates seamless aluminum gutters on site, feeding a single continuous coil to the exact length of your run, so there is no seam along the run to split or leak. We install six-inch and seven-inch K-style only, hung on screw-in hidden hangers spaced 24 inches. Installed correctly, seamless aluminum runs 20 to 30 years in this climate, and we back the labor with a 3-year JR One workmanship warranty.",
    propsOverride: [
      ["Formed at your house, not in a warehouse","We form each gutter on site from one continuous coil, cut to the actual measurement of your roofline. No seam along the run means no sealed joint sitting there waiting to open up three summers from now."],
      ["Six-inch and seven-inch K-style","We install six-inch and seven-inch only. Seven-inch carries roughly 40% more water than six-inch, which is the call we make on steep roofs, long unbroken runs, and valleys that dump into one spot."],
      ["Screw-in hidden hangers every 24 inches","Hidden hangers screw into the fascia at 24-inch spacing instead of relying on spikes driven through the face of the gutter. Nothing shows from the street, and nothing works loose under the weight of a heavy Brandon downpour."],
      ["Gauge matched to the exposure","Standard runs are .027 aluminum and we step up to .032 on Florida coastal exposure, with up to .050 available on commercial work. Painted aluminum carries a 20-year manufacturer paint warranty, and our labor is covered 3 years from substantial completion."],
    ],
    faqs: [
      { q: "What is the difference between seamless gutters and the sectional gutters sold at the home center?", a: "A sectional system is built from pre-cut lengths joined together along the run, and every one of those joints is a place water eventually works its way out. Seamless aluminum is a different animal. We feed one continuous coil through a forming machine right at your house and cut it to the exact length of your roofline, so there is no seam along the run to split or leak. The material lifespans tell the same story. Sectional gutter generally gives you 10 to 15 years and vinyl gutter 8 to 12 years, while seamless aluminum that is hung and pitched correctly runs 20 to 30 years. We do not sell sectional or vinyl gutter at all. What goes up on a Brandon home is seamless aluminum, copper, or galvalume steel." },
      { q: "Should I put 6 inch or 7 inch gutters on my Brandon house?", a: "Six-inch K-style handles most Brandon rooflines fine. Seven-inch is the step up, and it carries roughly 40% more water than six-inch. That matters more than people expect on a steep roof, on a long unbroken run served by a single outlet, or where two roof planes drain into one valley. In those spots a six-inch gutter is not really failing, it is getting overwhelmed at the peak of an afternoon storm. When we measure, we look at pitch, how much roof area drains into each run, and where the water is currently overshooting the front edge, then tell you which size the house actually calls for. We install six-inch and seven-inch only, and both are formed seamless on site." },
      { q: "How long do seamless aluminum gutters last in Florida, and what is the warranty?", a: "Installed correctly, seamless aluminum gives you 20 to 30 years in this climate. Aluminum will not rust the way steel does, which is the main reason it holds up on this side of the state, and the finish usually shows age before the metal does. Painted aluminum carries a 20-year manufacturer paint warranty. Our own work is covered by a 3-year JR One workmanship warranty from substantial completion, which covers how the system was hung, pitched, and sealed, not just the material that was used. If you want more life out of the metal itself, copper runs 50 years or more and galvalume steel runs 30 to 40 years, and we fabricate both." },
      { q: "How thick is the aluminum, and does gauge really matter here?", a: "It matters, and it is the easiest place for a cheap bid to hide. We install .027 aluminum as our standard and step up to .032 on Florida coastal exposure, where wind, salt, and heavier water load are harder on the metal. On commercial work we go up to .050. We do not install .019 aluminum on anything. Thin gauge dents when a ladder leans on it, oil-cans in the heat, and deforms around the hanger over time, which is how a gutter starts holding standing water in the middle of a run. When you compare gutter installers in Brandon, ask each one to put the gauge in writing. If it is not on the proposal, that is usually your answer." },
      { q: "How many downspouts does a Brandon home usually need?", a: "The working rule is a downspout about every 30 to 35 feet of gutter run, but that is a starting point, not a final answer. Actual spacing depends on the roof, the roofline, and other job factors: how much roof area drains into that particular run, the pitch, where the valleys land, where the water has to go once it leaves the wall, and where windows, doors, and walkways sit that it cannot cross. A long run on a two-story elevation with one outlet is the classic Brandon overflow call, and it is often solved by adding an outlet rather than by upsizing the gutter. We map the outlets during the measurement and show you where each one lands before anything gets installed." },
      { q: "My gutters leak and are pulling away. Do I need seamless gutter repair or a full replacement?", a: "It depends on what is actually failing. If the gutter itself is sound and the trouble is at the hangers, at an end cap, at a miter, or in the pitch, that is usually a repair. If the run is oil-canned, holding water in the middle, pulling the fascia away from the house, or was hung on spikes that have worked loose over the years, replacing that run is the honest call, because otherwise you pay twice. One thing to know about seamless: since each run is formed to the exact length of your roofline, a damaged section is not something you patch in from a stock piece the way you would with sectional gutter. We come out, look at it, and tell you which one it is before you commit to anything." },
      { q: "What do all the leaves and pine needles do to a new gutter system, and do you cover Valrico and Lithia?", a: "Pine needles are the part that gives gutters the most trouble on a wooded Brandon lot. Needles thread through a wide screen and pack into a mat right at the outlet. Gutter covers help, but the mesh has to be fine enough to stop a needle, not just a leaf. Be careful how anyone sells them to you: guards reduce cleaning, they never eliminate it. A good guard system means roughly 80% less cleaning and a service life of 15 to 20+ years, not a gutter you never touch again. We have completed 1,000+ guard installations and will tell you straight whether your tree load justifies them. We install throughout Brandon and the surrounding Hillsborough County area. Start with a free measured estimate at jronegutters.com/estimator or call (844) 444-3114." },
    ],
    neighborhoodsOfNote: ["Bloomingdale","Riverglen","Providence","FishHawk","Valrico","Lithia","Durant"],
    trustNumbers: ["Family-owned, over 30 years in the Tampa Bay gutter trade, specialized in seamless gutters, soffit, and fascia.","Every run is formed on site from a single continuous coil, hung on screw-in hidden hangers at 24 inches, and backed by a 3-year JR One workmanship warranty from substantial completion.","Painted aluminum carries a 20-year manufacturer paint warranty. Free measured estimate at jronegutters.com/estimator or call (844) 444-3114."],
  },
  "lutz/seamless-aluminum-gutters": {
    introOverride: "Lutz sits right on the Hillsborough and Pasco county line, and the oak and pine canopy that makes these neighborhoods feel established is the same canopy that fills gutters with leaves and needles all year. JR One Aluminum fabricates seamless aluminum gutters on site from a single continuous coil, so there is no seam along the run to split or leak. We install six-inch and seven-inch K-style only, hung on screw-in hidden hangers spaced 24 inches, in .027 standard or .032 for Florida coastal and high-exposure work. Under heavy tree cover we usually steer homeowners toward seven-inch, which carries roughly 40% more water than six-inch. Family-owned, over 30 years in the trade, and we look at your fascia and roofline in person before anything goes in writing.",
    propsOverride: [
      ["Seamless means no seam along the run","Every run is rolled on site from one continuous coil of aluminum and cut to the exact length of your wall. Sectional gutter is joined every few feet and those joints are where leaks start; a seamless run only connects at corners, end caps, and outlets."],
      ["Six-inch and seven-inch K-style","Those are the two sizes we install, plus copper and galvalume. Seven-inch moves roughly 40% more water than six-inch, which is why it comes up so often on Lutz homes sitting under heavy oak and pine."],
      ["Hidden hangers, screwed in every 24 inches","No spikes and no nails. Screw-in hidden hangers at 24-inch spacing hold the gutter tight to the fascia through a Florida summer downpour, and they stay invisible from the ground."],
      ["Gauge matched to the exposure","We run .027 aluminum as our standard and .032 for Florida coastal and high-exposure conditions, and we never hang .019. Painted aluminum carries a 20-year manufacturer paint warranty, and our workmanship is covered for 3 years from substantial completion."],
    ],
    faqs: [
      { q: "What does seamless gutter installation in Lutz FL actually involve?", a: "We start by measuring the roofline, then fabricate each run on site from a single continuous coil of aluminum, cut to the exact length of your wall. That is what seamless means: no seam along the run to split or leak. The only connections on the whole system are at corners, end caps, and downspout outlets. We hang the run on screw-in hidden hangers spaced 24 inches, set the pitch so water moves toward the outlets instead of standing in the trough, and route the downspouts down and away from the foundation. Color is matched to the house from a wide selection of factory finishes. If the fascia behind the old gutter has gone soft, we deal with that before anything new goes up, because new gutter hung on bad wood is wasted work. We are a specialty aluminum contractor, so we do not do roofing of any kind." },
      { q: "Should I go with 6 inch or 7 inch gutters on my Lutz home?", a: "Six-inch K-style goes on most Lutz homes and handles an ordinary roofline without complaint. Seven-inch carries roughly 40% more water than six-inch, and that extra capacity is the whole argument when a house sits under the oak and pine canopy that covers so much of this area. Heavier tree cover means more debris riding downhill with the water, and a wider trough with a wider outlet clogs less and overflows less. Long roof planes, steep pitches, and two valleys dumping into the same corner also push the answer toward seven-inch. We fabricate copper and galvalume as well for homeowners who want a different material. The honest answer is that your roofline decides, not a catalog, so we walk the house before recommending a size." },
      { q: "How long do seamless aluminum gutters last in Florida?", a: "Seamless aluminum runs 20 to 30 years in this climate when it is hung correctly and kept clear of debris. Painted aluminum carries a 20-year manufacturer paint warranty, and JR One covers its own workmanship for 3 years from substantial completion. For comparison, sectional gutter, the kind joined together every few feet, is generally a 10 to 15 year product, and vinyl gutter is 8 to 12 years; we install neither one. If you want to go past aluminum, copper lasts 50 years or more and galvalume steel runs 30 to 40 years, and we fabricate both. Aluminum soffit and fascia is a 30 to 40+ year system, which matters in Lutz because a lot of the older homes here are overdue for that work, and it is far easier to handle while the gutter is already down." },
      { q: "Do you do seamless gutter repair in Lutz, or only new installation?", a: "Both, and a good share of the repair calls we take in Lutz are not really gutter failures. The gutter is pulling off the house because the fascia behind it has rotted, or the original hangers were spiked in and worked their way loose, or the house never had enough downspouts to move the water the roof collects. So we look at the fascia, the hangers, the pitch, and the outlets before telling you what needs to change. Because a seamless run has no joint to take apart in the middle, a badly damaged length is usually re-run rather than patched, and the new run goes up on screw-in hidden hangers at 24 inches. If rotted fascia is the real problem, we wrap or replace it in aluminum, which is a 30 to 40+ year system and does not rot. We do not do roofing." },
      { q: "How many downspouts does my house need?", a: "The working rule of thumb is one downspout about every 30 to 35 feet of gutter run, but the real spacing depends on your roof, your roofline, and other factors on the job. How much roof area feeds that run, where the valleys dump, where the corners land, and where water can safely leave the property all change the answer. Too few downspouts is one of the most common problems we find on older Lutz homes. The trough itself is fine, but a heavy summer rain has nowhere to go, so it comes over the front lip in the same corner every time. Adding an outlet and routing the downspout properly is often the simplest fix for that corner." },
      { q: "Do I need gutter guards or leaf guards under all these oaks and pines?", a: "Under a canopy like Lutz has, guards are worth the conversation. A quality gutter cover means 80% less cleaning and lasts 15 to 20+ years, but be clear on one thing: guards reduce cleaning, they never eliminate it. Anyone promising a gutter you never have to think about again is selling you something. Oak tassels, pine needles, and blown-in debris still land on top of the screen and still have to come off, just far less often and without digging a packed trough out by hand. We have completed over 1,000 guard installations, so we have a good read on which debris loads a mesh handles and which ones still want a hand once a year. Seven-inch gutter paired with guards is the combination that gives a heavily shaded Lutz home the most margin in a downpour." },
      { q: "How do I choose a trusted seamless gutter company in Lutz?", a: "Ask three questions and the field sorts itself out. First, is the gutter fabricated on site from one continuous coil, or is it sectional stock joined together in your driveway? Second, what gauge is going up? We run .027 as our standard and .032 for Florida coastal and high-exposure work, and we will not hang .019. Third, what is actually written down? Ours is a 20-year manufacturer paint warranty on painted aluminum and a 3-year JR One workmanship warranty from substantial completion, in writing. We are a family-owned specialty aluminum contractor with over 30 years in the trade, we install six-inch and seven-inch K-style only plus copper and galvalume, and we do not do roofing. You can start an estimate at jronegutters.com/estimator or call (844) 444-3114." },
    ],
    neighborhoodsOfNote: ["Heritage Isles","Calusa Trace","Cheval","Lake Park"],
    trustNumbers: ["Family-owned specialty aluminum contractor with over 30 years in the Tampa Bay gutter trade.","Every run is fabricated on site from a single continuous coil: six-inch and seven-inch K-style only, plus copper and galvalume.","Painted aluminum carries a 20-year manufacturer paint warranty, and every JR One installation carries a 3-year workmanship warranty from substantial completion.","Over 1,000 gutter guard installations completed, which is how we know what a shaded Lutz roofline actually needs."],
  },
  "lutz/gutter-guards": {
    introOverride: "Lutz sits right on the Hillsborough and Pasco county line, and the oak and pine canopy that makes these neighborhoods so pleasant is the same canopy that fills gutters year round. Pine needles are the hard part. They slip through a wide gutter screen, stand up on end, and knit into a mat right at the outlet, so water sits against the fascia long after the rain stops. JR One installs aluminum and micromesh gutter guards on sound six-inch and seven-inch gutters throughout Lutz, from the established streets near Lake Park to newer builds in Heritage Isles and Calusa Trace. Most homes here do not need new gutters to get covered. If the run is straight and draining right, the guard retrofits onto it.",
    propsOverride: [
      ["Micromesh for pine, screen for oak","A standard gutter screen keeps leaves and twigs out but lets pine needles and shingle grit slip through. Micromesh is woven tight enough to stop both while rain still passes, which is why it is the usual call under a Lutz pine canopy."],
      ["Retrofits onto sound gutters","If your six-inch or seven-inch gutters are hanging straight and draining right, the guard goes on top of what you already have. No tear-off, no full replacement, and nothing that touches your roof, because JR One does not do roofing."],
      ["Aluminum that holds its shape","Aluminum mesh will not rust, warp, or collapse under a load of wet leaves the way thin plastic and foam inserts do. A properly installed system runs 15 to 20+ years."],
      ["80% less cleaning, told straight","Guards deliver 80% less cleaning. They reduce the work, they never eliminate it, and we would rather tell you that up front than have you find it out during the first heavy storm."],
    ],
    faqs: [
      { q: "What kind of gutter guard works best under oak and pine trees in Lutz?", a: "Micromesh. Pine needles are the problem child here, and they are thin enough to slide through a standard gutter screen, stand up on end, and knit into a mat right where the downspout takes off. Micromesh is woven fine enough that needles and shingle grit ride over the top instead of dropping in, while rain still passes through. A perforated aluminum guard handles broad oak leaves without trouble, so on a house with mostly oak and little pine it is a reasonable pick. On a lot with pine over the roofline, micromesh is the one still doing its job years later. We look at what is actually hanging over your roof before we recommend either one." },
      { q: "Do you install reverse curve gutter guards?", a: "No. Reverse curve covers, sometimes sold as surface tension or curved lid systems, use the shape of the lid to pull water around the lip and into the gutter. On paper that works. Under a Lutz pine canopy they tend to carry needles and shingle grit right along with the water, and in a hard Florida downpour the sheet of water can run past the lip and miss the gutter entirely. What JR One installs instead is perforated aluminum guard and micromesh, both of which sit flat and screen debris out at the surface. If you already have a reverse curve cover on the house and it is failing, we can look at what it takes to replace it with a screen or mesh system." },
      { q: "Can gutter covers go on my existing gutters, or do I need new gutters first?", a: "In most cases they go right onto what you have. The test is condition, not age. If your six-inch or seven-inch gutters are hung straight, pitched to the outlets, and the hangers and fascia behind them are sound, a gutter cover retrofits on top with no tear-off. Where we tell you to hold on is when a run is sagging, pulling away from the fascia, or already leaking at the seams, because a guard on a bad gutter just makes the bad gutter harder to reach. While we are up there we check hidden hanger spacing, which should be 24 inches. If yours are stretched wider than that, you will hear it from us before we quote anything on top of them. Start at jronegutters.com/estimator or call (844) 444-3114." },
      { q: "Will I still have to clean my gutters after leaf guards are installed?", a: "Yes, just far less often. Guards deliver 80% less cleaning. They do not eliminate it, and we will not tell you otherwise. What changes is the nature of the job. Instead of pulling a packed trough of wet leaves and shingle grit out by hand, you are brushing or rinsing fine debris off the top of the mesh and checking that the outlets and downspouts run clear. On a heavily shaded Lutz lot you still want eyes on it. Any company promising you will never touch your gutters again is selling a promise the product cannot keep, and you find that out the first time it pours over the front of the house in a summer storm." },
      { q: "How long do gutter guards last?", a: "15 to 20+ years for an aluminum or micromesh system that was installed correctly. Aluminum mesh does not rust, warp, or collapse under a debris load, which is exactly where thin plastic screens and foam inserts fail first. The guard normally outlasts the reason people bought it. What shortens that life is usually not the material, it is the install: sections that were not fastened consistently, or that got wedged under the shingle course in a way the roof was never built to take. We fasten to the gutter, not into your roof. JR One does not do roofing work, and a guard installation should never turn into one. Our workmanship warranty on the installation runs 3 years from substantial completion." },
      { q: "Do you repair leaf guards that another company installed?", a: "Often, yes. The common calls in Lutz are guard panels that lifted or blew loose at the edge, mesh crushed by a fallen limb, and sections that were never fastened right and have been letting debris in at the seam the whole time. If what is on the house is a decent aluminum or mesh product, repairing the run is usually the sensible move. If it is a flimsy plastic screen or a reverse curve cover that is already failing, patching it is money spent keeping a bad system alive, and we will say so plainly. Either way we look at the gutter underneath first, because a guard problem is sometimes a hanger problem or a pitch problem wearing a costume." },
      { q: "What is the difference between a gutter screen and micromesh?", a: "Opening size. A gutter screen is a perforated or slotted panel with holes you can see at a glance, and it does its job well, which is keeping leaves, twigs, and roof debris out of the trough. Micromesh is a fine aluminum weave over a frame, with openings small enough that pine needles and shingle grit stay on top. Both are gutter guards, both get called gutter covers or gutter shields depending on who is selling them, and both go on the same six-inch and seven-inch gutters. The pick comes down to what is overhead. Oak dominant lot, a screen holds up fine. Pine over the roofline, micromesh." },
    ],
    neighborhoodsOfNote: ["Heritage Isles","Calusa Trace","Cheval","Lake Park"],
    trustNumbers: ["Family-owned, over 30 years in the Tampa Bay gutter trade.","1,000+ gutter guard installations completed.","Every guard installation carries our 3 year workmanship warranty from substantial completion."],
  },
  "lutz/gutter-repair": {
    introOverride: "Lutz sits on the Hillsborough and Pasco county line, under heavy oak and pine canopy. That canopy drops leaves and needles year-round, and when heavy seasonal rain hits a loaded gutter, the water goes over the front edge instead of down the downspout. What starts as overflow turns into fascia rot and standing water at the foundation. JR One repairs sagging runs, leaking seams, pulled-away sections, and damaged or undersized downspouts on homes throughout Lutz, from the established streets around Lake Park to newer construction in Heritage Isles. We fix the cause, not the symptom, and we do not patch a failing seam with caulk that lets go by next season.",
    propsOverride: [
      ["Re-pitch and re-hang, not replace","Most sagging gutters in Lutz are a hanger and pitch problem, not worn out metal. We reset the run so it drains toward the outlet and re-hang it on hidden hangers set at 24 inches into solid wood. That is what holds a full gutter through an August storm, and it keeps a sound gutter in service instead of tearing it off."],
      ["Seams sealed the right way","Leaking seams, end caps, and miters get cleaned down to bare metal and sealed with commercial-grade gutter sealant. We do not use hardware store silicone, which shrinks and lets go by the next wet season. That is the repair that always comes back, and it is the one we get called out to redo."],
      ["Downspouts sized for the water","A gutter only moves what the downspout lets out. We replace crushed, undersized, or disconnected downspouts and add outlets where the roofline needs them. Outlets generally fall about every 30 to 35 feet, though actual spacing depends on the roof, the roofline, and other job factors, so we size and place them for your house."],
      ["Storm damage documented for your claim","Wind and falling limbs pull runs right off the fascia. We photograph what failed, write up why it failed, and hand you documentation an adjuster can work from. Then we repair or replace only the sections that are actually gone. Our workmanship is warranted for 3 years from substantial completion."],
    ],
    faqs: [
      { q: "Do you offer emergency or same day gutter repair in Lutz?", a: "If a run has torn loose and is hanging over a walkway, or water is dumping straight against a foundation or a doorway, say that when you call (844) 444-3114 and we treat it as urgent. Same day is sometimes possible depending on where the crew already is that morning and what the repair actually needs. We would rather give you a realistic window and hold it than promise a time we cannot keep. In the meantime, if a section is loose but not a hazard, leave it alone. Pulling on a hanging run usually takes more fascia with it and turns a small repair into a large one." },
      { q: "My gutters are sagging and pulling away from the fascia. Can that be repaired or do I need new ones?", a: "Sagging is usually a hanger and pitch problem, not worn out gutter. Under Lutz canopy a gutter carries standing water plus wet leaf pack, and that weight slowly works old spikes or hangers out of the fascia until the run bellies in the middle. If the aluminum is still sound, we re-pitch the run so it drains toward the outlet and re-hang it on hidden hangers set at 24 inches, screwed into solid wood. We also check the fascia behind it, because a hanger only holds as well as the board it is anchored to, and soft fascia is common on older Lutz homes. If the board is rotted, that gets addressed first. Replacement only makes sense when the metal is split, crushed, or corroded past repair." },
      { q: "How do you fix a leaking gutter seam so it actually stays fixed?", a: "Seams, end caps, and miters are where most gutter leaks start, and they are also where most bad repairs happen. Hardware store silicone is not made for constant wet and dry cycling or for the way aluminum moves in Florida heat. It skins over, shrinks, pulls away from the metal, and the drip is back by the next wet season. We clean the joint down to bare metal, dry it, and seal it with a commercial-grade gutter sealant made to bond to aluminum and stay flexible. If the seam is leaking because the run is pitched wrong and water is standing in it, sealing alone will not hold, so we correct the pitch at the same time. A seam that never holds water does not have much to leak through." },
      { q: "Water is pooling next to my house. Do you handle downspout repair and drainage?", a: "Downspout repair covers more than the visible tube. We look at whether the outlet is large enough for the run feeding it, whether the downspout has been crushed, disconnected, or pulled apart, and whether the water is actually getting away from the house once it lands. On most homes outlets fall about every 30 to 35 feet, but actual spacing depends on the roof, the roofline, and other job factors, so we size and place them for your house instead of a rule of thumb. If the discharge is pooling next to the slab, we extend it so the water leaves the foundation area rather than sitting against it. Overflow at one corner of the house is almost always an outlet problem, not a gutter problem." },
      { q: "Can you repair steel gutters, or do you only work on aluminum?", a: "We work galvalume steel, seamless aluminum, and copper. Galvalume holds up well in this climate and generally lasts 30 to 40 years, and copper lasts 50 years or more, so on an older home it is often worth repairing the existing metal rather than switching materials. What we do not install is sectional or vinyl systems, because the joints are the failure point and joint sealing on them is a temporary fix at best. Our seamless aluminum runs .027 as standard, .032 for coastal and heavy exposure, and heavier gauge on commercial work. We build six-inch and seven-inch only, so if a repair turns into a replacement, the new run gets sized to the roof area it actually has to drain." },
      { q: "When is gutter repair not enough, and when does gutter replacement make more sense?", a: "Repair is the right call when the metal is sound and the problem is pitch, hangers, seams, or downspouts, which is most of what we see in Lutz. Replacement makes sense when a run is split along the bottom, crushed by a falling limb, corroded through, or simply undersized for the roof area feeding it. Seamless aluminum generally lasts 20 to 30 years, so a gutter still inside that window that only leaks at joints is usually worth saving. We build six-inch and seven-inch only. On homes with large or steep roof planes sending a lot of water into one run, seven-inch carries roughly 40 percent more water than six-inch, and that is worth discussing before you pay to chase the same overflow twice." },
      { q: "Do you handle storm gutter damage and work with insurance?", a: "Yes. After a storm we document the damage properly: photos of the failed sections, the fascia behind them, and anything that came down on the run, plus a written description of what failed and why. That is what an adjuster needs to process a claim, and it carries a lot more weight than a one line invoice. We repair what can be repaired and replace only the sections that are genuinely gone. We do not do roofing, so if a limb came through the roof itself you will need a roofer for that part and we will work around their schedule on the gutter side. Our workmanship is warranted for 3 years from substantial completion." },
    ],
    neighborhoodsOfNote: ["Heritage Isles","Calusa Trace","Cheval","Lake Park"],
    trustNumbers: ["Family-owned, over 30 years in the gutter trade across Tampa Bay, with our workmanship warranted for 3 years from substantial completion.","Every repair is re-hung on hidden hangers at 24 inches and sealed with commercial-grade gutter sealant, the same standard we hold on a full installation.","Call (844) 444-3114 or start online at jronegutters.com/estimator."],
  },
  "lutz/gutter-cleaning": {
    introOverride: "Lutz sits right on the Hillsborough and Pasco county line, under an oak and pine canopy that never really stops shedding. Catkins and pollen in the spring, needles all summer, leaves and twigs through the fall, and shingle grit any time the rain drives hard. That mix packs down into a wet mat the water cannot get through, so the overflow runs behind the gutter and straight onto the fascia, which is how a cheap cleaning turns into a fascia rebuild. Gutter cleaning in Lutz is not a chore you can time to one season. It is maintenance you schedule around a canopy that drops something every month of the year, and around rain that finds every clog you left behind.",
    propsOverride: [
      ["Cleared by hand, not blown out","Every run is cleared by hand so the leaves, pine needles, twigs and shingle grit actually come out, instead of getting pushed down into the downspout elbow where you cannot see them. Debris goes into bags and leaves with the crew, never blown into your beds or back across the lawn."],
      ["Every downspout flushed and proven","We flush each downspout and confirm it exits at grade, then run a live water flow test on every run before the ladders come down. You get proof the system moves water, not a promise that it looks clean from the driveway."],
      ["A written condition report, included","Separating seams, loose hangers, soft or rotting fascia, downspouts that are undersized for the water the roof sends them: whatever we find gets written down with its location. The report is part of the cleaning, not a second visit you have to book."],
      ["The alternative when you are done with the ladder","Gutter guards are the long-term answer on a Lutz canopy lot, and a good guard means about 80% less cleaning. Guards reduce cleaning, they never eliminate it, so plan on a lighter check rather than no check at all."],
    ],
    faqs: [
      { q: "How often does a house in Lutz really need gutter cleaning?", a: "The canopy sets the schedule here, not the calendar. A lot in Calusa Trace or Lake Park with mature oaks and pines over the roofline loads up far faster than an open lot with young landscaping, and the drop never fully stops: pollen and catkins, then pine needles, then leaves and twigs, then shingle grit every time the rain comes down hard. So instead of guessing at an interval, watch the house. Water sheeting over the front lip during a storm, a dark stain running down the fascia, seedlings sprouting in the trough, or a downspout that trickles when it should be pushing a solid stream all mean the gutters are already packed. If you are seeing any of that, you are overdue." },
      { q: "What is included in a gutter cleaning service in Lutz FL?", a: "The whole job, in order. First, full hand removal of everything in the trough, leaves, pine needles, twigs and shingle grit, because a blower pushes the heavy grit down into the elbow and turns a clean gutter into a clogged downspout. Second, every downspout flushed and confirmed to exit at grade, so nothing is left plugged underground where you cannot see it. Third, a live water flow test on every run before we leave, and if a section is holding water after the flush, that goes in the report. Fourth, the written report on what we found. The debris is bagged and hauled off site, so there is nothing for you to drag to the curb. Start at jronegutters.com/estimator or call (844) 444-3114." },
      { q: "Do you go on the roof, or is this only the gutters?", a: "Plenty of people search for roof gutter cleaning and mean the gutters along the roof edge, and that is exactly the work. We clear the trough, the corners, the miters and the downspouts, working from ladders at the gutter line. JR One is a specialty aluminum contractor: gutters, downspouts, soffit, fascia, siding, guards and drainage. We do not do roofing, so we will not quote work on the shingles themselves and we will not go looking for a reason to sell you any. It also means the gutter is the part we actually know, the trough, the hangers, the miters and the fascia board behind it. If something outside our trade shows up, it goes in the written report and you take it to the right contractor." },
      { q: "What is a gutter tune-up, and how is it different from a cleaning?", a: "Tune-up and gutter maintenance are the words homeowners use for the same idea: get the system cleared and get an honest read on its condition in one visit. That is how we run it. The cleaning is the physical work, hand clearing, downspout flushing and the flow test. The read is the written report covering separating seams, loose hangers, soft fascia, and downspouts that are undersized for the water coming off that roof. Anything that needs repair gets written up with its location so you decide later, on a quote, instead of getting a number added to the invoice while the ladder is still leaning on the house. Cleaning and repair stay separate on purpose." },
      { q: "Is a gutter inspection part of the job, or do I have to ask for it separately?", a: "It is part of the job. Every cleaning ends with a written report, and you do not have to request it or schedule a second visit to get it. What we are looking at: whether the seams are separating, whether the hangers are still holding, since hidden hangers belong about every 24 inches and a sagging run usually means they are pulling out of the fascia, whether the fascia behind the gutter has gone soft where overflow has been running down it, and whether the house has enough downspouts for the roof it carries. On most homes downspouts land about every 30 to 35 feet, though the real spacing depends on the roof, the roofline and other job factors we check on site. Anything still holding water after the flush gets noted too." },
      { q: "My gutters overflow even right after a cleaning. What is wrong?", a: "Clean gutters that still overflow are usually not a debris problem, they are a capacity or a slope problem. Either the water leaving that roof plane is more than the trough and the downspouts can carry, or the run has lost its pitch and is standing water in the middle. Roof valleys are the usual culprit, because a valley funnels a wide area of roof into a short length of gutter, and that section drowns while the rest of the house looks fine. Size is the other half of it: a seven-inch gutter carries roughly 40% more water than a six-inch, which is why the heaviest valleys and the steepest planes around Lutz often end up on seven-inch with an added downspout. The written report tells you which problem you have." },
      { q: "If I install gutter covers, can I stop calling a gutter cleaner?", a: "Not entirely, and anyone who tells you otherwise is selling. A quality guard on a canopy lot means about 80% less cleaning, which is the difference between a chore you dread and a quick check you barely think about. Guards reduce cleaning, they never eliminate it. Fine debris, matted pine needles and shingle grit still collect on top of a cover and in the valleys, and the system still needs eyes on it. What guards buy you is time and safety, they hold up 15 to 20+ years, and they keep the trough from packing solid while you are not paying attention. JR One has completed 1,000+ guard installations, and the cleanest way to decide is to read your cleaning report first, then price guards against how often you are back on the ladder." },
    ],
    neighborhoodsOfNote: ["Heritage Isles","Calusa Trace","Cheval","Lake Park"],
    trustNumbers: ["JR One is family owned with over 30 years in the gutter trade, working these same streets long enough to know which Lutz lots load up fastest.","The same crew that cleans your gutters hangs seamless six-inch and seven-inch aluminum, so the condition report comes from people who install these systems for a living.","Every downspout is flushed and confirmed to exit at grade, and every run gets a live water flow test before the ladders come down.","More than 1,000 guard installations completed. Guards cut cleaning by about 80%, they never eliminate it, so the ladder comes out less often rather than never."],
  },
};
...
export async function generateMetadata({ params }) {
  ...
  // The ES combo route ships only the pairs in ES_COMBO_PAIRS (2026-08-07). Those
  // declare a real es-US alternate; every other pair keeps the x-default-only
  // fallback, which is the explicitly-allowed single-language path in the hreflang
  // check. Do NOT declare es-US for a pair the ES route does not generate, or the
  // alternate points at a 404.
  const hasEs = ES_COMBO_PAIRS.has(`${slug}/${service}`);
  return {
    title,
    description,
    alternates: {
      ...
      languages: hasEs
        ? {
            "en-US": url,
            "es-US": `https://www.jronegutters.com/es/areas/${slug}/${service}`,
            "x-default": url,
          }
        : {
            "x-default": url,
