...
const ENRICHMENT = {
  ...
  "brandon/seamless-aluminum-gutters": {
    ...
    propsOverride: [
      ...
      ["Gauge matched to the exposure","Standard runs are .027 aluminum and we step up to .032 on Florida coastal exposure, with up to .050 available on commercial work. Our labor is covered 3 years from substantial completion."],
    ],
    faqs: [
      ...
      { q: "How long do seamless aluminum gutters last in Florida, and what is the warranty?", a: "Installed correctly, seamless aluminum gives you 20 to 30 years in this climate. Aluminum will not rust the way steel does, which is the main reason it holds up on this side of the state, and the finish usually shows age before the metal does. Our own work is covered by a 3-year JR One workmanship warranty from substantial completion, which covers how the system was hung, pitched, and sealed, not just the material that was used. If you want more life out of the metal itself, copper runs 50 years or more and galvalume steel runs 30 to 40 years, and we fabricate both." },
  ...
  "lutz/seamless-aluminum-gutters": {
    ...
    propsOverride: [
      ...
      ["Gauge matched to the exposure","We run .027 aluminum as our standard and .032 for Florida coastal and high-exposure conditions, and we never hang .019. Our workmanship is covered for 3 years from substantial completion."],
    ],
    faqs: [
      ...
      { q: "How do I choose a trusted seamless gutter company in Lutz?", a: "Ask three questions and the field sorts itself out. First, is the gutter fabricated on site from one continuous coil, or is it sectional stock joined together in your driveway? Second, what gauge is going up? We run .027 as our standard and .032 for Florida coastal and high-exposure work, and we will not hang .019. Third, what is actually written down? Ours is a 3-year JR One workmanship warranty from substantial completion, in writing. We are a family-owned specialty aluminum contractor with over 30 years in the trade, we install six-inch and seven-inch K-style only plus copper and galvalume, and we do not do roofing. You can start an estimate at jronegutters.com/estimator or call (844) 444-3114." },
    ],
    neighborhoodsOfNote: ["Heritage Isles","Calusa Trace","Cheval","Lake Park"],
    trustNumbers: ["Family-owned specialty aluminum contractor with over 30 years in the Tampa Bay gutter trade.","Every run is fabricated on site from a single continuous coil: six-inch and seven-inch K-style only, plus copper and galvalume.","Every JR One installation carries a 3-year workmanship warranty from substantial completion.","Over 1,000 gutter guard installations completed, which is how we know what a shaded Lutz roofline actually needs."],
  },
  "lutz/gutter-guards": {
