...
const T = {
  en: {
    ...
    peakAlertDesc: "restores shingles from the inside out — adds 6–10 years of roof life and comes with the warranty docs Florida law requires your insurer to accept.",
  ...
  es: {
    ...
    peakAlertDesc: "restaura las tejas desde adentro — agrega 6–10 anos de vida al techo y viene con los documentos de garantia que la ley de FL requiere que su aseguradora acepte.",
